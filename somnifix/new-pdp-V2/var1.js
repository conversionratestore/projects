    ...
    `,
        ...
        for (let i = 0; i < swatchItem.length; i++) {
            swatchItem[i].addEventListener('click', function () {
                ...
                current[0].className = current[0].className.replace(' swatchCustom__item--active', '');
                ...
                if (swatchItem[0].classList.contains('swatchCustom__item--active')) {
                    ...
                    document.querySelector('.subscribe-custom').style.display = 'flex';
                }
        ...
        function upgrade(currentOptionValue) {
            let stockStrips = document.querySelector('.swatchCustom__item--active .days').innerText.replace(/ .*/, '');

            if (currentOptionValue === undefined) {
                document.querySelector('.stock__pack').innerHTML = `1 pack = ${stockStrips} strips`;
            } else {
                document.querySelector('.stock__pack').innerHTML = `${currentOptionValue} packs = ${
        ...
        document.querySelector('.stock__select').addEventListener('change', e => {
            let currentOptionValue = e.target.options[e.target.selectedIndex].dataset.value;
            ...
            document
                .querySelectorAll('.active .modal_price.subtitle')[1]
                .getElementsByClassName('money')[0].innerText = `$${Number(tempMoneyValue.toFixed(2))} USD`;
        ...
        document.querySelector('.subscribe-custom__checkbox').addEventListener('change', e => {
            if (e.currentTarget.checked) {
                ...
                if (
                    document.querySelectorAll('.swatchCustom__item')[1].classList.contains('swatchCustom__item--active')
                ) {
                    document
                        .querySelectorAll('.active .modal_price.subtitle')[1]
                        .getElementsByClassName('money')[0].innerText = '$49.97 USD';
                } else if (
                    document.querySelectorAll('.swatchCustom__item')[2].classList.contains('swatchCustom__item--active')
                ) {
                    document
                        .querySelectorAll('.active .modal_price.subtitle')[1]
        ...
        document.querySelector('.ship-destination__span--date').innerText =
            document.querySelectorAll('.on-select')[5].children[0].dataset.value;
        ...
        document.querySelectorAll('.on-select')[5].addEventListener('change', e => {
            ...
            document.querySelector('.free-shipping').innerText =
                document.querySelector('.on-free-shipping-label').innerText;
        });
