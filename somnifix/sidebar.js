	        ...
	        <div class="sidebar_body">
	            <div class="card_wrapper">            
	                <div class="card card_first selected" data-id="32115046023283">
	                    ...
	                    <div class="card_info" data-info-strips="28" data-info-weeks="4">
	                ...
	                <div class="card card_second" data-id="32115046056051">
	                    ...
	                    <div class="card_info" data-info-strips="84" data-info-weeks="12">
	                ...
	                <div class="card_info" data-info-strips="364" data-info-weeks="52">
	            ...
	            <div class="body_footer">
	                ...
	                <div class="left">
	                	...
	                	<p class="strips"><span data-strips>28</span> Strips - <span data-weeks>4</span> Weeks</p>
					</div>
					<div class="right">
...
let isTemplate = setInterval(() => {
	if (
		...
		function onCardClick(e, index) {
			...
			switch (index) {
				case 1:
					changeCheckboxText('12', '$49.97', '84', card)
					break
				case 2:
					changeCheckboxText('52', '$199.97', '364', card)
					break
				default:
					stripsNumber.innerText = '28'
					stripsWeeks.innerText = '4'
		...
		function calcPrice(operator) {
			...
			let strips = document.querySelector('.card.selected .card_info').dataset.infoStrips
			let weeks = document.querySelector('.card.selected .card_info').dataset.infoWeeks
			...
			stripsNumber.innerText = strips * counter
			stripsWeeks.innerText = weeks * counter
