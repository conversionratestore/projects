...
(function() {
  ...
  const w = (e, l, n, o = "") => {
    window.dataLayer = window.dataLayer || [], window.dataLayer.push({
      ...
      event_type: n,
      event_loc: o
    }), console.log(`Event: ${e} | ${l} | ${n} | ${o}`);
  }, m = (e, l, n, o, d = 3) => {
    let t = new IntersectionObserver(
      (u) => {
        u.forEach((s) => {
          s.isIntersecting && (t.unobserve(s.target), setTimeout(function() {
            _.observe(s.target);
          }, 1e3 * d));
        });
      },
      ...
      u.forEach((s) => {
        s.isIntersecting ? (w(
          l || `view_element_${s.target.id}`,
          n || `View element on screen (${d} sec or more)`,
          "view",
          o || s.target.id
        ), t.unobserve(s.target)) : t.observe(s.target), _.unobserve(s.target);
      });
    });
    document.querySelectorAll(e).forEach((u) => {
      t.observe(u);
    });
  };
  function v(e) {
    return new Promise((l) => {
      ...
      const n = new MutationObserver(() => {
        document.querySelector(e) && (l(document.querySelector(e)), n.disconnect());
      });
  ...
  }, p = ({ url: e, fullSize: l = !1, opacity: n = 1 }) => l ? (
    /* HTML */
    `<svg
      width="1345"
      height="1021"
    ...
    render() {
      ...
      b(".configurator__step").forEach((o) => {
        ...
        if (P.some((t) => o.textContent.includes(t))) {
          ...
          (d = t == null ? void 0 : t.closest(".configurator__step")) == null || d.classList.add("crs-window"), b(".crs-window__show").forEach((_) => {
            _.remove();
          }), t == null || t.insertAdjacentHTML("beforebegin", l), v(".roller .cart-title__image").then((_) => {
            _ && (_.innerHTML = l);
          }), o.addEventListener("click", (_) => {
            var h;
            const s = _.target.closest("button.selectable-item");
            if (s) {
              const r = (h = s.querySelector("h4")) == null ? void 0 : h.innerHTML, a = r == null ? void 0 : r.replace(/<br>| |\//g, "_").toLocaleLowerCase().trim(), c = $.find(({ name: f }) => f === a);
              this.allowEvent && w("exp_visualization_button_02", `${a}`, "click", "PDP Choose 'Blockout' colour & fabric"), b(".crs-window__fill").forEach((f) => {
                f.innerHTML = p({
                  url: `${y}/img/textures/${a}.jpg`,
  ...
  class C {
    ...
    init() {
      var t, _, u, s, h;
      m("div[data-carousel]", "exp_visualization_section_01", "Section", "PDP Select Roller Blind type"), b("h3").forEach((r) => {
        var a;
        (a = r.textContent) != null && a.includes("Choose your Roller Blind") && (r.innerHTML = /* HTML */
      ...
      }), b(".configurator__step [data-carousel] .selectable-item").forEach((r) => {
        var a, c, f;
        (a = r.textContent) != null && a.includes("Light Filtering") && r.classList.add("crs-light-filtering"), (c = r.textContent) != null && c.includes("Blockout") && r.classList.add("crs-blockout"), (f = r.textContent) != null && f.includes("Sunscreen") && r.classList.add("crs-sunscreen");
      });
      const l = (
        /* HTML */
      ...
      (t = i(".crs-measure")) == null || t.remove(), (_ = i(".measure-panel__howto")) == null || _.insertAdjacentHTML("beforeend", l), (u = i(".crs-measure .link")) == null || u.addEventListener("click", () => {
      ...
      ), b(".step-desc").forEach((r) => {
        var a;
        (a = r.textContent) != null && a.includes("Min/max width and drop") && (r.innerHTML = "Min/max width and drop will vary based on selected fabric range in the previous step.<br> *Motorised options available for Blinds  wider than 595mm.");
        ...
        (a = i(".crs-select-color")) == null || a.remove(), (c = i(".colour-chooser__wrap")) == null || c.insertAdjacentHTML("beforebegin", r), m(
          ...
          "PDP Choose 'Blockout' colour & fabric"
        ), b(".colour-chooser__wrap li").forEach((f) => {
          var S;
          (S = f.textContent) != null && S.includes("Colours") && (f.querySelector("span").style.backgroundImage = `url(${g}/img/others_color.png)`, f.querySelector("span").style.backgroundSize = "100%");
        });
      }), v(".cart-title__text").then((r) => {
        var c;
        const a = (
          /* HTML */
        ...
        (c = i(".crs-badges")) == null || c.remove(), r.insertAdjacentHTML("beforeend", a);
      });
      const n = (
        /* HTML */
        ' <div class="roller-container"></div>'
      );
      (s = i(".roller-container")) == null || s.remove(), (h = i(".crs-window + div")) == null || h.insertAdjacentHTML("beforeend", n);
      const o = i(".o-sidebar__panel-content .row > div");
      o && (o.classList.add("roller"), i(".roller-container").append(o));
      const d = i(".o-sidebar__panel-footer .cart-totals");
      d && (d.classList.add("add-to-cart"), i(".roller-container").append(d));
    }
  }
  class q {
    render() {
    ...
    `
      ...
      v(".crs-window .card-grid li").then(() => {
        var o, d, t;
        (o = i(".crs-show-more")) == null || o.remove(), b(".crs-window .card-grid li").length > 10 && ((d = i(".crs-window .row.small-gutters.row-gutters>div:last-of-type")) == null || d.insertAdjacentHTML(
          "beforeend",
          l
          ...
          const _ = i(".crs-window .card-grid");
          _.classList.toggle("show-more"), _.classList.contains("show-more") || (u = i(".crs-show-more .show-more")) == null || u.scrollIntoView({ behavior: "smooth" });
        }));
      });
    }
  }
  ...
  class H {
    ...
    init() {
      v(".configurator").then(() => {
        ...
        var t, _, u, s;
        const n = l.target, o = n.closest("button.selectable-item");
        o && ((t = o.textContent) != null && t.includes("Blockout Roller Blind") || (_ = o.textContent) != null && _.includes("Light Filtering Roller Blind") || (u = o.textContent) != null && u.includes("Sunscreen Roller Blind")) && (v(".crs-window button.selectable-item").then(() => {
          w("exp_visualization_icone_01", "Click", "click", "PDP Select Roller Blind type");
        }), new k().render(), new C().init());
        const d = n.closest(".colour-chooser__wrap li");
        if (new q().render(), d) {
          const h = (s = d.querySelector(".sr-only")) == null ? void 0 : s.textContent;
          w("exp_visualization_button_01", `${h}`, "click", "PDP Choose 'Blockout' colour & fabric"), new q().render();
        }
      });
    }
  }
