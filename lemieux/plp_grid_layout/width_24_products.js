    ...
    changeProductsSize() {
      const n = () => {
        ...
        c && ((e > d.length || i < e) && (c.disabled = !1), c.addEventListener("click", async () => {
          ...
          const a = u("ac-product-listing"), m = a.querySelectorAll("product"), g = Array.from(m), S = u(".crs-viewed"), O = a.querySelectorAll('product[style*="display: none"]'), q = Array.from(O), $ = new URLSearchParams(window.location.search), j = parseInt($.get("pg") || "1", 10);
