...
<style class="style-exp">
    ...
    .ProductItem__Title a, .Price--highlight, .Price--compareAt  {
        font-size: 12px;
        font-style: normal;
        line-height: 18px;
        font-weight: 400;
    ...
    .swiper-slide .ProductItem__Label {
        color: #3CBE1A;
        font-size: 10px;
        font-style: normal;
        font-weight: 400;
    ...
    .swiper-slide .AspectRatio--square:before {
        height: 220px;
    }
    .swiper-slide .Image--lazyLoaded.Image--fadeIn {
        object-fit: cover;
    }
    /* jackets */
    .jackets {
...
<div class="main-exp">
    ...
    <div class="top_review flex-center">
        <svg width="76" height="16" viewBox="0 0 76 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.00005 11.5133L10.7667 13.1866C11.2734 13.4933 11.8934 13.0399 11.76 12.4666L11.0267 9.31992L13.4734 7.19993C13.92 6.81326 13.68 6.07993 13.0934 6.03326L9.87338 5.75993L8.61338 2.78659C8.38671 2.24659 7.61338 2.24659 7.38671 2.78659L6.12671 5.75326L2.90672 6.02659C2.32005 6.07326 2.08005 6.80659 2.52672 7.19326L4.97338 9.31326L4.24005 12.4599C4.10672 13.0333 4.72671 13.4866 5.23338 13.1799L8.00005 11.5133Z" fill="#FCE358"/>
            <path d="M23 11.5133L25.7667 13.1866C26.2734 13.4933 26.8934 13.0399 26.76 12.4666L26.0267 9.31992L28.4734 7.19993C28.92 6.81326 28.68 6.07993 28.0934 6.03326L24.8734 5.75993L23.6134 2.78659C23.3867 2.24659 22.6134 2.24659 22.3867 2.78659L21.1267 5.75326L17.9067 6.02659C17.32 6.07326 17.08 6.80659 17.5267 7.19326L19.9734 9.31326L19.24 12.4599C19.1067 13.0333 19.7267 13.4866 20.2334 13.1799L23 11.5133Z" fill="#FCE358"/>
            <path d="M38 11.5133L40.7667 13.1866C41.2734 13.4933 41.8934 13.0399 41.76 12.4666L41.0267 9.31992L43.4734 7.19993C43.92 6.81326 43.68 6.07993 43.0934 6.03326L39.8734 5.75993L38.6134 2.78659C38.3867 2.24659 37.6134 2.24659 37.3867 2.78659L36.1267 5.75326L32.9067 6.02659C32.32 6.07326 32.08 6.80659 32.5267 7.19326L34.9734 9.31326L34.24 12.4599C34.1067 13.0333 34.7267 13.4866 35.2334 13.1799L38 11.5133Z" fill="#FCE358"/>
        ...
        <div class="flex-md-column-reverse justify-center">
            ...
            <div class="flex-center d-md-block">
                <svg width="130" height="42" viewBox="0 0 130 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Group 1217">
                    <g id="30">
                    <path d="M34.5607 23.5517V17.4828H39.5068C41.4476 17.4828 43.0209 16.9631 44.2268 15.9238C45.4327 14.8845 46.0357 13.539 46.0357 11.8872C46.0357 10.2354 45.461 8.92699 44.3116 7.96191C43.1622 6.97827 41.5418 6.48645 39.4503 6.48645C37.4719 6.48645 35.8703 7.01539 34.6455 8.07326C33.4208 9.13114 32.7519 10.5416 32.6388 12.3048H24.7816C24.9323 8.57436 26.3738 5.59561 29.1059 3.3685C31.838 1.14139 35.4086 0.0278388 39.8177 0.0278388C44.0761 0.0278388 47.5148 1.01148 50.1339 2.97876C52.7718 4.94603 54.0907 7.53504 54.0907 10.7458C54.0907 13.177 53.3182 15.2371 51.7731 16.926C50.2281 18.6149 48.1931 19.6821 45.6683 20.1275V20.2945C48.7395 20.5543 51.1702 21.5473 52.9602 23.2733C54.7691 24.9807 55.6735 27.2171 55.6735 29.9824C55.6735 33.5644 54.1755 36.4596 51.1796 38.6681C48.2025 40.8767 44.3493 41.981 39.6199 41.981C35.0412 41.981 31.3387 40.8489 28.5124 38.5846C25.7049 36.3204 24.
                    <path d="M102.919 35.077C103.535 34.359 104.37 34 105.422 34C106.474 34 107.306 34.359 107.919 35.077C108.535 35.795 108.843 36.7703 108.843 38.0027C108.843 39.2315 108.535 40.205 107.919 40.923C107.303 41.641 106.47 42 105.422 42C104.37 42 103.535 41.641 102.919 40.923C102.306 40.205 102 39.2315 102 38.0027C102 36.7703 102.306 35.795 102.919 35.077ZM106.808 36.0683C106.464 35.5896 106.002 35.3503 105.422 35.3503C104.841 35.3503 104.378 35.5896 104.03 36.0683C103.686 36.547 103.514 37.1918 103.514 38.0027C103.514 38.81 103.686 39.453 104.03 39.9317C104.374 40.4068 104.838 40.6443 105.422 40.6443C106.002 40.6443 106.464 40.4068 106.808 39.9317C107.152 39.453 107.324 38.81 107.324 38.0027C107.324 37.1918 107.152 36.547 106.808 36.0683Z" fill="#344D79"/>
                    <path d="M113.3 41.866H111.815V34.134H116.461V35.4682H113.3V37.5419H116.186V38.8225H113.3V41.866Z" fill="#344D79"/>
                    <path d="M120.839 41.866H119.354V34.134H124V35.4682H120.839V37.5419H123.725V38.8225H120.839V41.866Z" fill="#344D79"/>
                    </g>
                    <g id="Up to">
                    <path d="M3.87347 41.866H2.25774V35.4682H0V34.134H6.13656V35.4682H3.87347V41.866Z" fill="#344D79"/>
                    <path d="M9.55313 35.077C10.2237 34.359 11.1314 34 12.2763 34C13.4213 34 14.3272 34.359 14.9942 35.077C15.6647 35.795 16 36.7703 16 38.0027C16 39.2315 15.6647 40.205 14.9942 40.923C14.3236 41.641 13.4177 42 12.2763 42C11.1314 42 10.2237 41.641 9.55313 40.923C8.88616 40.205 8.55266 39.2315 8.55266 38.0027C8.55266 36.7703 8.88616 35.795 9.55313 35.077ZM13.7851 36.0683C13.4106 35.5896 12.9076 35.3503 12.2763 35.3503C11.645 35.3503 11.1403 35.5896 10.7623 36.0683C10.3877 36.547 10.2005 37.1918 10.2005 38.0027C10.2005 38.81 10.3877 39.453 10.7623 39.9317C11.1368 40.4068 11.6415 40.6443 12.2763 40.6443C12.9076 40.6443 13.4106 40.4068 13.7851 39.9317C14.1596 39.453 14.3468 38.81 14.3468 38.0027C14.3468 37.1918 14.1596 36.547 13.7851 36.0683Z" fill="#344D79"/>
                    </g>
                    <g id="Up to_2">
                    <path d="M1.63155 21V25.921C1.63155 26.4332 1.77382 26.8401 2.05835 27.1417C2.34648 27.4396 2.74987 27.5886 3.2685 27.5886C3.78354 27.5886 4.18332 27.4396 4.46786 27.1417C4.75599 26.8401 4.90005 26.4332 4.90005 25.921V21H6.53161V26.0845C6.53161 26.9564 6.23447 27.6612 5.64019 28.1989C5.04952 28.733 4.25896 29 3.2685 29C2.27445 29 1.48028 28.733 0.886008 28.1989C0.295336 27.6612 0 26.9564 0 26.0845V21H1.63155Z" fill="#344D79"/>
                    <path d="M10.0465 21H13.2988C14.1019 21 14.752 21.247 15.2491 21.7411C15.7497 22.2352 16 22.8856 16 23.6921C16 24.495 15.7425 25.1453 15.2274 25.6431C14.7124 26.1371 14.0425 26.3842 13.2177 26.3842H11.678V28.8638H10.0465V21ZM11.678 22.3025V25.0981H12.8612C13.3294 25.0981 13.6931 24.9764 13.9525 24.733C14.2118 24.4896 14.3414 24.1444 14.3414 23.6975C14.3414 23.2507 14.2118 22.9074 13.9525 22.6676C13.6967 22.4242 13.3348 22.3025 12.8666 22.3025H11.678Z" fill="#344D79"/>
                    </g>
                    </g>
                </svg>
                <p>Black friday in september</p>
            </div>
        </div>
    </div>
...
let mut = new MutationObserver(function (muts) {
    if (!document.querySelector('.style-exp') && 
        ...
        document.querySelector('#main').insertAdjacentHTML('afterbegin', tophtml)
