...
document.querySelector('.product-single__add').insertAdjacentHTML('',`<div class="justify-content-between"><p>30-day money back guarantee</p><p>Free USA shipping & retuens</p> <img src="madeinitaly.png" alt="made in italy"></div>`)
let arrFurniture = [
    {
        name: 'Armchair',
