  ...
  function E(m) {
    return new Promise((t) => {
      ...
      const o = new MutationObserver(() => {
        document.querySelector(m) && (t(document.querySelector(m)), o.disconnect());
      });
...
`
  ...
  class F {
    ...
    changeSlides() {
      const t = document.querySelector(".swiper-container"), o = document.querySelectorAll(".swiper-slide"), s = t == null ? void 0 : t.swiper, n = e("#solarForm .wrapper"), l = e(".os-navigation").querySelector(".os-next"), d = document.querySelector(".os-prev"), x = () => {
    ...
    addSlides() {
      ...
      (s = (o = t[1]) == null ? void 0 : o.querySelector("#estimate-bill")) == null || s.insertAdjacentHTML("afterend", M), (n = t[4]) == null || n.insertAdjacentHTML("beforeend", $);
    }
  }
  ...
  class P {
    ...
    `
      ...
      if (!n || !h)
        return;
      document.head.insertAdjacentHTML("beforeend", `<style>${O}</style>`), n.insertAdjacentHTML("beforeend", t), h.insertAdjacentHTML("afterbegin", o);
      const l = e(".os-prev"), d = e(".os-next"), x = document.querySelector(".swiper-container"), a = x == null ? void 0 : x.swiper;
      l == null || l.addEventListener("click", () => {
    ...
    init() {
      location.pathname === "/save/" && E(".swiper-slide-active").then(() => {
        E(".wrapper #slider-block .default").then(() => {
          document.head.insertAdjacentHTML("beforeend", `<style>${W}</style>`), document.title = "Solar Incentive Program", new P(), this.slideManager.addSlides(), this.slideManager.changeSlides(), new C();
        });
      });
    }
  }
