(function() {
    ...
    let l = new IntersectionObserver(
      ...
      x.forEach((a) => {
        a.isIntersecting ? (k(
          ...
          "view",
          s || a.target.id
        ), h && h(), l.unobserve(a.target)) : l.observe(a.target), c.unobserve(a.target);
      });
    });
  ...
  const e = (d) => document.querySelector(d), C = (d) => {
    let t = setInterval(function() {
      typeof window.clarity == "function" && (clearInterval(t), window.clarity("set", d, "variant_1"));
    }, 1e3);
  };
  (function(d = {}) {
    let t, o, s, n, h = d.delay || 50;
    function l() {
      t = null, n = 0;
    }
    return l(), function() {
      return o = window.scrollY, t !== null && (n = o - t), t = o, clearTimeout(s), s = setTimeout(l, h), n;
    };
  })();
  class N {
    constructor() {
    ...
    setEvents() {
      ...
      const l = e("#homeowner-yes"), c = e("#homeowner-no"), x = e("#homeowner-back");
...
`
  ...
  class O {
    ...
    changeSlides() {
      const t = document.querySelector(".swiper-container"), o = document.querySelectorAll(".swiper-slide"), s = t == null ? void 0 : t.swiper, n = e("#solarForm .wrapper"), l = e(".os-navigation").querySelector(".os-next"), c = document.querySelector(".os-prev"), x = () => {
      ...
      s == null || s.on("transitionEnd", () => {
        ...
        if (l.style.top = `${f}px`, i === 1 && (e("#estimate-bill").classList.contains("os-hide") || (l.style.top = `${f + 50}px`)), t && (t.dataset.currentSlide = i.toString()), i === 0 && this.progressBar.update(1), i === 1 && (c == null || c.removeEventListener("click", x), e("#estimate-homeowner").classList.contains("os-hide") ? (this.progressBar.update(3), l == null || l.classList.remove("os-hide"), c == null || c.addEventListener("click", x)) : this.progressBar.update(2)), i === 2 && (c == null || c.removeEventListener("click", x), this.progressBar.update(4)), i === 3 && this.progressBar.update(5), i === 3 ? n.dataset.background = "false" : n.dataset.background = "", i === 7 ? n.dataset.background = "opacity" : n.dataset.background = "", i > 3 ? e(".os-progress-block").classList.add("os-hide") : e(".os-progress-block").classList.remove("os-hide"), i === 4) {
          const r = e('input[value="unknown"]'), u = r.parentElement;
          r.checked = !0;
          const m = e(".os-spinner"), p = e('[data-os="result"]'), S = setTimeout(() => {
            m.classList.add("os-hide"), p.classList.remove("os-hide");
          }, 1e3), T = setTimeout(() => {
            u && u.click(), m.classList.remove("os-hide"), p.classList.add("os-hide"), p.classList.add("os-passed");
        ...
        if (i.querySelector("#estimate-zip")) {
          const r = i.querySelector(".title"), u = i.querySelector("h5"), m = i.querySelector("#calculateYourSavings"), p = i.querySelector("#zip"), S = i.querySelector("#zip-error");
          S && (S.textContent = ""), r && r.insertAdjacentHTML("afterend", '<h1 class="os-title">Enter your zip code</h1>'), u && (u.style.display = "none"), m && (m.textContent = "Continue"), p && p.setAttribute("placeholder", "Enter Your Zip Code"), m == null || m.addEventListener("click", () => {
            l == null || l.classList.add("os-hide");
          });
        }
        if (i.querySelector("#estimate-bill")) {
          const r = i.querySelectorAll(".title:not([data-custom])"), u = i.querySelectorAll(".sub-title"), m = (f = (w = i.closest(".swiper-container")) == null ? void 0 : w.nextElementSibling) == null ? void 0 : f.querySelector(".nextSlide");
          r.forEach((p) => {
            p && (p.innerHTML = /* HTML */
          ...
          }), m && m.classList.add("os-hide"), this.estimateHomeownerHandler();
        }
        ...
        if (i.querySelector("#estimate-map")) {
          ...
          r.forEach((m) => {
            m && (m.textContent = "Find your house location");
          }), u.forEach((m) => {
            m && (m.textContent = "Enter your house address to verify your eligibility for No Net Cost Solar");
          }), new z("#estimate-map .container");
        }
        if (i.querySelector("#estimate-email")) {
          const r = i.querySelectorAll(".sub-title.banner"), u = i.querySelectorAll(".title"), m = i.querySelectorAll(".sub-title");
          u.forEach((p) => {
            p && (p.innerHTML = /* HTML */
        ...
        if (i.querySelector("#estimate-name")) {
          const r = i.querySelectorAll(".title"), u = i.querySelector("#fname"), m = i.querySelector("#lname");
          r && r.forEach((p) => {
            p && (p.innerHTML = /* HTML */
            "What is your name?");
          }), u && u.setAttribute("placeholder", "First Name"), m && m.setAttribute("placeholder", "Family Name"), new z("#estimate-name .container");
        }
      });
    ...
    estimateHomeownerHandler() {
      ...
      const l = e("#homeowner-yes"), c = e("#homeowner-no"), x = e("#homeowner-back"), a = e("#solarForm .wrapper"), g = e('#estimate-homeowner [data-step="1"]'), b = e('#estimate-homeowner [data-step="2"]'), y = e(".os-progress-block");
  ...
  class W {
    ...
    `
      ...
      ), s = e("#slider-block"), n = e(".swiper-wrapper"), h = e(".wrapper");
      if (!n || !h)
        return;
      document.head.insertAdjacentHTML("beforeend", `<style>${P}</style>`), n.insertAdjacentHTML("beforeend", t), h.insertAdjacentHTML("afterbegin", o);
      const l = e(".os-prev"), c = e(".os-next"), x = document.querySelector(".swiper-container"), a = x == null ? void 0 : x.swiper;
      l == null || l.addEventListener("click", () => {
    ...
    init() {
      location.pathname === "/save/" && E(".swiper-slide-active").then(() => {
        E(".wrapper #slider-block .default").then(() => {
          document.head.insertAdjacentHTML("beforeend", `<style>${V}</style>`), document.title = "Solar Incentive Program", new W(), this.slideManager.addSlides(), this.slideManager.changeSlides(), new N();
        });
      });
    }
  }
