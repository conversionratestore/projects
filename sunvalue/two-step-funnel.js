(function() {
    ...
    let l = new IntersectionObserver(
      ...
      h.forEach((n) => {
        n.isIntersecting ? (k(
          ...
          "view",
          s || n.target.id
        ), u && u(), l.unobserve(n.target)) : l.observe(n.target), m.unobserve(n.target);
      });
    });
  ...
  const e = (c) => document.querySelector(c), N = (c) => {
    let t = setInterval(function() {
      typeof window.clarity == "function" && (clearInterval(t), window.clarity("set", c, "variant_1"));
    }, 1e3);
  };
  (function(c = {}) {
    let t, o, s, a, u = c.delay || 50;
    function l() {
      t = null, a = 0;
    }
    return l(), function() {
      return o = window.scrollY, t !== null && (a = o - t), t = o, clearTimeout(s), s = setTimeout(l, u), a;
    };
  })();
  class A {
    constructor() {
    ...
    setEvents() {
      ...
      const a = document.querySelector(".os-prev"), u = () => {
        k("exp_2_step_funnel_survey_1_1_back", "Back", "button", "Step 1.1");
      };
      o == null || o.on("transitionEnd", () => {
        const n = o.realIndex;
        n === 1 && e("#estimate-bill").classList.contains("os-hide") && (e('#estimate-homeowner [data-step="2"]').classList.contains("os-hide") && L("#estimate-homeowner", "exp_2_step_funnel_survey_1_1_view", "Full page view", "Step 1.1"), a.addEventListener("click", u)), n === 4 && L("#estimate-notnet", "exp_2_step_funnel_survey_4_1_view", "Full page view", "Step 4.1");
      });
      const l = e("#homeowner-yes"), m = e("#homeowner-no"), h = e("#homeowner-back");
      l.addEventListener("click", () => {
        k("exp_2_step_funnel_survey_1_1_yes", "Yes", "button", "Step 1.1"), a.removeEventListener("click", u);
...
`
  ...
  <div class="v-center" id="estimate-notnet">
    ...
    <div class="container text-center os-hide-o" data-os="result">
      <div class="os-spinner">${T}</div>
...
`
  ...
  class O {
    ...
    changeSlides() {
      const t = document.querySelector(".swiper-container"), o = document.querySelectorAll(".swiper-slide"), s = t == null ? void 0 : t.swiper, a = e("#solarForm .wrapper"), l = e(".os-navigation").querySelector(".os-next"), m = document.querySelector(".os-prev"), h = () => {
      ...
      s == null || s.on("transitionEnd", () => {
        ...
        if (l.style.top = `${f}px`, i === 1 && (e("#estimate-bill").classList.contains("os-hide") || (l.style.top = `${f + 40}px`)), t && (t.dataset.currentSlide = i.toString()), i === 0 && this.progressBar.update(1), i === 1 && (m == null || m.removeEventListener("click", h), e("#estimate-homeowner").classList.contains("os-hide") ? (this.progressBar.update(3), l == null || l.classList.remove("os-hide"), m == null || m.addEventListener("click", h)) : this.progressBar.update(2)), i === 2 && (m == null || m.removeEventListener("click", h), this.progressBar.update(4)), i === 3 && this.progressBar.update(5), i === 3 ? a.dataset.background = "false" : a.dataset.background = "", i === 7 ? a.dataset.background = "opacity" : a.dataset.background = "", i > 3 ? e(".os-progress-block").classList.add("os-hide") : e(".os-progress-block").classList.remove("os-hide"), i === 4) {
          const r = e('input[value="no_shade"]'), x = r.parentElement;
          r.checked = !0;
          const d = e(".os-spinner"), p = e('[data-os="result"]'), S = setTimeout(() => {
            d.classList.add("os-hide-o"), p.classList.remove("os-hide-o");
          }, 1e3), j = setTimeout(() => {
            x && x.click(), d.classList.remove("os-hide-o"), p.classList.add("os-hide-o"), p.classList.add("os-passed");
          }, 4e3), q = e("#slider-block .prevSlide");
          p.classList.contains("os-passed") && (clearTimeout(S), clearTimeout(j), p.classList.remove("os-passed"), q == null || q.click());
        }
      }), o.forEach((i) => {
        var w, f;
      ...
      const n = e("#bill-slider .rangeslider-tooltip");
      ...
      n.style.left = v - 18 + "px", y && (y.style.left = v + 5 + "px"), new MutationObserver(function(i) {
        i.forEach(function(w) {
          if (w.type === "attributes" && w.attributeName === "style") {
            const f = parseInt(b.style.left);
            n.style.left = f - 18 + "px", y && (y.style.left = f + 5 + "px");
            const r = n.getBoundingClientRect(), x = window.innerWidth || document.documentElement.clientWidth;
            r.right >= x - 20 && (n.style.left = x - r.width - 40 + "px"), r.left <= 20 && (n.style.left = "-1px");
          }
        });
      }).observe(b, {
        attributes: !0,
    ...
    estimateHomeownerHandler() {
      const t = e("#estimate-homeowner"), o = e("#estimate-bill"), s = e(".os-navigation"), a = s.querySelector(".os-next"), u = document.querySelector(".os-prev");
      o.classList.add("os-hide");
      const l = e("#homeowner-yes"), m = e("#homeowner-no"), h = e("#homeowner-back"), n = e("#solarForm .wrapper"), g = e('#estimate-homeowner [data-step="1"]'), b = e('#estimate-homeowner [data-step="2"]'), y = e(".os-progress-block");
  ...
  class P {
    ...
    `
      ...
      ), s = e("#slider-block"), a = e(".swiper-wrapper"), u = e(".wrapper");
      if (!a || !u)
        return;
      document.head.insertAdjacentHTML("beforeend", `<style>${W}</style>`), a.insertAdjacentHTML("beforeend", t), u.insertAdjacentHTML("afterbegin", o);
      const l = e(".os-prev"), m = e(".os-next"), h = document.querySelector(".swiper-container"), n = h == null ? void 0 : h.swiper;
      l == null || l.addEventListener("click", () => {
        if ((n == null ? void 0 : n.realIndex) === 1) {
    ...
    init() {
      location.pathname === "/save/" && E(".swiper-slide-active").then(() => {
        E(".wrapper #slider-block .default").then(() => {
          document.head.insertAdjacentHTML("beforeend", `<style>${V}</style>`), document.title = "Solar Incentive Program", new P(), this.slideManager.addSlides(), this.slideManager.changeSlides(), new A();
        });
      });
    }
  }
