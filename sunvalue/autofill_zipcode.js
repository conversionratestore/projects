(function() {
  ...
  }, y = (r) => document.querySelector(r), E = (r) => {
...
`;
  class B {
    ...
    `
      ...
      document.head.insertAdjacentHTML("afterbegin", `<style>${z}</style>`), e == null || e.insertAdjacentHTML("beforeend", n), i == null || i.insertAdjacentHTML("beforeend", t);
    }
    update(n) {
      if (n < 1 || n > 4) {
...
`;
  class f {
    ...
    render() {
      ...
      this.container && ((t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${j}</style>`));
    }
  }
  const P = `.estimate-custom-bill .os-title {
...
.os-subnote .os-saveup-note .icon {
  ...
  class Z {
    ...
    render() {
      ...
      (e = this.container) == null || e.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${P}</style>`), t && t.remove();
    }
    handle() {
    ...
    addAdressSubNote() {
      ...
      if (n) {
        ...
        c && ((e = c.closest(".os-subnote-wrap")) == null || e.remove()), new f({
  ...
  const F = "https://api.sunvalue.com/api/address?zip=", D = "https://api.sunvalue.com/api/geo";
  async function S(r, n = "GET", t = null) {
    try {
      const e = {
        method: n,
        headers: {
  ...
  const V = async (r) => await S(F + r), O = async () => await S(D), W = `#estimate-zip h1:not(.os-title) {
...
`;
  class Y {
    ...
    addSubNote() {
      ...
      <span class="icon">${_}</span> Fast. Simple. Secure
    </div>`
      );
      new f({
    ...
    addInfoBlock() {
      ...
      <div class="os-info-block">
        ...
        <ul class="os-info-block__list">
          <li><span>${b}</span>Location</li>
          <li><span>${M}</span>Your energy bill amount</li>
          <li><span>${q}</span>Best incentives provided in your area</li>
        </ul>
      </div>
    `
    ...
    async titleAndZipChanges() {
      ...
      if (s && (s.textContent = ""), e) {
        const d = (v) => {
          for (const x of v)
            x.type === "characterData" && (e.insertAdjacentHTML("afterend", u), m.disconnect());
      ...
      if (i && (i.textContent = "Enter your ZIP code to get started"), a && (a.textContent = "GeT STARTED", a.addEventListener("click", () => {
        ...
        <div class="os-current-location">
          ${n.regionName ? `<span class="os-current-location__icon">${b}</span>
    ...
    zipCodeHandler() {
      ...
      n.addEventListener("input", async () => {
        ...
        clearTimeout(t), t = setTimeout(async () => {
          ...
          `<span class="os-current-location__spinner">${C}</span>`;
          const { state_name: a } = await V(Number(e));
          a ? i.innerHTML = `<span class="os-current-location__icon">${b}</span>
  ...
  const G = `.estimate-custom-shade .os-title {
  color: #4a4a4a;
  font-size: 32px;
  font-weight: 900;
  line-height: 42px;
...
`;
  class U {
    ...
    render() {
      ...
      !this.container || document.querySelector("#estimate-custom-shade") || ((t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${G}</style>`));
    }
    handle() {
      ...
      n && n.addEventListener("click", (t) => {
        ...
        if (e.closest(".custom-radio-item")) {
          ...
          if (o) {
            ...
            c && (c.classList.add("os-hide"), l == null || l.classList.remove("os-hide"), d && (d.dataset.slideName = "address"), g(
...
.os-incentive-note .icon {
  ...
  class X {
    ...
    handle() {
      ...
      t && t.addEventListener("click", (e) => {
        ...
        const m = a.value;
        if (m && !d)
          o.classList.add("os-hide"), s.classList.remove("os-hide"), c && (c.dataset.slideName = "homeowner"), l.classList.add("os-hide"), this.updateProgressBar(), g("#estimate-custom-homeowner", "exp_evaluation_view", "Evaluating your average monthly energy bill ...", "Step  - Evaluation View");
        else if (!m) {
  ...
  const J = `.estimate-custom-homeowner .os-title {
  font-size: 32px;
  font-weight: 900;
  line-height: 42px;
  text-align: left;
...
`;
  class K {
    ...
    render() {
      ...
      !this.container || document.querySelector("#estimate-custom-homeowner") || ((t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${J}</style>`));
    }
    startLoadingBar() {
      var d, m, h;
      ...
      const l = setInterval(() => {
        if (s++, i && i.style.setProperty("--var-width", `${s}%`), a && (a.textContent = `${s}%`), o)
          if (s === 16)
            ...
            s === 100 && (clearInterval(l), n == null || n.classList.add("os-hide"), t == null || t.classList.remove("os-hide"), e && (e.dataset.slideName = "name"), g("#estimate-custom-name", "exp_name_view", "Last and First Name", "Step - Last and First Name"));
      }, 100);
    }
    observeShadeClass() {
  ...
  const Q = `.estimate-custom-name .os-title {
  display: flex;
  align-items: center;
  gap: 12px;
  font-size: 32px;
    ...
    render() {
      ...
      <div class="container text-center">
        <div class="os-mobile-container">
          <h2 class="os-title"><span class="icon">${A}</span>Congratulations!</h2>
      ...
      !this.container || document.querySelector("#estimate-custom-name") || ((t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${Q}</style>`));
    }
    handle() {
      ...
      n == null || n.addEventListener("change", () => {
        ...
        h && (h.value = d), u && (u.value = m), o == null || o.classList.add("os-hide"), s == null || s.classList.remove("os-hide"), c && (c.dataset.slideName = "email"), l.classList.remove("os-hide"), p("exp_name_click", "Continue", "click", "Step - Last and First Name"), g("#estimate-custom-email", "exp_email_view", "View - Email", "Step - Email");
      });
    }
  }
  const tn = `.estimate-custom-email .os-title {
  display: flex;
  align-items: center;
  gap: 12px;
  font-size: 32px;
...
`;
  class en {
    ...
    addSubNote() {
      ...
      <span class="icon">${_}</span> We keep your information safe and secure
    </div>`
      );
      new f({
    ...
    render() {
      ...
      !this.container || document.querySelector("#estimate-custom-email") || ((t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${tn}</style>`));
    }
    handle() {
  ...
  const on = `#estimate-phone .medium-container {
  max-width: 580px;
}
...
@media screen and (max-width: 768px) {
  ...
  class sn {
    ...
    init() {
      document.head.insertAdjacentHTML("beforeend", `<style>${on}</style>`), this.addLabel(), this.inputChanges();
    }
    inputChanges() {
  ...
  const an = `.swiper-container-android .swiper-slide,
.swiper-wrapper {
...
`;
  class rn {
    ...
    `
        ...
        /* HTML */
        `<button type="button" data-current-slide="0" class="os-prev">${N}</button>`
      ...
      if (!i || !o)
        return;
      document.head.insertAdjacentHTML("beforeend", `<style>${an}</style>`), i.insertAdjacentHTML("beforeend", n), o.insertAdjacentHTML("afterbegin", t);
      ...
      s == null || s.addEventListener("click", () => {
        ...
        if (l.classList.add("os-hide"), setTimeout(() => {
          ...
          const h = document.getElementById("estimate-custom-address"), u = document.getElementById("estimate-custom-shade"), v = document.getElementById("estimate-custom-name"), x = document.getElementById("estimate-custom-email");
          if (u.classList.contains("os-hide") || p("exp_roof_back", "Back", "click", "Step 3 - Does your roof get sunlight?"), !h.classList.contains("os-hide")) {
            h.classList.add("os-hide"), u.classList.remove("os-hide"), this.progressBar && this.progressBar.update(3), p("exp_property_adress_back", "Back", "click", "Step 4 - What is your property address?");
            return;
          }
          if (!x.classList.contains("os-hide")) {
            x.classList.add("os-hide"), v.classList.remove("os-hide"), a.dataset.slideName = "name", s.classList.add("os-hide"), p("exp_email_back", "Back", "click", "Step - Email ");
            return;
          }
        }
  ...
  class ln {
    constructor() {
      var n;
      this.swiperElement = document.querySelector(".swiper-container"), this.swiper = (n = this.swiperElement) == null ? void 0 : n.swiper, this.progressBar = new B(), this.addNavigation(), this.otherEvents();
    }
    addNavigation() {
      new rn({ progressBar: this.progressBar, swiper: this.swiper });
    }
    changeSlides() {
      new Y(), new sn();
      const n = document.querySelector(".swiper-container"), t = n == null ? void 0 : n.swiper, e = y("#solarForm .wrapper"), i = y(".os-navigation");
      ...
      this.progressBar.hide(), g("#estimate-zip", "exp_zipcode_view", "View Screen", "Step zipcode"), t == null || t.on("transitionEnd", () => {
        ...
        if (o === 4 && document.querySelectorAll('input[name="shade"]').forEach((d) => {
          if (d.checked) {
          ...
          let l = !1;
          l || (g("#estimate-phone", "exp_phone_view", "View - Phone", "Step - Phone"), l = !0);
        }
      });
    }
    otherEvents() {
    ...
    addSlides() {
      ...
      new Z({ container: n[1], position: "beforeend" }), new U({ container: n[3], position: "beforeend", progressBar: this.progressBar }), new X({ container: n[3], position: "beforeend", progressBar: this.progressBar }), new K({ container: n[3], position: "beforeend" }), new nn({ container: n[3], position: "beforeend" }), new en({ container: n[3], position: "beforeend" });
    }
  }
  const dn = `.site-header {
  display: flex;
  justify-content: center;
  align-items: center;
  height: 56px;
...
`;
  ...
  class cn {
    ...
    init() {
      location.pathname === "/save/" && w(".swiper-slide-active").then(() => {
        w(".wrapper #slider-block .default").then(() => {
          document.head.insertAdjacentHTML("beforeend", `<style>${dn}</style>`), document.title = "Solar Incentive Program", this.slideManager.addSlides(), this.slideManager.changeSlides();
        });
      });
    }
  }
