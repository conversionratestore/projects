(function() {
  ...
  const g = (r, n, e, t) => {
    let i = new IntersectionObserver(
      ...
      o.forEach((s) => {
        s.isIntersecting ? (p(n || `view_element_${s.target.id}`, e || "Element visibility", "view", t || s.target.id), i.unobserve(s.target)) : i.observe(s.target), a.unobserve(s.target);
      });
    });
  ...
  class P {
    ...
    update(n) {
      ...
      if (t && (t.textContent = n.toString()), !e)
        return;
      const i = e.querySelector('[data-step="1"]'), a = e.querySelector('[data-step="2"]'), o = e.querySelector('[data-step="3"]'), s = e.querySelector('[data-step="4"]');
      n === 1 && (i.style.setProperty("--fill", "100%"), a.style.setProperty("--fill", "0%"), o.style.setProperty("--fill", "0%"), s.style.setProperty("--fill", "0%")), n === 2 && (i.style.setProperty("--fill", "100%"), a.style.setProperty("--fill", "50%"), o.style.setProperty("--fill", "0%"), s.style.setProperty("--fill", "0%")), n === 3 && (i.style.setProperty("--fill", "100%"), a.style.setProperty("--fill", "100%"), o.style.setProperty("--fill", "50%"), s.style.setProperty("--fill", "0%")), n === 4 && (i.style.setProperty("--fill", "100%"), a.style.setProperty("--fill", "100%"), o.style.setProperty("--fill", "100%"), s.style.setProperty("--fill", "50%"));
    }
    hide() {
...
@media (max-width: 768px) {
  ...
  class C {
    ...
    render() {
      ...
      this.container && (this.container.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${K}</style>`));
    }
    checkContainer() {
      if (!this.container) {
  ...
  const X = `.estimate-custom-bill .os-title {
  ...
  class J {
    ...
    render() {
      ...
      <div class="container text-center">
        ...
        ].map(({ text: i, value: a, averageValue: o }) => (
          /* HTML */
      ...
      (t = this.container) == null || t.insertAdjacentHTML(this.position, n), document.head.insertAdjacentHTML("beforeend", `<style>${X}</style>`), e && e.remove();
    }
    handle() {
      ...
      n.addEventListener("click", (t) => {
        ...
        t.addEventListener("change", () => {
          var o, s;
          const i = t.dataset.averageValue;
          this.addAddressSubNote(i);
          const a = (s = (o = t.parentElement) == null ? void 0 : o.textContent) == null ? void 0 : s.trim();
          p(
    ...
    addAddressSubNote(n) {
      var i, a, o;
      const e = sessionStorage.getItem("chosen_state");
      if (!e)
        return;
      const t = ((i = f[e]) == null ? void 0 : i.savings) || f.default.savings;
      if (n) {
        const s = Number(n), d = parseFloat(t) / 100, c = s * 12 * d, m = Math.round(c).toLocaleString("en-US"), u = (
          /* HTML */
        ...
        h && ((a = h.closest(".os-subnote-wrap")) == null || a.remove());
...
`;
  class sn {
    ...
    async titleAndZipChanges() {
      ...
      if (!e)
        return;
      const t = e.querySelector(".title"), i = e.querySelector("h5"), a = e.querySelector("#calculateYourSavings"), o = e.querySelector("#zip"), s = e.querySelector("#zip-error");
      if (s && (s.textContent = ""), t) {
        ...
        const x = (
          /* HTML */
          `<h1 class="os-title">
        See if your home qualifies for the <span>${(d = t.textContent) == null ? void 0 : d.replace("Incentive", "Energy")}</span>
      </h1>`
        );
      ...
      if (i && (i.textContent = "Enter your ZIP code to get started"), a && (a.textContent = "GeT STARTED", a.addEventListener("click", () => {
        ...
        if (m) {
          const h = ((c = f[n.regionName]) == null ? void 0 : c.savings) || f.default.savings;
          m.innerHTML = Math.round(parseFloat(h)) + "%";
        }
        const u = (
          /* HTML */
          `
      ...
      `
        ...
        (l = o == null ? void 0 : o.closest("li")) == null || l.insertAdjacentHTML("beforeend", u);
      }
    }
    zipCodeHandler() {
      ...
      n.addEventListener("input", async () => {
        ...
        clearTimeout(e), e = setTimeout(async () => {
          ...
          const { state_name: a } = await en(Number(t));
          sessionStorage.setItem("chosen_state", a);
          const o = document.querySelector("#os-save-up");
          if (a) {
            const c = ((s = f[a]) == null ? void 0 : s.savings) || f.default.savings, l = Math.round(parseFloat(c));
            o && (o.innerHTML = l + "%"), i.innerHTML = /* HTML */
            `<span class="os-current-location__icon">${k}</span>
            <span class="os-current-location__city">${a}</span>`;
          } else {
            const c = ((d = f[a]) == null ? void 0 : d.savings) || f.default.savings, l = Math.round(parseFloat(c));
        ...
        if (t.closest(".custom-radio-item")) {
          ...
          if (o) {
            ...
            if (!s)
              return;
            s.checked = !0;
            const d = document.getElementById("estimate-custom-shade"), c = document.getElementById("estimate-custom-address"), l = document.querySelector(".wrapper");
            d && (d.classList.add("os-hide"), c == null || c.classList.remove("os-hide"), b(), l && (l.dataset.slideName = "address"), g(
          ...
          p("exp_roof_click", (a = t.textContent) == null ? void 0 : a.trim(), "click", "Step 3 - Does your roof get sunlight?");
        }
      });
    }
  }
  ...
  class dn {
    ...
    handle() {
      ...
      e && e.addEventListener("click", (t) => {
        const i = t.target, a = document.getElementById("os-googleautoaddress"), o = document.getElementById("estimate-custom-address"), s = document.getElementById("estimate-custom-homeowner"), d = document.querySelector(".wrapper"), c = document.querySelector(".os-prev"), l = (i == null ? void 0 : i.dataset.disabled) === "true";
        if (!a)
          return;
        const m = a.value;
        if (m && !l)
          o.classList.add("os-hide"), s.classList.remove("os-hide"), b(), d && (d.dataset.slideName = "homeowner"), c.classList.add("os-hide"), this.updateProgressBar(), g(
...
`;
  class pn {
    ...
    startLoadingBar() {
      var l, m, u;
      const n = document.getElementById("estimate-custom-homeowner"), e = document.getElementById("estimate-custom-name"), t = document.querySelector(".wrapper"), i = (l = this.container) == null ? void 0 : l.querySelector(".os-loading-bar__progress"), a = (m = this.container) == null ? void 0 : m.querySelector(".os-loading-bar__status"), o = (u = this.container) == null ? void 0 : u.querySelector(".os-loading-bar__label");
      let s = 0;
      const c = setInterval(() => {
        if (s++, i && i.style.setProperty("--var-width", `${s}%`), a && (a.textContent = `${s}%`), o)
          if (s === 16)
            ...
            s === 100 && (clearInterval(c), n == null || n.classList.add("os-hide"), e == null || e.classList.remove("os-hide"), b(), t && (t.dataset.slideName = "name"), g(
...
`;
  class un {
    ...
    handle() {
      const n = document.getElementById("os-fname"), e = document.getElementById("os-fname-error"), t = document.getElementById("os-lname"), i = document.getElementById("os-lname-error"), a = document.getElementById("os-namesaving");
      n == null || n.addEventListener("change", () => {
        ...
        const o = document.getElementById("estimate-custom-name"), s = document.getElementById("estimate-custom-email"), d = document.querySelector(".wrapper"), c = document.querySelector(".os-prev");
        e.textContent = "", i.textContent = "";
        const l = n.value, m = t.value;
        if (!l || l.length === 0) {
        ...
        u && (u.value = l), h && (h.value = m), o == null || o.classList.add("os-hide"), s == null || s.classList.remove("os-hide"), d && (d.dataset.slideName = "email"), b(), c.classList.remove("os-hide"), p("exp_name_click", "Continue", "click", "Step - Last and First Name"), g("#estimate-custom-email", "exp_email_view", "View - Email", "Step - Email");
      });
    }
  }
...
`;
  class bn {
    ...
    `
      ...
      ), t = document.querySelector("#slider-block"), i = document.querySelector(".swiper-wrapper"), a = document.querySelector(".wrapper"), o = document.querySelector(".content-wrapper .container");
      if (!i || !o)
        return;
      ...
      s == null || s.addEventListener("click", () => {
        ...
        if (c.classList.add("os-hide"), setTimeout(() => {
          ...
          if (!v.classList.contains("os-hide")) {
            v.classList.add("os-hide"), x.classList.remove("os-hide"), b(), a.dataset.slideName = "name", s.classList.add("os-hide"), p("exp_email_back", "Back", "click", "Step - Email ");
            return;
          }
        }
        if (s.dataset.currentSlide === "7") {
          (m = this.swiper) == null || m.slideTo(3), window != null && window.google && (window.google = null), a.dataset.slideName = "email", p("exp_phone_back", "Back", "click", "Step - Phone");
          return;
        }
        const l = t == null ? void 0 : t.querySelector("a:first-child");
        setTimeout(() => {
          l == null || l.click();
        }, 0);
      }), d == null || d.addEventListener("click", () => {
        const c = t == null ? void 0 : t.querySelector("a:last-child"), l = document.querySelector(".os-navigation");
  ...
  class yn {
    ...
    changeSlides() {
      new sn(), new xn();
      const n = document.querySelector(".swiper-container"), e = n == null ? void 0 : n.swiper, t = L("#solarForm .wrapper"), i = L(".os-navigation"), a = document.querySelector(".os-prev");
      this.progressBar.hide(), g("#estimate-zip", "exp_zipcode_view", "View Screen", "Step zipcode"), e == null || e.on("transitionEnd", () => {
        const o = e.realIndex;
        t.dataset.currentSlide = o.toString(), a && (a.dataset.currentSlide = o.toString());
        const s = document.querySelector(".swiper-slide-active"), d = (s == null ? void 0 : s.clientHeight) || 0;
        i.style.top = `${d}px`, n && (n.dataset.currentSlide = o.toString()), o === 0 && this.progressBar.hide(), o === 1 && (this.progressBar.show(), this.progressBar.update(1), g(
        ...
        )), o === 4 && (document.querySelectorAll('input[name="shade"]').forEach((l) => {
          if (l.checked) {
            const m = l.closest(".radioNext");
            m && m.click();
          }
    ...
    otherEvents() {
      ...
      n && n.addEventListener("click", (e) => {
        ...
        if (t.closest(".radioNext")) {
          const o = (a = (i = t.closest(".radioNext")) == null ? void 0 : i.textContent) == null ? void 0 : a.trim();
    ...
    init() {
      location.pathname === "/save/" && z(".swiper-slide-active").then(() => {
        z(".wrapper #slider-block .default").then(() => {
          document.head.insertAdjacentHTML("beforeend", `<style>${wn}</style>`), document.title = "Solar Incentive Program", this.slideManager = new yn(), this.slideManager.addSlides(), this.slideManager.changeSlides();
        });
      });
    }
  }
