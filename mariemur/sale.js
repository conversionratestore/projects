...
if (twentyFourHours >= 0) {
    ...
    const elementsArray = ['.product-price .price span span.money[data-currency-usd]', '.product-list__box-price .price span .money[data-currency-usd]', '.cart-modal__box-option-row .money[data-currency-usd]'];
