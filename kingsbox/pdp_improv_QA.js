...
const languagesObj = {
    ...
    nl: {
        ...
        demand: 'Er is veel vraag naar dit product',
        order: 'Bestel vandaag en krijg uw bestelling binnen',
        weeks: 'weken verzonden',        
        details: 'Productgegevens',
        wl: 'Aanmelden wachtlijst',
        guarantee: 'weken verzonden',
        made: 'Gemaakt in de EU',
        designed: 'Designed in EU',
        superb: 'Uitstekende kwaliteit gegarandeerd',
        similar: 'VERGELIJKBARE PRODUCTEN',
        like: 'Misschien vindt u ook dit leuk',
        shop: 'Winkelen per categorie',
        sell: 'Verkoopt snel',
        menu: [
            'KRACHT',
            'TUIGEN & REKKEN',
            ...
            'CONDITIE',
            'LICHAAMSGEWICHT',
            'BENODIGDHEDEN VOOR DE SPORTSCHOOL',
            'KLEDING EN ACCESSOIRES',
            'SETS',
            'ACCESSOIRES VOOR TRAINING',
    ...
    se: {
        ...
        demand: 'Efterfrågan på den här produkten är mycket hög',
        order: 'Beställ idag och få din leverans inom',
        weeks: 'veckor',        
        details: 'Produktuppgifter',
        wl: 'Gå med på väntelistan',
        guarantee: '30-dagars pengarna-tillbaka-garanti',
        made: 'Tillverkad i EU',
        designed: 'Designed in EU',
        superb: 'Superb kvalitet garanteras',
        similar: 'LIKNANDE PRODUKTER',
        like: 'du kanske också gillar',
        shop: 'Handla efter kategori',
        sell: 'Säljer snabbt',
        menu: [
            'STRENGTH',
            'STRUKTURER FÖR TRÄNING',
            'POWER MACHINES',
            'KONDITION',
            'EGEN VIKT',
    ...
    cs: {
        ...
        demand: 'O tento produkt je velký zájem.',
        order: 'Objednejte si ještě dnes a vaše objednávka bude odeslána do',
        weeks: 'týdnů',        
        details: 'Detaily produktu',
        wl: 'Přidejte se na čekací listinu',
        guarantee: 'Garance vynikající kvality',
        made: 'Vyrobeno v EU',
        designed: 'Designed in EU',
        superb: 'Garance vynikající kvality',
        similar: 'PODOBNÉ PRODUKTY',
        like: 'možná se vám bude líbit také',
        shop: 'Nakupovat podle kategorií',
        sell: 'Rychle se prodává',
        menu: [
            'POSILOVACÍ',
            'KLECE A STOJANY',
            'POSILOVACÍ STROJE',
