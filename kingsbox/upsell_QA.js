...
const translations = {
    ...
    nl: ['Accessoires', 'Lägg till i kundvagn', 'Er zijn nog geen producten in deze categorie', 'Er zijn nog geen producten in deze productcategorieën'],
    se: ['Tillbehör', 'Lägg till i kundvagn', 'Det finns inga produkter i denna kategori ännu', 'Det finns inga produkter i dessa produktkategorier ännu'],
    cs: ['Příslušenství', 'Přidat do košíku', 'V této kategorii zatím žádné produkty nemáme', 'V těchto produktových kategoriích zatím žádné produkty nemáme'],
