setTimeout(function () {
    ...
    let product = window.location.pathname.split('/')[2].split('-')[0]
    ...
    let propForProduct = {
        'london': {
            ...
            review: ['The technology is seamless! The ambience feature is one of my favourite things about these headphone, especially when your trying to concentrate. They are easy to connect and are compatible with every device I have. The in-ear detection is honestly amazing, and the fact they start playing what ever was last on when you put them in again is awesome! If your gonna buy headphones, buy these!', 'Maria']
        ...
        'stockholm': {
            ...
            lt: ['4', textList[34]],
            prop: ['14', '16', '2', '1'],
            review: [`This is the third pair of Stockholm plus I've bought as gifts for family. Great quality, sound and stylish. Very good value too.`, 'Catherine B.']
        },
        'paris': {
            bl: ['20', textList[33]],
            lt: ['5', textList[34]],
            prop: ['7', '14', '19', '2', '1'],
            review: [`I've been using the Urbanista Paris now for about two weeks and really like them! They feel good, they look nice and the sound quality is good as well. The passive noise cancellation works fine. They come with a nice charging case which lasted for about a week before I had to charge the case again. Absolut recommendation if you don't wan't to spend a fortune on headphones.`, '']
        },
        'miami': {
            lt: ['50', textList[1]],
            prop: ['11', '0', '13', '8', '6', '2', '1'],
            review: [`There are so many great things to say about the Urbanista Miami Wireless Headphones that I don't even know where to start. They have a stylish and beautiful design and a wonderful soft-touch feel. The headband and ear-cups are nicely padded and totally comfortable. The sound quality is top-notch, including rich bass. The ambient feature works better than expected allowing you to hear everything around you as if your headphones weren't even on. The travel case is an added bonus, I wish more brands included this. Most brands just give you a pouch, not a nice hard case. If a friend or family member asked me to recommend a pair of headphones, I would happily recommend these.  
        `, 'Andy R.']
        },
        'boston': {
            lt: ['6', textList[1]],
            prop: ['4', '16', '20', '1'],
            review: ['First set of earphones that give me a good ear fit while using. No slipping and great sound. Love my Boston earphones!', 'Julie C.']
        },
        'sydney': {
            lt: ['5', textList[1]],
            prop: ['3', '17', '2', '1'],
            review: [`This speaker is amazing, I purchased it because I wanted a small speaker for when we're out and about, on a picnic etc. It is the perfect size, could easily fit in a handbag, The sound quality is fantastic and the volume it can reach is perfect. I was really surprised at what a wonderful buy this was.`, 'Rebecca G.']
        },
        'brisbane': {
            lt: ['10', textList[1]],
            prop: ['3', '2', '1'],
            review: [`Looks unreal, fits on my fireplace, bookshelf, coffee table and doesn’t look out of place, fits in the bag easily. Doesn’t look cheap or tacky like most of the competition. Sounds good, deep and can go loud!`, 'David S.']
        },
        'athens': {
            bl: ['32', textList[33]],
            lt: ['8', textList[34]],
            prop: ['14', '7', '4', '18', '2', '1'],
            review: [`I purchased these late last year and have been using them for a while now. I have tried Beats and a few other brands but the charging case and size of the some of the competitors make them cumbersome to carry around. The Athens are the perfect size. Easily portable, fast charging and comfortable to wear while at work or out at play. The carrying case is small and fits comfortably in my pocket for quick and easy charging while on the go. The earbuds fit nice and snug in my ears and provide exceptional sound quality with good hi and low end audio sound. They are great for outdoors as well as the gym as i have never had one fall out of my ear during activity. Voice quality on phone calls is exceptional as well. I would definitely recommend these to anyone looking for great set of earbuds at an affordable price. 
        `, 'Aaron D.']
        },
        'new': {
            bl: ['25', textList[1]],
            prop: ['11', '9', '2', '1'],
            review: [`With the medium prize range you get authentic sound and quality. Despite the genre of music these bad boys delivers the top notch sound. Im glad I bought these.
        `, 'Miska']
        },
        'seattle': {
            bl: ['12', textList[1]],
            prop: ['5', '9', '3', '2', '1'],
            review: [`Love my black seattle wireless headphones, feels really comfortable with clear sound, bluetooth is stable and easy to change tracks and volume, folding feature makes easy to carry. Great value for money.
        `, 'Matt']
        },
        'san': {
            prop: ['9', '2', '3'],
            review: [`I really love that Urbanista provides plastic ended headphones. They're really the best fit for me and are sadly becoming less prevalent.`, 'Sulaiman K.']
        },
        'madrid': {
            bl: ['4', textList[1]],
            prop: ['9', '3', '2', '1'],
            review: [`These are awesome headphones. Easy to use. Easy to connect and easy to change. Perfect to walks or just relaxing.`, 'Annmaree B.']
        },
        'berlin': {
            bl: ['4', textList[1]],
            prop: ['10', '9', '3', '2', '1'],
            review: [`Excellent purchase. Thoroughly pleased with them. Good sound quality. Easy to manage. Also great idea for a gift. Recommend them 100%.`, 'Soraya P.']
        },
        'lyon': {
            prop: ['7'],
            review: [`So easy to set up that I didn’t realise it was on. Charged my Paris very quickly, and also my iPhone. Yet another great product from Urbanista.
        `, 'Stuart P.']
        },
        'detroit': {
            bl: ['12', textList[1]],
    ...
    document.querySelector(
        '.swatch-title',
    ).innerHTML = `<span class='swatch-title--color'>${textList[41]
    }: </span> ${document.querySelector('.swatch-option.selected').ariaLabel
        }`;
    ...
    document.querySelectorAll('.swatch-option').forEach((e) =>
        e.addEventListener('click', () => {
            document.querySelector(
                '.swatch-title',
            ).innerHTML = `<span class='swatch-title--color'>${languages[local].color
            }: </span> ${document.querySelector('.swatch-option.selected')
                .ariaLabel
                }`;
        }),
    );
    ...
    // read more
    document
        .querySelector('.product-info-main .product.attribute.overview')
        .getElementsByClassName('value')[0].children[0].style.position =
        'relative';

    document
        .querySelector('.product-info-main .product.attribute.overview')
        .getElementsByClassName('value')[0]
        .children[0].insertAdjacentElement(
            'beforeend',
            document
                .querySelector(
                    '.product-info-main .product.attribute.overview',
    ...
    // localization Read 241 Reviews
    // document.querySelector('.yotpo-stars').innerText += `${languages[local].read} ${document.querySelector('.yotpo-stars').innerText}` 

    // add to cart button
    // document.querySelector('.action.primary.tocart').getElementsByTagName('span')[0].innerText += ` - ${document.querySelector('.product-info-main .price').innerText}`
    document
    ...
    // product properties
    document.querySelectorAll('.pd-row')[9].setAttribute('id', 'specs-block')
    drawProdProp()

    // view specs scroll logic
    // $(".view-block span").click(function (e) {
    //     e.preventDefault();
    //     $('html,body').animate({scrollTop:$('#specs-block').offset().top - 430 + "px"},{duration:1E3});
    // })
...
`;
    ...
    document.querySelector('.slick-dots').insertAdjacentHTML('afterBegin', `
  <img class='prev-arrow' src='https://conversionratestore.github.io/projects/urbanista/images/arrow-next.svg'/>
`)
    document.querySelector('.slick-dots').insertAdjacentHTML('beforeEnd', `
...
`;
    ...
    function drawProdProp() {
        ...
        if (currentPropList.bl) {
            t += drawTimeBat(currentPropList.bl[0], currentPropList.bl[1])
        }

        if (currentPropList.lt) {
            t += drawTimeLis(currentPropList.lt[0], currentPropList.lt[1])
        }
        currentPropList.prop.map((i) => {
            t += drawpropBlockImg(propList[i][0], propList[i][1], propList[i][2])
        })
        t += `<div class='view-block'><span>${textList[39]} ></span></div>`

        properties.innerHTML = t
        document.querySelector('.product.media').insertAdjacentElement('afterend', properties)
    };
