...
.note_block p {
  ...
  class u {
    ...
    handleSubscriptionPage() {
      ...
      ), e(".crs_style") || document.head.insertAdjacentHTML("beforeend", `<style class="crs_style">${C}</style>`), this.renderTitleBlock(), this.renderEmailBlock(), this.renderNoteBlock(), this.renderPeopleJoinedBlock(), this.renderGuaranteeBlock(), this.replaceTxtBtnGetStarted();
    }
    renderTitleBlock() {
