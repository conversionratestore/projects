...
@media (max-width: 376px) {
  ...
  class C {
    ...
    init() {
      g({ name: "Improvements on the paywall screen (new section structure + Locker mechanics)", dev: "SKh" }), y("exp_6", "variant_2"), this.observeMain(), this.allFunctionsInitHandler();
    }
    observeMain() {
