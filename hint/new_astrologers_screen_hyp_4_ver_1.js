(function() {
  ...
  (function(t) {
    t = t === void 0 ? {} : t;
    let e, n, o, r, i = (t == null ? void 0 : t.delay) || 50;
    function a() {
      e = null, r = 0;
    }
    return a(), function() {
      return n = window.scrollY, e != null && (r = n - e), e = n, clearTimeout(o), o = setTimeout(a, i), r;
    };
  })();
      ...
      <ul class="astrologers_list">
        <li class="astrologer_item best_for_you">
          <div class="img_wrapper">
            <img src="${p}astrologer_jane.png" alt="astrologer photo" />
          </div>
          <div>
        ...
        <li class="astrologer_item">
          <div class="img_wrapper">
            <img src="${p}astrologer_akho.png" alt="astrologer photo" />
          </div>
          <div>
        ...
        <li class="astrologer_item decoration">
          <div class="img_wrapper">
            <img src="${p}astrologer_kate.png" alt="astrologer photo" />
          </div>
          <div>
  ...
  class m {
    ...
    allFunctionsInitHandler() {
      ...
      if (this.checkPage() === "paywall")
        ...
        let i = setInterval(() => {
          s(".subscription_plan_page main") && (clearInterval(i), s(".subscription_plan_page main").classList.add("is_hidden"));
        }, 300);
        ...
        console.log(this.checkPage()), (o = s(".new_btn_back")) == null || o.remove(), (r = s(".new_astrologers_screen")) == null || r.remove(), e.classList.contains("subscription_plan_page") && e.classList.remove("subscription_plan_page");
    }
    // subscription-plan
      ...
      l("[data-nextBtn]").then((e) => {
        ...
        n.forEach((r) => {
          r.addEventListener("click", () => {
            var i;
            c("exp_new_astro_button_01", "Continue", "Click", "palm readers"), o.style.display = "block", o.classList.contains("is_hidden") && o.classList.remove("is_hidden"), (i = s(".new_astrologers_screen")) == null || i.remove(), localStorage.setItem("newAstrologersScreen", "yes"), this.renderNewBtnBack();
          });
        });
      });
    }
      ...
      l(".radio_item label").then((e) => {
        _(".radio_item label").forEach((o) => {
          o.addEventListener("click", (r) => {
            var i, a;
            this.storage = r.currentTarget.previousElementSibling.getAttribute("value").trim(), localStorage.setItem("newAstrologerValue", this.storage), c("exp_new_astro_button_06", this.storage, "Click", "palm readers"), (i = s(".new_continue_btn")) != null && i.classList.contains("is_disabled") && ((a = s(".new_continue_btn")) == null || a.classList.remove("is_disabled"));
          });
        });
      });
    }
    ...
    observeMain() {
      new MutationObserver((n) => {
        for (let o of n) {
          ...
          for (let r of o.removedNodes)
            r instanceof HTMLElement && r.tagName === "MAIN" && this.checkPage() === "email" && this.allFunctionsInitHandler();
        }
