...
const html = /*html*/`
    <main class="pdp_main">
        ...
        <section id="faq" data-section="faq">
            <article>
                <div class="content" data-visibility="Visibility FAQ section" data-ga-label="FAQ">
    ...
    if (typeof jQuery === 'function') {
        ...
        const waitForSlick = setInterval(() => {
            if (typeof jQuery.fn.slick === 'function'
                ...
                //     let hasCurrentClass = $currentSlide.hasClass('slick-current')

                //     // Add 'slick-current' class to the current slide if it doesn't already have it
                //     if (!hasCurrentClass) {
                ...
                // // custom arrow
                // $('.slider_nav_wrap .slick-prev').on('click', function () {
                //     let currentSlide = $('.slider_nav').slick('slickCurrentSlide')

                //     if ($('.slider_nav .slick-slide:last').hasClass('slick-current')) { // fix if last item is active
                //         document.querySelectorAll('.slider_nav .slick-slide')[totalSlides - 2]?.click()
                //     } else {
                //         document.querySelectorAll('.slider_nav .slick-slide')[currentSlide - 1]?.click()
                //     }
                // })

                // $('.slider_nav_wrap .slick-next').on('click', function () {
                ...
                //         $('.slider_for_wrap').removeClass('hideLabels')
                //     }
                // })

                // $('.slider_for').on('afterChange', function (event, slick, currentSlide) {
                //     // Play video of current slide if it exists
                //     var currentVideo = $(slick.$slides[currentSlide]).find('video')
                //     if (currentVideo.length) {
                //         $('.slider_for_wrap').addClass('hideLabels')
