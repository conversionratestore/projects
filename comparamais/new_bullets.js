...
const styles = `
  ...
  .my_list li:first-child {
    background-image:url('https://conversionratestore.github.io/projects/comparamais/img/feedback.svg');
  }
  .my_list li:first-child + li {
    background-image:url('https://conversionratestore.github.io/projects/comparamais/img/justice.svg');
  }
  .my_list li:first-child + li + li {
    background-image:url('https://conversionratestore.github.io/projects/comparamais/img/bellboy.svg');
  }
  .my_list li:last-child {
    background-image:url('https://conversionratestore.github.io/projects/comparamais/img/bank.svg');
    margin-bottom: 0;
  }
  .container--hero .page__title { padding-top: 0px !important; }
  .container--listing .in__grid .page__title .header-list, .container--edit .in__grid .page__title .header-list, .container--hero .header-list {
    display: none;
  }
...
let startFunk = setInterval(() => {
    if (document.querySelector('#hlApp')) {
        ...
        if (!location.search.includes('experiment=HL-Simulator-New_Bullets')) {
            if (location.search) {
                window.history.replaceState(
                    null,
                    null,
                    location.search + '&experiment=HL-Simulator-New_Bullets'
                );
            } else {
                window.history.replaceState(
                    null,
                    null,
                    '?experiment=HL-Simulator-New_Bullets'
                );
            }
        }
        ...
        if (document.querySelector('.header-list')) {
            ...
            const list = `
                <ul class="my_list">
                    ...
                    <li>Compare todos os créditos</li>
                    <li>Acompanhamento especializado</li>
                    <li>Regulado pelo Banco de Portugal</li>
                </ul>
            `

            document.querySelector('.header-list').insertAdjacentHTML('beforebegin', list)

            const waitForEl = setInterval(() => {
                if (document.querySelector('.my_list')) {
                    clearInterval(waitForEl)

                    document.querySelector('.my_list').addEventListener('mouseover', (e) => {
                        if (e.target.matches('li')) {
                            gaEvent(`hover or click on ${e.target.innerText}`, document.querySelector('.simulator-step strong')?.innerText.trim())
                        }
                    })
                    ...
                    if (screen.width <= 768) {
                        ...
                        observer.observe(document.querySelector('.my_list'))
                    }
                }
            }, 100)
        }
