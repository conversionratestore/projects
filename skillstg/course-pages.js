...
.offer_section .main p.day {
    ...
    width: fit-content;
    white-space: nowrap;
    ${window.location.href.includes(arrlinks[1]) || window.location.href.includes(arrlinks[4]) ? 'text-transform: lowercase;':''}
}
...
let courseInit = (course) =>  {
    ...
    let numberImage = course.index == 0 ? '0,1,2,3,4' : 
                        ...
                        course.index == 3 ? '16,15,17,18,19,20' : 
                        '21,15,17,18,19,20';
    ...
    return `
        ...
        <section class="offer_section">
            ...
            <div class="container">
                ...
                ${course.index < 4 && course.index > 0 ? '<div class="flex-center offer_certificate">'+
