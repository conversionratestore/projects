...
<style>
    ...
    .wrapper::after {
        ...
        height: 100%;
        width: 100%;
        background: linear-gradient(0.24deg, #FFFFFF 12%, rgba(255, 255, 255, 0) 20%);
    }
    ...
    const shiftsHTML = getRandomItems(shifts, 5).map(job => `
<div class="slide">
    ...
    <main class="main_wrapper">
        <section class="message_section">
            <div class="content">
                ...
                <p class="subtitle">The final step is to <b>complete an onboarding / document check session</b> in one of our offices in order to start making extra money with Upshift.</p>
                <div class="box timer">
                    <p class="box_title">We'll email and text you the available times of the session in …</p>
                    <p class="time"></p>
                </div>
                <div class="box message" hidden>
                    <p class="box_title">The text and email with available slots have been sent!</p>
                    <p class="check_mail">Please check your email / phone</p>
                    <div class="info">
                        <img src="${imgFolderLink}/info_blue.svg" alt="info">
                        <p>In case you cannot find the email from us, please check your spam folder</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="video_section">
            <div class="content">
                ...
                <div class="video_wrapper">
                    ...
                    <iframe id="video_youtube" height="185" src="https://www.youtube.com/embed/vzHr6bWaw0M?enablejsapi=1&origin=${window.location.origin}" frameborder="0"
                    ></iframe>
                </div>
                <div class="some-txt">
                    <p><b>The in-person onboarding</b> is a short informative session in our office.</p>
                    <p>During this onboarding, you will complete tax paperwork and receive a brief orientation on how to use Upshift.</p>
                    <p>You’ll be able to pick up shifts through our app as soon as the meeting is finished!</p>
                </div>
...
function runVideoEvents() {
    ...
    function onPlayerReady() {
        ...
        const waitForEl = setInterval(() => {
            if (document.querySelector('.lds-ring') && document.getElementById('video_youtube')) {
                clearInterval(waitForEl)
