...
window.onload  = function () {
  ...
  document.querySelector('.tour-intro').insertAdjacentHTML('beforebegin',`
  ...
  <section class="tour-section">
      <div class="container d-flex flex-wrap">
          <div class="left">
              ...
              <div class="brands">
                  <img src="${dir}/brands.png" alt="brands image">
              </div>
          </div>
          <div class="right">
  ...
  document.querySelector('.tour-section .breadcrumbs').innerHTML = document.querySelector('.tour-intro .breadcrumbs ul').innerHTML; //breadcrumb
  document.querySelector('.tour-section h1').innerHTML = document.querySelector('.tour-intro h1.dest_title').innerHTML; //title
  ...
  for (let i = 0; i < descrObj.length; i++) {
      ...
      if (document.querySelector(`.destination_page_wr .tour-intro .destination_descr .item .${icon}`) != null) {
          let info = document.querySelector(`.destination_page_wr .tour-intro .destination_descr .item .${icon}`).nextElementSibling.innerText.trim();
  ...
  if (document.querySelector('.tour-drinks .main_subheading') != null) {
