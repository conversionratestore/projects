    ...
    if (sessionStorage.getItem('old_version') == null && document.readyState == 'complete') { 
            ...
            let shipFormHtml = (sibling, state, countries_ship, active, edit) => {
                ...
                <form class="ship-form ${edit} ${active}">
                    ...
                    <dd style="width: 100%;float:left;padding-right: 8px">
                        ...
                        <input type="text" name="email" placeholder="email@mail.com" value="${mm_e != null ? mm_e : ''}">
                        <i></i>
                    </dd>
                    <dd style="width: 50%;float:left;padding-right: 8px">
        ...
        if (!href.includes('login') && !href.includes('register.php') && !href.includes('/checkout') && !href.includes('/guest-checkout') && !href.includes('/guest-paypal')) {
            ...
            <div class="shopping-cart">
                <div class="container">     
                    ...
                    <div class="footer-cart flex flex-center-between">
                        ...
                        <p>or</p>
                        <a href="/cart.html" class="btn-next items-center flex">
            ...
            *:-ms-input-placeholder {
            ...
            .ais-ClearRefinements-button--disabled, .ais-RefinementList-showMore--disabled {
                display: none!important;
            }
            .listing_wrapper .ais-InfiniteHits-loadMore {
                opacity: 0;
            }
            ...
            window.addEventListener('scroll', (e) => {
                remActiveSelect();
                if ((window.innerHeight + window.scrollY).ceil() >= document.body.offsetHeight) {
                            ...
                            <nav id="breadcrumbs-pdp" class="breadcrumbs">
                                <ul class="ais-Breadcrumb-list">
                                    <li class="ais-Breadcrumb-item">
                                        <a class="ais-Breadcrumb-link" href="https://medicalmega.com/" onclick="pushDataLayer('Click on crumb - Home', 'Breadcrumbs')">Home</a>
                                    </li>
                                    <li class="ais-Breadcrumb-item">
                                        <span class="ais-Breadcrumb-separator" aria-hidden="true">&gt;</span>
                                        <a class="ais-Breadcrumb-link" href="https://medicalmega.com/?products%5BhierarchicalMenu%5D%5Bcategories.lvl0%5D%5B0%5D=${product.categories['lvl0'][0].split(' &').join('%20%26')}" onclick="pushDataLayer('Click on crumb - ${product.categories['lvl0'][0]}', 'Breadcrumbs')">${product.categories['lvl0'][0]}</a>
                                    </li>
