...
const style = /*html*/`
    <style>
        ...
        .list li::before {
            ...
            width: 16px;
            height: 16px;
            background: url(${IMAGE_DIR_URL}/list_check.svg) no-repeat center center;
            background-size: cover;
        }
...
const content = /*html*/`
    <section class="choose_plan">
        ...
        <ul class="list">
            <li>“Plays Like” Distances with wind speed and elevation</li>
            <li>Green Reading Maps for 13,000+ courses</li>
            <li>Enhanced Scorecard & Stats</li>
            <li>Biggest Library of Performance Practice Drills and Videos</li>
            <li>Stats & Performance Comparison vs. Your Target Handicap</li>
            <li>Relative Handicap for Each Facet of your game</li>
        </ul>
        <div class="plans_comparison_table_container">
            <div class="features">
                <div>
                    <img src="${IMAGE_DIR_URL}/golf_ball.svg" alt="">
                    <p>Compare all features</p>
                </div>
                <img src="${IMAGE_DIR_URL}/green_arrow.svg" alt="">
            </div>
    ...
    if (document.querySelector('.main-column')) {
        ...
        waitForElement('.features').then(el => {
            el.addEventListener('click', () => {
                document.querySelector('.list').classList.toggle('hide_list')
