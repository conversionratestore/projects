...
let isFee = setInterval(() => {
  if (
    ...
    // $$('.table-custom tr th')[4].innerText = 'Bearbeitungsgebühr'
    // $$('.table-custom tr td')[4].innerText = fee
    ...
    // $$('.table-custom tr td')[4].innerText = ''
    // $$('.table-custom tr th')[4].innerText = ''
...
let isBtnForward = setInterval(function() {
  if($('.woocommerce-message .button.wc-forward')) {
    ...
    $$('.table-custom td')[4].innerHTML = remove
