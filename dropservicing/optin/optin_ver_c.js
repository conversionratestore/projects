...
.crs_v2 #main_block .hero_wrapper .info {
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start;
...
.crs_v2 #main_block .video_wrapper::before {
  position: absolute;
  content: "";
  bottom: 34px;
  right: -20px;
...
.crs_v2 #main_block .video_wrapper::after {
  position: absolute;
  content: "";
  bottom: 34px;
  left: -20px;
...
.crs_v2 #main_block .video_wrapper .video .wistia_embed {
  border-radius: 20px;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div {
  border-radius: 20px !important;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div .w-css-reset {
  border-radius: 20px !important;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div .w-css-reset-tree.w-bpb-wrapper > div {
  width: 80px !important;
  display: none !important;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div .w-css-reset-tree.w-bpb-wrapper button {
  width: 80px !important;
  height: 52px !important;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div .w-css-reset-tree.w-bpb-wrapper button > svg {
  width: 80px !important;
  height: 100% !important;
}
.crs_v2 #main_block .video_wrapper .video .wistia_embed > div .w-css-reset-tree.w-bpb-wrapper button > svg rect {
  fill: red;
}
@media (max-width: 768px) {
  .crs_v2 #main_block .video_wrapper {
  ...
  .crs_v2 #main_block .video_wrapper::before, .crs_v2 #main_block .video_wrapper::after {
    content: unset;
  }
  .crs_v2 #main_block .video_wrapper .video {
    width: 100%;
...
.crs_v2 #main_block .crs_stories::before {
  ...
  border-bottom: 30px solid rgba(42, 51, 128, 0.7);
}
.crs_v2 #main_block .crs_stories.is_hidden {
  display: none;
}
...
.crs_v2 #main_block .loader {
  border: 5px solid #f3f3f3;
  border-top: 5px solid #17aa1c;
  border-radius: 50%;
  width: 70px;
  height: 70px;
...
.crs_v2 #main_block .loader.is_hidden {
  display: none;
}
@keyframes spin {
  0% {
...
@media (max-width: 768px) {
  ...
  .crs_v2 .blokers .blokers_list.is_open {
    max-height: 1550px;
  }
}
...
.crs_v2 .blokers .blokers_list li {
...
.crs_v2 .blokers .blokers_list .blokers_item {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  width: 100%;
...
.crs_v2 .blokers .blokers_list .blokers_item > div > svg {
  width: 80px;
  height: 80px;
  flex-shrink: 0;
  margin: 0 0 14px;
...
.crs_v2 .blokers .blokers_list .blokers_item > div p {
  color: #161718;
...
.crs_v2 .blokers .blokers_list .blokers_item .btn_see_details {
  display: flex;
  align-items: center;
...
.crs_v2 .blokers .blokers_list .blokers_item .btn_see_details .arrow_btn_icon {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 35px;
...
@media (max-width: 768px) {
  .crs_v2 .blokers .show_more_block {
  ...
  .crs_v2 .blokers .show_more_block.is_open svg {
    transform: rotate(180deg);
  }
}
.crs_v2 #base_review {
...
.crs_v2 #base_review ul .slide::after {
  content: "";
  position: absolute;
  bottom: -25px;
  left: 0;
...
.crs_v2 footer .crs_container p:nth-child(3) a {
  text-decoration: underline;
  color: #dcdcdc;
}
...
.crs_v2 .info_block .info_item .info_icon img {
  width: 100%;
  height: 100%;
  -o-object-fit: contain;
     object-fit: contain;
...
.crs_v2 .crs_blockers_popup .crs_blockers_content .info_wrapper .sticky_btn_wrapper_desktop {
  position: sticky;
  bottom: 0;
  left: 0;
  background: white;
...
.crs_v2 .crs_exit_popup .crs_exit_content .crs_main_info .no_btn {
  ...
  margin: 25px auto 0;
  cursor: pointer;
}/*# sourceMappingURL=style.css.map */`, N1 = (e, i, r, a = "") => {
  ...
  (function(e) {
    e = e === void 0 ? {} : e;
    let i, r, a, c, h = (e == null ? void 0 : e.delay) || 50;
    function l() {
      i = null, c = 0;
    }
    return l(), function() {
      return r = window.scrollY, i != null && (c = r - i), i = r, clearTimeout(a), a = setTimeout(l, h), c;
    };
  })();
  const D = (e, i, r, a = "") => {
    window.dataLayer = window.dataLayer || [], window.dataLayer.push({
      ...
      event_type: r,
      event_loc: a
    }), W1(`Event: ${e} | ${i} | ${r} | ${a}`, "success");
  }, q1 = (e, i) => {
    const r = setInterval(() => {
      const a = document.querySelector(e);
      a && (clearInterval(r), i(a));
    }, 100);
  };
  class F1 {
    constructor(i) {
    ...
    on(i, r, a) {
      return typeof r == "function" && (a = r, r = ""), this.elements.forEach(function(c) {
        c.addEventListener(i, function(h) {
          var l;
          if (r !== "") {
            let p = (l = h.target) == null ? void 0 : l.closest(r);
            p && (a == null || a.call(p, h));
          } else
            a == null || a.call(c, h);
        });
    ...
    style(i, r) {
      const a = i.split("-").map((c, h) => h === 0 ? c : c.charAt(0).toUpperCase() + c.slice(1)).join("");
      return this.elements.forEach(function(c) {
        c.style[a] = r;
      }), this;
    }
  }
  const d = (e) => new F1(e), R1 = (e) => {
    const i = document.querySelector(e);
    if (!i)
      return;
    const a = i.getBoundingClientRect().top - 100;
    window.scrollBy({
      top: a,
      behavior: "smooth"
    });
...
`,
  ...
  `
  ...
  ], yi = [
    {
      ...
      button: `See details <span class="arrow_btn_icon">${L.arrowBtnIcon}</span>`,
      popupContent: {
        icon: L.blockersIcon1,
        title: "I feel stuck in the 9-to-5 grind with no time, freedom, or flexibility to enjoy my life.",
        text: "<p>Feeling stuck in a 9-to-5 grind can drain your time, freedom, and flexibility. This free training introduces a business model built for a lifestyle of freedom: Drop Servicing.</p> <p>All you need is a laptop and an internet connection to get started. Leveraging simple tools of modern technology, you’ll learn how to create an online business that lets you work from anywhere and earn on your terms.</p> <p>The training provides step-by-step guidance, done-for-you templates, and proven strategies, so you can escape the daily grind and design a life you love without taking big risks like giving up your current job.</p>",
    ...
    },
    {
      ...
      popupContent: {
        ...
        text: "<p>Financial freedom starts with the right strategy, and this free training delivers just that.</p> <p>You’ll discover a 4-step system to build a Drop Servicing business—an online model that connects clients with services to create recurring income.</p> <p>It’s affordable, beginner-friendly, and requires no inventory, startup costs or technical skills.</p> <p>The process is broken into clear actionable steps, helping beginners work toward consistent monthly income.</p> <p>Whether you want to earn extra on the side or replace your job entirely, this training provides the tools to achieve it.</p>",
        button: "Access Your Free Training Now!",
        video: "ox92uv10uy",
        review: {
    ...
    {
      id: 3,
      icon: L.blockersIcon3,
      text: "I’m struggling to boost my income without sacrificing all my free time or taking big risks.",
      button: `See details <span class="arrow_btn_icon">${L.arrowBtnIcon}</span>`,
      popupContent: {
        icon: L.blockersIcon3,
        title: "I’m struggling to boost my income without sacrificing all my free time or taking big risks.",
        text: "<p>This free training is perfect for anyone wanting to increase their income in a flexible way.</p> <p>You’ll discover how to build a Drop Servicing business that fits your schedule and learn strategies to land your first high-value client using low-risk methods and time-saving automation.</p> <p>With done-for-you templates and a beginner-friendly process, you’ll gain the tools to grow at your own pace and create a scalable recurring income stream—whether as a side hustle or a full-time business.</p>",
        button: "Access Your Free Training Now!",
        video: "8mgchi8e3u",
        review: {
          reviewerPhoto: `${wn}avatar_1.png`,
          reviewerName: "Ed",
          reviewText: "“Ed used our strategies to boost his income and earned 6 figures within his first year”",
          stars: `${wn}rating_stars_new.png`
        }
      }
    },
    ...
    {
      name: "Keely",
      review: '"Keely went from a draining corporate job to building her own business and gaining total control over when and where she works, all through our 4-step process."',
      img: "kelly.jpg",
      videoId: "li713im4h6"
    },
    {
      name: "Stephen",
      review: '"After losing his job, Stephen found our training and turned things around, landing his first client in weeks. He’s now traveling the world with his laptop business."',
      img: "stephen.jpg",
      videoId: "hil0o6ude6"
    },
    {
    ...
    {
      name: "Gehadul",
      review: '"Gehadul used our 4-step system to quickly secure his first Drop Servicing sales and has since built several successful businesses with this method."',
      img: "gehadul.jpg",
      videoId: "setchjy39v"
    }
  ], Y1 = [
    ...
    },
    {
      ...
      text: "I am extremely satisfied with the Drop Servicing Blueprint course! The content is incredibly in-depth and packed with tons of valuable material that is well-structured and easy to follow.<br><br>Thanks to the course, I’ve already bagged a couple of sales and am eager to continue expanding my business with the insights and strategies I've learned. Fully satisfied and highly recommend!",
      date: "Aug 27, 2024",
    ...
    },
    {
      ...
      text: "This is my first ever online review because, damn! This course deserves an online review.<br><br>Since 2010, I have started so many online businesses. From E-commerce to affiliate marketing to trading. If it has trended, I have tried it.<br><br>I just launched my first campaign using the guide in the course and have a few interested clients I am meeting with. This is so surreal. I can't believe am finally running my own business.",
      date: "Oct 7, 2022",
    ...
    {
      name: "Maswood Abdus Sakur",
      title: "Dylan's course is an absolute…",
      text: "Dylan's course is an absolute game-changer! From A to Z, it covers everything with insightful materials and practical templates. The supportive community, daily guidance & support, and weekly live calls with different mentors, including Dylan, make it truly exceptional. It's not just a course; it's a positive and energetic journey that has become the best investment in my life. Highly recommend!",
      date: "Dec 27, 2023",
      link: "https://www.trustpilot.com/reviews/658bb218247a1f1d02cadea1"
    },
    {
      name: "Andy Jay",
      title: "Exceeded Expectations",
      text: "The course starts off with a lot of mindset exercises that I felt really got me out of my funk and into a deeper state of motivation. Then, the rest of the course is jam-packed with so many resources, yet done in a way that doesn't make you feel overwhelmed.<br><br>Also, for everything he offers, I've paid, and I'm not even exaggerating... 10x more for other courses that are not nearly as good. So, if you're looking for a way to break out of the 9-5 rat race, this course is your best shot. Invest in yourself and get to work!",
      date: "Oct 8, 2022",
    ...
    {
      name: "Andrej",
      text: '"Andrej used the Drop Servicing method to build an automated business from his laptop using freelancers and software to make life easier."'
    },
    {
      name: "Philipp",
      text: '"By applying just one strategy from our training, Philipp landed his first client in weeks and built a hands-off business with recurring revenue."'
    },
    {
      name: "Ipek",
      text: '"Ipek, a young student with no experience or resources, doubted she could start an online business. But with our strategies, she landed her first clients soon after launching and hasn’t looked back."'
    },
    {
      name: "Yash",
      text: '"Yash used the free templates and tutorials from the training to land his first clients. He now follows the same method whenever he needs more."'
    }
  ], Li = [
    {
      name: "Derik",
      text: '"Derik left behind the stress of his 9-to-5 job after building a Drop Servicing business, giving him the freedom to live life on his own terms."'
    },
    {
      name: "Steve",
      text: '"Steve went from long hours in a corporate cubicle to a life of freedom, earning 7 figures per year with a business that runs itself."'
    },
    {
      name: "Fredrik",
      text: '"Fredrik used Drop Servicing to build a 6-figure business that provides financial security and freedom for his family."'
    },
    {
      name: "Albert",
      text: '"After countless setbacks with other business models, Albert found success in Drop Servicing and finally achieved financial freedom."'
    }
  ], H = "https://conversionratestore.github.io/projects/dropservicing/optin/img", Ti = (
    /* HTML */
    `
  ...
  <div class="crs_stories">
    ...
    <div class="crs_stories_block">
      ...
      (e, i) => `<span class="${i === 0 ? "active" : ""}">
                <img src="https://conversionratestore.github.io/projects/dropservicing/popups/img/${e.name}.png" alt="avatar" />
              </span>`
    ).join("")}
      </div>
      ...
      (e, i) => (
        ...
        `<div class="crs_story ${i === 0 ? "active" : ""}">
                <div class="crs_story_head">
                  <span>
                    <img
                      src="https://conversionratestore.github.io/projects/dropservicing/popups/img/${e.name}.png"
                      alt="avatar"
                    />
                  </span>
                  <p>
                    <b>${e.name}</b><br />
                    <span>Verified Customer <img src="${H}/check_exit_img.png" alt="icon" /> </span>
                  </p>
                </div>
                <img src="${H}/rating_stars.png" alt="stars" />
                <p>${e.text}</p>
              </div>`
      )
    ).join("")}
  ...
  <div class="crs_stories">
    ...
    <div class="crs_stories_block">
      <div class="crs_stories_nav">
        ${Li.map(
      (e, i) => `<span class="${i === 0 ? "active" : ""}">
                <img src="https://conversionratestore.github.io/projects/dropservicing/popups/img/${e.name}.jpg" alt="avatar" />
              </span>`
    ).join("")}
      </div>
      <div class="crs_stories_content">
      ...
      (e, i) => (
        ...
        `<div class="crs_story ${i === 0 ? "active" : ""}">
                <div class="crs_story_head">
                  <span>
                    <img
                      src="https://conversionratestore.github.io/projects/dropservicing/popups/img/${e.name}.jpg"
                      alt="avatar"
                    />
                  </span>
                  <p>
        ...
        `
            <li>
              <div data-id="${e}" class="blokers_item" data-seedetails>
                ...
                <div class="btn_see_details">${a}</div>
              </div>
            </li>
          `
      )
...
`
  ...
  <div class="trusted_block">
    <img src="${H}/trusted_img.png" alt="img people" />
...
`
  ...
  <div class="safe_and_secure_block">
    <span class="safe_and_secure_icon"> ${L.safeAndSecureIcon} </span>
  ...
  <section id="main_block">
    <div class="wrapper">
      <header>
        ...
        <div class="desktop">${Ti}</div>
      </header>
      <div class="hero_wrapper">
        <div class="info">
          ${Mi}
          <h1>
            ${window.location.href.includes(".net") ? `The 4 steps to start your online business<br />in ${(/* @__PURE__ */ new Date()).getFullYear()} and unlock financial freedom goals` : `The 4 steps to make money online in ${(/* @__PURE__ */ new Date()).getFullYear()}<br />(with no experience or startup costs)`}
          </h1>
        ...
        <div class="mobile stats_mob">${Ti}</div>
      </div>
      ${X1}
    </div>
  </section>
`
  ...
  <section id="base_review">
    ...
    <div class="crs_container">
      <ul class="">
        ${Pt.map(
      ({ name: e, review: i, img: r, videoId: a }) => (
        /* HTML */
        `
              <li>
                <div class="slide" data-video="${a}">
                  <div>
                    ...
                    <p><b>${e}</b><img src="${H}/rating_stars_new.png" alt="stars" /></p>
                  </div>
                  <p>${i}</p>
                </div>
              </li>
        ...
        `
            <li>
              <div class="video_slide" data-video="${a}">
                ...
                <div class="video">
                  <div class="wistia_embed wistia_async_${a}" style="width:100%;height:100%;"></div>
                </div>
              </div>
            </li>
          `
...
`
  ...
  <section id="trust_pilot">
    <div class="crs_container">
      <h2>
        TrustScore&nbsp;<img src="${H}/trustpilot_star.svg" alt="" />&nbsp;<b>4.8/5</b>&nbsp;<span class="desktop"
          >300+ Reviews</span
        >
      </h2>
      ...
      <ul>
        ${G1.map(
      ({ name: e, title: i, text: r, date: a, link: c }) => (
        /* HTML */
        `
              <li>
                <div class="review_slide">
                  <p class="name">${e}<img src="${H}/stars_tp.svg" alt="stars" /></p>
                  <a href="${c}" target="_blank">${i}</a>
                  <p class="text">${r}</p>
                  <p>
                    <span><img src="${H}/check2.svg" alt="check" />Verified User</span>
                  </p>
                </div>
              </li>
            `
    ...
    <div class="points">
      <div class="crs_container">
        <p>3,000+ Members ${L.membersIcon}</p>
        <p>4M+ In Revenue ${L.revenueIcon}</p>
        <p>100+ Countries ${L.countriesIcon}</p>
        <p>15M+ Views ${L.viewsIcon}</p>
      </div>
    </div>
  </section>
`
...
`
  ...
  <section id="last_cta" class="crs_container">
    <div class="img">
      <img src="${H}/product.png" alt="product" />
    </div>
    <div>
  ...
  <footer>
    <div class="crs_container">
      <p>
        ...
        claims made for their products. Sales figures stated or implied are personal sales figures or that of our
        members. Please understand these results are not typical.We are using these as examples of what is possible when
        you commit and take consistent action. We do not guarantee any earnings because your results will vary and
        depend on many factors, including but not limited to your background, experience, and work ethic. All business
        entails financial risk as well as massive and consistent effort and action.
      </p>
      <p>
        ${window.location.href.includes(".net") ? "NOT META: This site is not a part of the Meta website or Meta and is NOT endorsed by Meta in any way." : "NOT GOOGLE: This site is not a part of the Google website, or Google Inc. and is NOT endorsed by Google in any way."}
        <br class="mobile" /><br class="mobile" />
      </p>
      <p>
        <a
          href="https://www.${window.location.href.includes(".net") ? "dropservicing.net/" : "dropservicingblueprint.com/"}"
          >Dylan Sigley Consulting - FZCO</a
        >
        | IFZA Business Park, DDP, Dubai Silicon Oasis | +1 (786) 475-8716 |
        info@${window.location.href.includes(".net") ? "dropservicing.net" : "dropservicingblueprint.com"}
      </p>
      <p>
        <a
          href="${window.location.href.includes(".net") ? "https://www.dropservicing.net/privacy-policy-page" : "https://www.dropservicingblueprint.com/privacy-policy"}"
          >Privacy Policy
        </a>
        <a
          href="${window.location.href.includes(".net") ? "https://www.dropservicing.net/disclaimer-page" : "https://www.dropservicingblueprint.com/earnings-disclaimer"}"
          >Earnings Disclaimer</a
        >
        <a
          href="${window.location.href.includes(".net") ? "https://www.dropservicing.net/terms-and-conditions-page" : "https://www.dropservicingblueprint.com/terms-and-conditions"}"
...
`
  ...
  <div class="crs_popup_form" data-closeform>
    <div class="form">
      <div class="close" data-closeform>${L.closeIconPopup}</div>
      <form class="crs_form">
        <div class="inputs1">
...
`
    ...
    <ul class="time_list">
      ${e.map(({ date: a, schedule: c }, h) => {
        const l = new Date(a).toLocaleString("en-us", { weekday: "long" }), p = new Date(a).toLocaleString("en-us", { month: "long", day: "numeric" }), _ = new Date(a).toLocaleString("en-us", { hour: "numeric", minute: "numeric" }), C = new Date(a).getTime() - (/* @__PURE__ */ new Date()).getTime(), $ = new Date(a).getTime() + 1e3 * 60 * 15, j = new Date($).toLocaleString("en-us", { hour: "numeric", minute: "numeric" }), X = $ - (/* @__PURE__ */ new Date()).getTime(), T = Math.ceil((C < 0 ? X : C) / (1e3 * 60));
        return (
          /* HTML */
          `
            <li class="${h === 0 ? "selected" : ""}" data-schedule="${c}">
              ...
              <span class="comment"
                >Starts in ${h === 0 ? T : Math.ceil(C / (1e3 * 60 * 60))}
                ${h === 0 ? "minutes" : "hours"}</span
              >
            </li>
          `
        );
  ...
  <div class="crs_blockers_popup" data-closeblokers>
    <div class="crs_blockers_popup_container">
      <div class="close" data-closeblokers>${L.closeIconPopup}</div>
...
`
  ), go = (e, i, r, a, c, h, l, p, _) => (
    /* HTML */
    `
    <h3 class="mobile">${h}</h3>
    <div class="video_wrapper">
      ...
      <div class="video">
        <div class="wistia_embed wistia_async_${_}" style="width:100%;height:100%;"></div>
      </div>
    </div>
    <div class="info_wrapper">
      <div class="title_wrapper">
        ...
        <div class="txt_container_abs">
          <div class="txt_container">${l}</div>
        </div>
      </div>
      ${window.innerWidth >= 768 ? `<div class="sticky_btn_wrapper_desktop"><button class="cta pop">${p}</button></div>` : ""}
    </div>
  `
  ), mo = (
    /* HTML */
  ...
  <div class="crs_exit_popup" data-closeexit>
    <div class="crs_exit_content">
      <div class="close" data-closeexit>${L.closeSvgExitPopup}</div>
      <div class="crs_main_info">
        ...
        <div class="crs_list_block">
          <h3>
            <img src="${H}/rocket_icon.png" alt="icon" />
...
`
  ...
  var nt = window, qn = nt.requestAnimationFrame || nt.webkitRequestAnimationFrame || nt.mozRequestAnimationFrame || nt.msRequestAnimationFrame || function(e) {
    return setTimeout(e, 16);
  }, $i = window, Nt = $i.cancelAnimationFrame || $i.mozCancelAnimationFrame || function(e) {
    clearTimeout(e);
  };
  function Ot() {
    for (var e, i, r, a = arguments[0] || {}, c = 1, h = arguments.length; c < h; c++)
      if ((e = arguments[c]) !== null)
        for (i in e)
          r = e[i], a !== r && r !== void 0 && (a[i] = r);
    return a;
  }
  function Mn(e) {
  ...
  function xo() {
    var e = document, i = et(), r = tt(i), a = e.createElement("div"), c = !1;
    i.appendChild(a);
    try {
      for (var h = "(10px * 10)", l = ["calc" + h, "-moz-calc" + h, "-webkit-calc" + h], p, _ = 0; _ < 3; _++)
        if (p = l[_], a.style.width = p, a.offsetWidth === 100) {
          c = p.replace(h, "");
          break;
        }
    } catch {
    }
    return i.fake ? it(i, r) : a.remove(), c;
  }
  function wo() {
    var e = document, i = et(), r = tt(i), a = e.createElement("div"), c = e.createElement("div"), h = "", l = 70, p = 3, _ = !1;
    a.className = "tns-t-subp2", c.className = "tns-t-ct";
    for (var C = 0; C < l; C++)
      h += "<div></div>";
    return c.innerHTML = h, a.appendChild(c), i.appendChild(a), _ = Math.abs(a.getBoundingClientRect().left - c.children[l - p].getBoundingClientRect().left) < 2, i.fake ? it(i, r) : a.remove(), _;
  }
  function Co() {
    if (window.matchMedia || window.msMatchMedia)
      return !0;
    var e = document, i = et(), r = tt(i), a = e.createElement("div"), c = e.createElement("style"), h = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}", l;
    return c.type = "text/css", a.className = "tns-mq-test", i.appendChild(c), i.appendChild(a), c.styleSheet ? c.styleSheet.cssText = h : c.appendChild(e.createTextNode(h)), l = window.getComputedStyle ? window.getComputedStyle(a).position : a.currentStyle.position, i.fake ? it(i, r) : a.remove(), l === "absolute";
  }
  function yo(e, i) {
  ...
  function Pn(e, i, r, a) {
    "insertRule" in e ? e.insertRule(i + "{" + r + "}", a) : e.addRule(i, r, a);
  }
  function ko(e, i) {
  ...
  function To(e, i) {
    var r = !1, a = Math.abs(90 - Math.abs(e));
    return a >= 90 - i ? r = "horizontal" : a <= i && (r = "vertical"), r;
  }
  function Fn(e, i, r) {
    for (var a = 0, c = e.length; a < c; a++)
      i.call(r, e[a], a);
  }
  var Zt = "classList" in document.createElement("_"), fe = Zt ? function(e, i) {
    return e.classList.contains(i);
  } : function(e, i) {
    return e.className.indexOf(i) >= 0;
  }, W = Zt ? function(e, i) {
    fe(e, i) || e.classList.add(i);
  } : function(e, i) {
    fe(e, i) || (e.className += " " + i);
  }, ln = Zt ? function(e, i) {
    fe(e, i) && e.classList.remove(i);
  } : function(e, i) {
    fe(e, i) && (e.className = e.className.replace(i, ""));
  };
  function Te(e, i) {
  ...
  function Me(e) {
    if (typeof e == "string") {
      var i = [e], r = e.charAt(0).toUpperCase() + e.substr(1), a = ["Webkit", "Moz", "ms", "O"];
      a.forEach(function(p) {
        (p !== "ms" || e === "transform") && i.push(p + r);
      }), e = i;
    }
  ...
  function Mo(e) {
    if (!e || !window.getComputedStyle)
      return !1;
    var i = document, r = et(), a = tt(r), c = i.createElement("p"), h, l = e.length > 9 ? "-" + e.slice(0, -9).toLowerCase() + "-" : "";
    return l += "transform", r.insertBefore(c, null), c.style[e] = "translate3d(1px,1px,1px)", h = window.getComputedStyle(c).getPropertyValue(l), r.fake ? it(r, a) : c.remove(), h !== void 0 && h.length > 0 && h !== "none";
  }
  function ji(e, i) {
    var r = !1;
  ...
  try {
    ...
    window.addEventListener("test", null, So);
  } catch {
  }
  var Hi = Di ? { passive: !0 } : !1;
  function R(e, i, r) {
    for (var a in i) {
      var c = ["touchstart", "touchmove"].indexOf(a) >= 0 && !r ? Hi : !1;
      e.addEventListener(a, i[a], c);
    }
  }
  function U(e, i) {
    for (var r in i) {
      var a = ["touchstart", "touchmove"].indexOf(r) >= 0 ? Hi : !1;
      e.removeEventListener(r, i[r], a);
    }
  }
  function Eo() {
    return {
  ...
  function $o(e, i, r, a, C, h, l) {
    var p = Math.min(h, 10), _ = C.indexOf("%") >= 0 ? "%" : "px", C = C.replace(_, ""), $ = Number(e.style[i].replace(r, "").replace(a, "").replace(_, "")), j = (C - $) / h * p;
    setTimeout(X, p);
    function X() {
      h -= p, $ += j, e.style[i] = r + $ + _ + a, h > 0 ? setTimeout(X, p) : l();
    }
  }
  ...
  var st = function(e) {
    ...
    var i = document, r = window, a = {
      ENTER: 13,
      SPACE: 32,
      LEFT: 37,
      RIGHT: 39
    }, c = {}, h = e.useLocalStorage;
    if (h) {
      var l = navigator.userAgent, p = /* @__PURE__ */ new Date();
      try {
        c = r.localStorage, c ? (c.setItem(p, p), h = c.getItem(p) == p, c.removeItem(p)) : h = !1, h || (c = {});
      } catch {
        h = !1;
      }
      h && (c.tnsApp && c.tnsApp !== l && ["tC", "tPL", "tMQ", "tTf", "t3D", "tTDu", "tTDe", "tADu", "tADe", "tTE", "tAE"].forEach(function(n) {
        c.removeItem(n);
      }), localStorage.tnsApp = l);
    }
    var _ = c.tC ? Mn(c.tC) : Sn(c, "tC", xo(), h), C = c.tPL ? Mn(c.tPL) : Sn(c, "tPL", wo(), h), $ = c.tMQ ? Mn(c.tMQ) : Sn(c, "tMQ", Co(), h), j = c.tTf ? Mn(c.tTf) : Sn(c, "tTf", Me("transform"), h), X = c.t3D ? Mn(c.t3D) : Sn(c, "t3D", Mo(j), h), T = c.tTDu ? Mn(c.tTDu) : Sn(c, "tTDu", Me("transitionDuration"), h), Cn = c.tTDe ? Mn(c.tTDe) : Sn(c, "tTDe", Me("transitionDelay"), h), ue = c.tADu ? Mn(c.tADu) : Sn(c, "tADu", Me("animationDuration"), h), Se = c.tADe ? Mn(c.tADe) : Sn(c, "tADe", Me("animationDelay"), h), Nn = c.tTE ? Mn(c.tTE) : Sn(c, "tTE", ji(T, "Transition"), h), ie = c.tAE ? Mn(c.tAE) : Sn(c, "tAE", ji(ue, "Animation"), h), Ee = r.console && typeof r.console.warn == "function", rt = ["container", "controlsContainer", "prevButton", "nextButton", "navContainer", "autoplayButton"], Pi = {};
    if (rt.forEach(function(n) {
      if (typeof e[n] == "string") {
        var t = e[n], o = i.querySelector(t);
        if (Pi[n] = t, o && o.nodeName)
          e[n] = o;
        else {
          Ee && console.warn("Can't find", e[n]);
          return;
        }
      }
    }), e.container.children.length < 1) {
      Ee && console.warn("No slides found in", e.container);
      return;
    }
    var O = e.responsive, he = e.nested, v = e.mode === "carousel";
    if (O) {
      0 in O && (e = Ot(e, O[0]), delete O[0]);
      var qt = {};
      for (var Ni in O) {
        var $e = O[Ni];
        $e = typeof $e == "number" ? { items: $e } : $e, qt[Ni] = $e;
      }
      O = qt, qt = null;
    }
    function Oi(n) {
      for (var t in n)
        v || (t === "slideBy" && (n[t] = "page"), t === "edgePadding" && (n[t] = !1), t === "autoHeight" && (n[t] = !1)), t === "responsive" && Oi(n[t]);
    }
    if (v || Oi(e), !v) {
      e.axis = "horizontal", e.slideBy = "page", e.edgePadding = !1;
      var Wn = e.animateIn, at = e.animateOut, Ft = e.animateDelay, An = e.animateNormal;
    }
    var z = e.axis === "horizontal", an = i.createElement("div"), cn = i.createElement("div"), pn, b = e.container, Rt = b.parentNode, Zi = b.outerHTML, E = b.children, x = E.length, Ae, ct = Xi(), ze = !1;
    O && p1(), v && (b.className += " tns-vpfix");
    var y = e.autoWidth, g = w("fixedWidth"), q = w("edgePadding"), M = w("gutter"), G = n1(), Q = w("center"), k = y ? 1 : Math.floor(w("items")), _e = w("slideBy"), Wt = e.viewportMax || e.fixedWidthViewportWidth, Vn = w("arrowKeys"), yn = w("speed"), Ie = e.rewind, nn = Ie ? !1 : e.loop, dn = w("autoHeight"), zn = w("controls"), Yn = w("controlsText"), In = w("nav"), Bn = w("touch"), Gn = w("mouseDrag"), sn = w("autoplay"), Vt = w("autoplayTimeout"), Jn = w("autoplayText"), Kn = w("autoplayHoverPause"), Un = w("autoplayResetOnVisibility"), I = yo(null, w("nonce")), je = e.lazyload, zo = e.lazyloadSelector, V, ve = [], en = nn ? Ho() : 0, A = v ? x + en * 2 : x + en, qi = !!((g || y) && !nn), ge = g ? pi() : null, Yt = !v || !nn, oe = z ? "left" : "top", Xn = "", me = "", De = /* @__PURE__ */ function() {
      return g ? function() {
        return Q && !nn ? x - 1 : Math.ceil(-ge / (g + M));
      } : y ? function() {
        for (var n = 0; n < A; n++)
          if (V[n] >= -ge)
            return n;
      } : function() {
        return Q && v && !nn ? x - 1 : nn || v ? Math.max(0, A - Math.ceil(k)) : A - 1;
      };
    }(), f = Ki(w("startIndex")), Qn = f;
    Ji();
    var jn = 0, mn = y ? null : De(), lt = e.preventActionWhenRunning, pt = e.swipeAngle, Dn = pt ? "?" : !0, ne = !1, Bt = e.onInit, J = new Eo(), ee = " tns-slider tns-" + e.mode, Z = b.id || bo(), fn = w("disable"), He = !1, dt = e.freezable, kn = dt && !y ? ii() : !1, Pe = !1, Ne = {
      click: te,
      keydown: os
    }, Gt = {
      click: Uo,
      ...
      mouseover: es,
      mouseout: ts
    }, Ze = { visibilitychange: ns }, qe = { keydown: is }, Fe = {
      touchstart: z1,
      touchmove: I1,
      touchend: Dt,
      touchcancel: Dt
      ...
      mouseup: Dt,
      mouseleave: Dt
    }, ft = On("controls"), Jt = On("nav"), We = y ? !0 : e.navAsThumbnails, Kt = On("autoplay"), Fi = On("touch"), Ri = On("mouseDrag"), Ut = "tns-slide-active", Wi = "tns-slide-cloned", ut = "tns-complete", ht = {
      load: Ro,
      error: Wo
    }, Xt, Qt, Ve = e.preventScrollOnTouch === "force";
    if (ft)
      var Y = e.controlsContainer, Vi = e.controlsContainer ? e.controlsContainer.outerHTML : "", P = e.prevButton, N = e.nextButton, Io = e.prevButton ? e.prevButton.outerHTML : "", jo = e.nextButton ? e.nextButton.outerHTML : "", Ye, Be;
    if (Jt)
      var tn = e.navContainer, Yi = e.navContainer ? e.navContainer.outerHTML : "", bn, Ln = y ? x : D1(), se = 0, re = -1, xn = Ui(), be = xn, _t = "tns-nav-active", xe = "Carousel Page ", ni = " (Current Slide)";
    if (Kt)
      var Bi = e.autoplayDirection === "forward" ? 1 : -1, F = e.autoplayButton, Gi = e.autoplayButton ? e.autoplayButton.outerHTML : "", Ge = ["<span class='tns-visually-hidden'>", " animation</span>"], vt, un, gt, we, mt;
    if (Fi || Ri)
      var ae = {}, En = {}, bt, ce = !1, Tn, ei = z ? function(n, t) {
        return n.x - t.x;
      } : function(n, t) {
        return n.y - t.y;
      };
    y || xt(fn || kn), j && (oe = j, Xn = "translate", X ? (Xn += z ? "3d(" : "3d(0px, ", me = z ? ", 0px, 0px)" : ", 0px)") : (Xn += z ? "X(" : "Y(", me = ")")), v && (b.className = b.className.replace("tns-vpfix", "")), No(), Oo(), i1();
    function xt(n) {
      n && (zn = In = Bn = Gn = Vn = sn = Kn = Un = !1);
    }
    function Ji() {
      for (var n = v ? f - en : f; n < 0; )
        n += x;
      return n % x + 1;
    }
    function Ki(n) {
      return n = n ? Math.max(0, Math.min(nn ? x - 1 : x - k, n)) : 0, v ? n + en : n;
    }
    function wt(n) {
      for (n == null && (n = f), v && (n -= en); n < 0; )
        n += x;
      return Math.floor(n % x);
    }
    function Ui() {
      var n = wt(), t;
      return t = We ? n : g || y ? Math.ceil((n + 1) * Ln / x - 1) : Math.floor(n / k), !nn && v && f === mn && (t = Ln - 1), t;
    }
    function Do() {
      if (y || g && !Wt)
        return x - 1;
      var n = g ? "fixedWidth" : "items", t = [];
      if ((g || e[n] < x) && t.push(e[n]), O)
        for (var o in O) {
          var s = O[o][n];
          s && (g || s < x) && t.push(s);
        }
      return t.length || t.push(0), Math.ceil(g ? Wt / Math.min.apply(null, t) : Math.max.apply(null, t));
    }
    function Ho() {
      var n = Do(), t = v ? Math.ceil((n * 5 - x) / 2) : n * 4 - x;
    ...
    function Qi(n) {
      if (n != null) {
        ...
        return n.appendChild(t), o = t.getBoundingClientRect(), s = o.right - o.left, t.remove(), s || Qi(n.parentNode);
      }
    }
    function n1() {
      var n = q ? q * 2 - M : 0;
    ...
    function w(n, t) {
      if (t == null && (t = ct), n === "items" && g)
        return Math.floor((G + M) / (g + M)) || 1;
      var o = e[n];
      if (O)
        for (var s in O)
          t >= parseInt(s) && n in O[s] && (o = O[s][n]);
      return n === "slideBy" && o === "page" && (o = w("items")), !v && (n === "slideBy" || n === "items") && (o = Math.floor(o)), o;
    }
    function Po(n) {
      return _ ? _ + "(" + n * 100 + "% / " + A + ")" : n * 100 / A + "%";
    }
    function Ct(n, t, o, s, u) {
      var m = "";
      if (n !== void 0) {
        var S = n;
        t && (S -= t), m = z ? "margin: 0 " + S + "px 0 " + n + "px;" : "margin: " + n + "px 0 " + S + "px 0;";
      } else if (t && !o) {
        var K = "-" + t + "px", on = z ? K + " 0 0" : "0 " + K + " 0";
        m = "margin: 0 " + on + ";";
      }
      return !v && u && T && s && (m += le(s)), m;
    }
    function yt(n, t, o) {
      return n ? (n + t) * A + "px" : _ ? _ + "(" + A * 100 + "% / " + o + ")" : A * 100 / o + "%";
    }
    function kt(n, t, o) {
      var s;
      if (n)
      ...
      return s = "width:" + s, he !== "inner" ? s + ";" : s + " !important;";
    }
    function Lt(n) {
      var t = "";
      if (n !== !1) {
        var o = z ? "padding-" : "margin-", s = z ? "right" : "bottom";
        t = o + s + ": " + n + "px;";
      }
      return t;
    }
    ...
    function le(n) {
      return e1(T, 18) + "transition-duration:" + n / 1e3 + "s;";
    }
    function t1(n) {
      return e1(ue, 17) + "animation-duration:" + n / 1e3 + "s;";
    }
    function No() {
      var n = "tns-outer", t = "tns-inner";
      if (On("gutter"), an.className = n, cn.className = t, an.id = Z + "-ow", cn.id = Z + "-iw", b.id === "" && (b.id = Z), ee += C || y ? " tns-subpixel" : " tns-no-subpixel", ee += _ ? " tns-calc" : " tns-no-calc", y && (ee += " tns-autowidth"), ee += " tns-" + e.axis, b.className += ee, v ? (pn = i.createElement("div"), pn.id = Z + "-mw", pn.className = "tns-ovh", an.appendChild(pn), pn.appendChild(cn)) : an.appendChild(cn), dn) {
        var o = pn || cn;
        o.className += " tns-ah";
      }
      if (Rt.insertBefore(an, b), cn.appendChild(b), Fn(E, function(B, ye) {
        W(B, "tns-item"), B.id || (B.id = Z + "-item" + ye), !v && An && W(B, An), _n(B, {
          "aria-hidden": "true",
          tabindex: "-1"
        });
      }), en) {
        for (var s = i.createDocumentFragment(), u = i.createDocumentFragment(), m = en; m--; ) {
          var S = m % x, K = E[S].cloneNode(!0);
          if (W(K, Wi), Rn(K, "id"), u.insertBefore(K, u.firstChild), v) {
            var on = E[x - 1 - S].cloneNode(!0);
            W(on, Wi), Rn(on, "id"), s.appendChild(on);
          }
        }
        b.insertBefore(s, b.firstChild), b.appendChild(u), E = b.children;
      }
    }
    function i1() {
      if (On("autoHeight") || y || !z) {
        var n = b.querySelectorAll("img");
        Fn(n, function(t) {
          var o = t.src;
          je || (o && o.indexOf("data:image") < 0 ? (t.src = "", R(t, ht), W(t, "loading"), t.src = o) : v1(t));
        }), qn(function() {
          St(zi(n), function() {
            Xt = !0;
          });
        }), On("autoHeight") && (n = ci(f, Math.min(f + k - 1, A - 1))), je ? o1() : qn(function() {
          St(zi(n), o1);
        });
      } else
        v && Ke(), r1(), a1();
    ...
    function o1() {
      if (y && x > 1) {
        var n = nn ? f : x - 1;
        (function t() {
          var o = E[n].getBoundingClientRect().left, s = E[n - 1].getBoundingClientRect().right;
          Math.abs(o - s) <= 1 ? s1() : setTimeout(function() {
            t();
          }, 16);
        })();
      } else
    ...
    function s1() {
      (!z || y) && (x1(), y ? (ge = pi(), dt && (kn = ii()), mn = De(), xt(fn || kn)) : ui()), v && Ke(), r1(), a1();
    }
    function Oo() {
      if (!v)
        for (var n = f, t = f + Math.min(x, k); n < t; n++) {
          var o = E[n];
          o.style.left = (n - f) * 100 / k + "%", W(o, Wn), ln(o, An);
        }
      if (z && (C || y ? (Pn(I, "#" + Z + " > .tns-item", "font-size:" + r.getComputedStyle(E[0]).fontSize + ";", $n(I)), Pn(I, "#" + Z, "font-size:0;", $n(I))) : v && Fn(E, function(gi, mi) {
        gi.style.marginLeft = Po(mi);
      })), $) {
        if (T) {
          var s = pn && e.autoHeight ? le(e.speed) : "";
          Pn(I, "#" + Z + "-mw", s, $n(I));
        }
        s = Ct(e.edgePadding, e.gutter, e.fixedWidth, e.speed, e.autoHeight), Pn(I, "#" + Z + "-iw", s, $n(I)), v && (s = z && !y ? "width:" + yt(e.fixedWidth, e.gutter, e.items) + ";" : "", T && (s += le(yn)), Pn(I, "#" + Z, s, $n(I))), s = z && !y ? kt(e.fixedWidth, e.gutter, e.items) : "", e.gutter && (s += Lt(e.gutter)), v || (T && (s += le(yn)), ue && (s += t1(yn))), s && Pn(I, "#" + Z + " > .tns-item", s, $n(I));
      } else {
        Yo(), cn.style.cssText = Ct(q, M, g, dn), v && z && !y && (b.style.width = yt(g, M, k));
        var s = z && !y ? kt(g, M, k) : "";
        M && (s += Lt(M)), s && Pn(I, "#" + Z + " > .tns-item", s, $n(I));
      }
      if (O && $)
        for (var u in O) {
          u = parseInt(u);
          var m = O[u], s = "", S = "", K = "", on = "", B = "", ye = y ? null : w("items", u), Qe = w("fixedWidth", u), de = w("speed", u), _i = w("edgePadding", u), vi = w("autoHeight", u), ke = w("gutter", u);
          T && pn && w("autoHeight", u) && "speed" in m && (S = "#" + Z + "-mw{" + le(de) + "}"), ("edgePadding" in m || "gutter" in m) && (K = "#" + Z + "-iw{" + Ct(_i, ke, Qe, de, vi) + "}"), v && z && !y && ("fixedWidth" in m || "items" in m || g && "gutter" in m) && (on = "width:" + yt(Qe, ke, ye) + ";"), T && "speed" in m && (on += le(de)), on && (on = "#" + Z + "{" + on + "}"), ("fixedWidth" in m || g && "gutter" in m || !v && "items" in m) && (B += kt(Qe, ke, ye)), "gutter" in m && (B += Lt(ke)), !v && "speed" in m && (T && (B += le(de)), ue && (B += t1(de))), B && (B = "#" + Z + " > .tns-item{" + B + "}"), s = S + K + on + B, s && I.insertRule("@media (min-width: " + u / 16 + "em) {" + s + "}", I.cssRules.length);
        }
    }
    function r1() {
      if (li(), an.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + _1() + "</span>  of " + x + "</div>"), Qt = an.querySelector(".tns-liveregion .current"), Kt) {
        var n = sn ? "stop" : "start";
        F ? _n(F, { "data-action": n }) : e.autoplayButtonOutput && (an.insertAdjacentHTML(ti(e.autoplayPosition), '<button type="button" data-action="' + n + '">' + Ge[0] + n + Ge[1] + Jn[0] + "</button>"), F = an.querySelector("[data-action]")), F && R(F, { click: S1 }), sn && (jt(), Kn && R(b, Oe), Un && R(b, Ze));
      }
      if (Jt) {
        if (tn)
          _n(tn, { "aria-label": "Carousel Pagination" }), bn = tn.children, Fn(bn, function(S, K) {
            _n(S, {
              "data-nav": K,
              tabindex: "-1",
              "aria-label": xe + (K + 1),
          ...
          for (var t = "", o = We ? "" : 'style="display:none"', s = 0; s < x; s++)
            t += '<button type="button" data-nav="' + s + '" tabindex="-1" aria-controls="' + Z + '" ' + o + ' aria-label="' + xe + (s + 1) + '"></button>';
          t = '<div class="tns-nav" aria-label="Carousel Pagination">' + t + "</div>", an.insertAdjacentHTML(ti(e.navPosition), t), tn = an.querySelector(".tns-nav"), bn = tn.children;
        }
        if (hi(), T) {
          var u = T.substring(0, T.length - 18).toLowerCase(), m = "transition: all " + yn / 1e3 + "s";
          u && (m = "-" + u + "-" + m), Pn(I, "[aria-controls^=" + Z + "-item]", m, $n(I));
        }
        _n(bn[xn], { "aria-label": xe + (xn + 1) + ni }), Rn(bn[xn], "tabindex"), W(bn[xn], _t), R(tn, Gt);
      }
      ft && (!Y && (!P || !N) && (an.insertAdjacentHTML(ti(e.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' + Z + '">' + Yn[0] + '</button><button type="button" data-controls="next" tabindex="-1" aria-controls="' + Z + '">' + Yn[1] + "</button></div>"), Y = an.querySelector(".tns-controls")), (!P || !N) && (P = Y.children[0], N = Y.children[1]), e.controlsContainer && _n(Y, {
        "aria-label": "Carousel Navigation",
        tabindex: "0"
      }), (e.controlsContainer || e.prevButton && e.nextButton) && _n([P, N], {
        "aria-controls": Z,
        tabindex: "-1"
      }), (e.controlsContainer || e.prevButton && e.nextButton) && (_n(P, { "data-controls": "prev" }), _n(N, { "data-controls": "next" })), Ye = C1(P), Be = C1(N), k1(), Y ? R(Y, Ne) : (R(P, Ne), R(N, Ne))), si();
    }
    function a1() {
      if (v && Nn) {
        var n = {};
      ...
      Bn && R(b, Fe, e.preventScrollOnTouch), Gn && R(b, Re), Vn && R(i, qe), he === "inner" ? J.on("outerResized", function() {
        l1(), J.emit("innerLoaded", rn());
      }) : (O || g || y || dn || !z) && R(r, { resize: c1 }), dn && (he === "outer" ? J.on("innerLoaded", Mt) : fn || Mt()), ri(), fn ? u1() : kn && f1(), J.on("indexChanged", g1), he === "inner" && J.emit("innerLoaded", rn()), typeof Bt == "function" && Bt(rn()), ze = !0;
    }
    function Zo() {
      if (I.disabled = !0, I.ownerNode && I.ownerNode.remove(), U(r, { resize: c1 }), Vn && U(i, qe), Y && U(Y, Ne), tn && U(tn, Gt), U(b, Oe), U(b, Ze), F && U(F, { click: S1 }), sn && clearInterval(vt), v && Nn) {
        var n = {};
        n[Nn] = Hn, U(b, n);
      }
      Bn && U(b, Fe), Gn && U(b, Re);
      var t = [Zi, Vi, Io, jo, Yi, Gi];
      ...
      }), rt = Wn = at = Ft = An = z = an = cn = b = Rt = Zi = E = x = Ae = ct = y = g = q = M = G = k = _e = Wt = Vn = yn = Ie = nn = dn = I = je = V = ve = en = A = qi = ge = Yt = oe = Xn = me = De = f = Qn = jn = mn = pt = Dn = ne = Bt = J = ee = Z = fn = He = dt = kn = Pe = Ne = Gt = Oe = Ze = qe = Fe = Re = ft = Jt = We = Kt = Fi = Ri = Ut = ut = ht = Xt = zn = Yn = Y = Vi = P = N = Ye = Be = In = tn = Yi = bn = Ln = se = re = xn = be = _t = xe = ni = sn = Vt = Bi = Jn = Kn = F = Gi = Un = Ge = vt = un = gt = we = mt = ae = En = bt = ce = Tn = ei = Bn = Gn = null;
      for (var o in this)
    ...
    function l1(n) {
      if (ze) {
        he === "outer" && J.emit("outerResized", rn(n)), ct = Xi();
        var t, o = Ae, s = !1;
        O && (p1(), t = o !== Ae, t && J.emit("newBreakpointStart", rn(n)));
        var u, m, S = k, K = fn, on = kn, B = Vn, ye = zn, Qe = In, de = Bn, _i = Gn, vi = sn, ke = Kn, gi = Un, mi = f;
        if (t) {
          var rs = g, as = dn, cs = Yn, ls = Q, bi = Jn;
          if (!$)
            var ps = M, ds = q;
        }
        if (Vn = w("arrowKeys"), zn = w("controls"), In = w("nav"), Bn = w("touch"), Q = w("center"), Gn = w("mouseDrag"), sn = w("autoplay"), Kn = w("autoplayHoverPause"), Un = w("autoplayResetOnVisibility"), t && (fn = w("disable"), g = w("fixedWidth"), yn = w("speed"), dn = w("autoHeight"), Yn = w("controlsText"), Jn = w("autoplayText"), Vt = w("autoplayTimeout"), $ || (q = w("edgePadding"), M = w("gutter"))), xt(fn), G = n1(), (!z || y) && !fn && (x1(), z || (ui(), s = !0)), (g || y) && (ge = pi(), mn = De()), (t || g) && (k = w("items"), _e = w("slideBy"), m = k !== S, m && (!g && !y && (mn = De()), oi())), t && fn !== K && (fn ? u1() : Fo()), dt && (t || g || y) && (kn = ii(), kn !== on && (kn ? (di(At(Ki(0))), f1()) : (qo(), s = !0))), xt(fn || kn), sn || (Kn = Un = !1), Vn !== B && (Vn ? R(i, qe) : U(i, qe)), zn !== ye && (zn ? Y ? gn(Y) : (P && gn(P), N && gn(N)) : Y ? vn(Y) : (P && vn(P), N && vn(N))), In !== Qe && (In ? (gn(tn), hi()) : vn(tn)), Bn !== de && (Bn ? R(b, Fe, e.preventScrollOnTouch) : U(b, Fe)), Gn !== _i && (Gn ? R(b, Re) : U(b, Re)), sn !== vi && (sn ? (F && gn(F), !un && !we && jt()) : (F && vn(F), un && Xe())), Kn !== ke && (Kn ? R(b, Oe) : U(b, Oe)), Un !== gi && (Un ? R(i, Ze) : U(i, Ze)), t) {
          if ((g !== rs || Q !== ls) && (s = !0), dn !== as && (dn || (cn.style.height = "")), zn && Yn !== cs && (P.innerHTML = Yn[0], N.innerHTML = Yn[1]), F && Jn !== bi) {
            var xi = sn ? 1 : 0, wi = F.innerHTML, H1 = wi.length - bi[xi].length;
            wi.substring(H1) === bi[xi] && (F.innerHTML = wi.substring(0, H1) + Jn[xi]);
          }
        } else
          Q && (g || y) && (s = !0);
        if ((m || g && !y) && (Ln = D1(), hi()), u = f !== mi, u ? (J.emit("indexChanged", rn()), s = !0) : m ? u || g1() : (g || y) && (ri(), li(), h1()), m && !v && Bo(), !fn && !kn) {
          if (t && !$ && ((q !== ds || M !== ps) && (cn.style.cssText = Ct(q, M, g, yn, dn)), z)) {
            v && (b.style.width = yt(g, M, k));
            var fs = kt(g, M, k) + Lt(M);
            ko(I, $n(I) - 1), Pn(I, "#" + Z + " > .tns-item", fs, $n(I));
          }
          dn && Mt(), s && (Ke(), Qn = f);
        }
    ...
    function ii() {
      ...
      var t = g ? (g + M) * x : V[x], o = q ? G + q * 2 : G + M;
      return Q && (o -= g ? (G - g) / 2 : (G - (V[f + 1] - V[f] - M)) / 2), t <= o;
    }
    function p1() {
      Ae = 0;
      for (var n in O)
        n = parseInt(n), ct >= n && (Ae = n);
    }
    var oi = /* @__PURE__ */ function() {
      return nn ? v ? (
        ...
        function() {
          var n = jn, t = mn;
          n += _e, t -= _e, q ? (n += 1, t -= 1) : g && (G + M) % (g + M) && (t -= 1), en && (f > t ? f -= x : f < n && (f += x));
        }
      ) : (
        // loop + gallery
        function() {
        ...
        // non-loop
        function() {
          f = Math.max(jn, Math.min(mn, f));
        }
      );
    }();
    function si() {
      !sn && F && vn(F), !In && tn && vn(tn), zn || (Y ? vn(Y) : (P && vn(P), N && vn(N)));
    }
    function d1() {
      sn && F && gn(F), In && tn && gn(tn), zn && (Y ? gn(Y) : (P && gn(P), N && gn(N)));
    }
    function f1() {
      if (!Pe) {
        if (q && (cn.style.margin = "0px"), en)
          for (var n = "tns-transparent", t = en; t--; )
            v && W(E[t], n), W(E[A - t - 1], n);
        si(), Pe = !0;
      }
    }
    function qo() {
      if (Pe) {
        if (q && $ && (cn.style.margin = ""), en)
          for (var n = "tns-transparent", t = en; t--; )
            v && ln(E[t], n), ln(E[A - t - 1], n);
        d1(), Pe = !1;
      }
    }
    function u1() {
      if (!He) {
        if (I.disabled = !0, b.className = b.className.replace(ee.substring(1), ""), Rn(b, ["style"]), nn)
          for (var n = en; n--; )
            v && vn(E[n]), vn(E[A - n - 1]);
        if ((!z || !v) && Rn(cn, ["style"]), !v)
          for (var t = f, o = f + x; t < o; t++) {
            var s = E[t];
            Rn(s, ["style"]), ln(s, Wn), ln(s, An);
          }
        si(), He = !0;
      }
    }
    function Fo() {
      if (He) {
        if (I.disabled = !1, b.className += ee, Ke(), nn)
          for (var n = en; n--; )
            v && gn(E[n]), gn(E[A - n - 1]);
        if (!v)
          for (var t = f, o = f + x; t < o; t++) {
            var s = E[t], u = t < f + k ? Wn : An;
            s.style.left = (t - f) * 100 / k + "%", W(s, u);
          }
        d1(), He = !1;
      }
    }
    function h1() {
      var n = _1();
      Qt.innerHTML !== n && (Qt.innerHTML = n);
    }
    function _1() {
      var n = Tt(), t = n[0] + 1, o = n[1] + 1;
      return t === o ? t + "" : t + " to " + o;
    }
    function Tt(n) {
      n == null && (n = At());
      var t = f, o, s, u;
      if (Q || q ? (y || g) && (s = -(parseFloat(n) + q), u = s + G + q * 2) : y && (s = V[f], u = s + G), y)
        V.forEach(function(on, B) {
          B < A && ((Q || q) && on <= s + 0.5 && (t = B), u - on >= 0.5 && (o = B));
        });
      else {
        if (g) {
          var m = g + M;
          Q || q ? (t = Math.floor(s / m), o = Math.ceil(u / m - 1)) : o = t + Math.ceil(G / m) - 1;
        } else if (Q || q) {
          var S = k - 1;
          if (Q ? (t -= S / 2, o = f + S / 2) : o = f + S, q) {
            var K = q * k / G;
            t -= K, o += K;
          }
    ...
    function ri() {
      if (je && !fn) {
        var n = Tt();
        n.push(zo), ci.apply(null, n).forEach(function(t) {
          if (!fe(t, ut)) {
            var o = {};
            o[Nn] = function(u) {
              u.stopPropagation();
            }, R(t, o), R(t, ht), t.src = ot(t, "data-src");
    ...
    function ai(n) {
      W(n, ut), ln(n, "loading"), U(n, ht);
    }
    function ci(n, t, o) {
      var s = [];
      for (o || (o = "img"); n <= t; )
        Fn(E[n].querySelectorAll(o), function(u) {
          s.push(u);
        }), n++;
      return s;
    }
    function Mt() {
      var n = ci.apply(null, Tt());
      qn(function() {
        St(n, b1);
      });
    }
    function St(n, t) {
      if (Xt || (n.forEach(function(o, s) {
        !je && o.complete && ai(o), fe(o, ut) && n.splice(s, 1);
      }), !n.length))
        return t();
      qn(function() {
        St(n, t);
    ...
    function Yo() {
      v && dn && (pn.style[T] = yn / 1e3 + "s");
    }
    function m1(n, t) {
      for (var o = [], s = n, u = Math.min(n + t, A); s < u; s++)
        o.push(E[s].offsetHeight);
      return Math.max.apply(null, o);
    }
    function b1() {
      var n = dn ? m1(f, k) : m1(en, x), t = pn || cn;
      t.style.height !== n && (t.style.height = n + "px");
    }
    function x1() {
      V = [0];
      var n = z ? "left" : "top", t = z ? "right" : "bottom", o = E[0].getBoundingClientRect()[n];
      Fn(E, function(s, u) {
        u && V.push(s.getBoundingClientRect()[n] - o), u === A - 1 && V.push(s.getBoundingClientRect()[t] - o);
      });
    }
    function li() {
      var n = Tt(), t = n[0], o = n[1];
      Fn(E, function(s, u) {
        u >= t && u <= o ? Te(s, "aria-hidden") && (Rn(s, ["aria-hidden", "tabindex"]), W(s, Ut)) : Te(s, "aria-hidden") || (_n(s, {
          "aria-hidden": "true",
          tabindex: "-1"
        }), ln(s, Ut));
      });
    ...
    function Bo() {
      for (var n = f + Math.min(x, k), t = A; t--; ) {
        var o = E[t];
        t >= f && t < n ? (W(o, "tns-moving"), o.style.left = (t - f) * 100 / k + "%", W(o, Wn), ln(o, An)) : o.style.left && (o.style.left = "", W(o, An), ln(o, Wn)), ln(o, at);
      }
      setTimeout(function() {
        Fn(E, function(s) {
          ln(s, "tns-moving");
    ...
    function Go() {
      if (In && (xn = re >= 0 ? re : Ui(), re = -1, xn !== be)) {
        var n = bn[be], t = bn[xn];
        _n(n, {
          tabindex: "-1",
          "aria-label": xe + (be + 1)
        }), ln(n, _t), _n(t, { "aria-label": xe + (xn + 1) + ni }), Rn(t, "tabindex"), W(t, _t), be = xn;
      }
    }
    function w1(n) {
    ...
    function k1() {
      if (!(!zn || Ie || nn)) {
        var n = Ye ? P.disabled : y1(P), t = Be ? N.disabled : y1(N), o = f <= jn, s = !Ie && f >= mn;
        o && !n && Et(Ye, P, !0), !o && n && Et(Ye, P, !1), s && !t && Et(Be, N, !0), !s && t && Et(Be, N, !1);
      }
    }
    function $t(n, t) {
      T && (n.style[T] = t);
    ...
    function Je(n) {
      n == null && (n = f);
      var t = q ? M : 0;
      return y ? (G - t - (V[n + 1] - V[n] - M)) / 2 : g ? (G - g) / 2 : (k - 1) / 2;
    }
    function pi() {
      var n = q ? M : 0, t = G + n - Jo();
      return Q && !nn && (t = g ? -(g + M) * (A - 1) - Je() : Je(A - 1) - V[A - 1]), t > 0 && (t = 0), t;
    }
    function At(n) {
      n == null && (n = f);
      var t;
      if (z && !y)
        ...
        t = -V[n], Q && y && (t += Je());
      return qi && (t = Math.max(t, ge)), t += z && !y && !g ? "%" : "px", t;
    }
    function Ke(n) {
      $t(b, "0s"), di(n);
    }
    function di(n) {
      n == null && (n = At()), b.style[oe] = Xn + n + me;
    }
    function L1(n, t, o, s) {
      var u = n + k;
      nn || (u = Math.min(u, A));
      for (var m = n; m < u; m++) {
        var S = E[m];
        s || (S.style.left = (m - f) * 100 / k + "%"), Ft && Cn && (S.style[Cn] = S.style[Se] = Ft * (m - n) / 1e3 + "s"), ln(S, t), W(S, o), s && ve.push(S);
      }
    }
    var Ko = /* @__PURE__ */ function() {
      return v ? function() {
        $t(b, ""), T || !yn ? (di(), (!yn || !Ii(b)) && Hn()) : $o(b, oe, Xn, me, At(), yn, Hn), z || ui();
      } : function() {
        ve = [];
        var n = {};
        n[Nn] = n[ie] = Hn, U(E[Qn], n), R(E[f], n), L1(Qn, Wn, at, !0), L1(f, An, Wn), (!Nn || !ie || !yn || !Ii(b)) && Hn();
      };
    }();
    function fi(n, t) {
      Yt && oi(), (f !== Qn || t) && (J.emit("indexChanged", rn()), J.emit("transitionStart", rn()), dn && Mt(), un && n && ["click", "keydown"].indexOf(n.type) >= 0 && Xe(), ne = !0, Ko());
    }
    function T1(n) {
    ...
    function Hn(n) {
      if (v || ne) {
        if (J.emit("transitionEnd", rn(n)), !v && ve.length > 0)
          for (var t = 0; t < ve.length; t++) {
            var o = ve[t];
            o.style.left = "", Se && Cn && (o.style[Se] = "", o.style[Cn] = ""), ln(o, at), W(o, An);
          }
        if (!n || !v && n.target.parentNode === b || n.target === b && T1(n.propertyName) === T1(oe)) {
          if (!Yt) {
            var s = f;
            oi(), f !== s && (J.emit("indexChanged", rn()), Ke());
          }
          he === "inner" && J.emit("innerLoaded", rn()), ne = !1, Qn = f;
        }
      }
    }
    function Ue(n, t) {
      if (!kn)
        if (n === "prev")
          ...
          var o = wt(), s = 0;
          if (n === "first" ? s = -o : n === "last" ? s = v ? x - k - o : x - 1 - o : (typeof n != "number" && (n = parseInt(n)), isNaN(n) || (t || (n = Math.max(0, Math.min(x - 1, n))), s = n - o)), !v && s && Math.abs(s) < k) {
            var u = s > 0 ? 1 : -1;
            s += f + s - x >= jn ? x * u : x * 2 * u * -1;
          }
          f += s, v && nn && (f < jn && (f += x), f > mn && (f -= x)), wt(f) !== wt(Qn) && fi(t);
        }
    }
    function te(n, t) {
      if (ne) {
      ...
      if (!t) {
        n = Zn(n);
        for (var s = Ce(n); s !== Y && [P, N].indexOf(s) < 0; )
          s = s.parentNode;
        var u = [P, N].indexOf(s);
        u >= 0 && (o = !0, t = u === 0 ? -1 : 1);
      }
      ...
      t && (f += _e * t, y && (f = Math.floor(f)), fi(o || n && n.type === "keydown" ? n : null));
    }
    function Uo(n) {
      if (ne) {
        if (lt)
      ...
      for (var t = Ce(n), o; t !== tn && !Te(t, "data-nav"); )
        t = t.parentNode;
      if (Te(t, "data-nav")) {
        var o = re = Number(ot(t, "data-nav")), s = g || y ? o * x / Ln : o * k, u = We ? o : Math.min(Math.ceil(s), x - 1);
    ...
    function M1(n, t) {
      _n(F, { "data-action": n }), F.innerHTML = Ge[0] + n + Ge[1] + t;
    }
    function jt() {
      zt(), F && M1("stop", Jn[1]);
    }
    ...
    function ns() {
      i.hidden ? un && (It(), mt = !0) : mt && (zt(), mt = !1);
    }
    function es() {
      un && (It(), gt = !0);
    }
    ...
    function os(n) {
      n = Zn(n);
      var t = [a.LEFT, a.RIGHT].indexOf(n.keyCode);
      t >= 0 && (t === 0 ? P.disabled || te(n, -1) : N.disabled || te(n, 1));
    }
    function E1(n) {
      n.focus();
    }
    function ss(n) {
      ...
      if (Te(t, "data-nav")) {
        var o = [a.LEFT, a.RIGHT, a.ENTER, a.SPACE].indexOf(n.keyCode), s = Number(ot(t, "data-nav"));
        o >= 0 && (o === 0 ? s > 0 && E1(bn[s - 1]) : o === 1 ? s < Ln - 1 && E1(bn[s + 1]) : (re = s, Ue(s, n)));
      }
    }
    function Zn(n) {
      return n = n || r.event, pe(n) ? n.changedTouches[0] : n;
    }
    function Ce(n) {
    ...
    function A1() {
      return To(Lo(En.y - ae.y, En.x - ae.x), pt) === e.axis;
    }
    function z1(n) {
      if (ne) {
        if (lt)
      ...
      sn && un && It(), ce = !0, Tn && (Nt(Tn), Tn = null);
      var t = Zn(n);
      J.emit(pe(n) ? "touchStart" : "dragStart", rn(n)), !pe(n) && ["img", "a"].indexOf(w1(Ce(n))) >= 0 && $1(n), En.x = ae.x = t.clientX, En.y = ae.y = t.clientY, v && (bt = parseFloat(b.style[oe].replace(Xn, "")), $t(b, "0s"));
    }
    function I1(n) {
      if (ce) {
        var t = Zn(n);
        En.x = t.clientX, En.y = t.clientY, v ? Tn || (Tn = qn(function() {
          j1(n);
    ...
    function j1(n) {
      ...
      if (Nt(Tn), ce && (Tn = qn(function() {
        j1(n);
      })), Dn === "?" && (Dn = A1()), Dn) {
        !Ve && pe(n) && (Ve = !0);
        try {
          n.type && J.emit(pe(n) ? "touchMove" : "dragMove", rn(n));
        } catch {
        }
        var t = bt, o = ei(En, ae);
        if (!z || g || y)
          ...
          var s = j ? o * k * 100 / ((G + M) * A) : o * 100 / (G + M);
          t += s, t += "%";
        }
        b.style[oe] = Xn + t + me;
      }
      ...
      if (ce) {
        ...
        if (Math.abs(o)) {
          ...
          v ? Tn = qn(function() {
            if (z && !y) {
              var u = -o * k / (G + M);
              u = o > 0 ? Math.floor(u) : Math.ceil(u), f += u;
            } else {
              var m = -(bt + o);
              if (m <= 0)
                f = jn;
                ...
                for (var S = 0; S < A && m >= V[S]; )
                  f = S, m > V[S] && o < 0 && (f += 1), S++;
            }
            fi(n, o), J.emit(pe(n) ? "touchEnd" : "dragEnd", rn(n));
          }) : Dn && te(n, o > 0 ? -1 : 1);
        }
      }
      e.preventScrollOnTouch === "auto" && (Ve = !1), pt && (Dn = "?"), sn && !un && zt();
    }
    function ui() {
      var n = pn || cn;
      n.style.height = V[f + k] - V[f] + "px";
    }
    function D1() {
      var n = g ? (g + M) * x / G : x / k;
  ...
  class Ao {
    constructor() {
      this.device = window.innerWidth < 768 ? "mobile" : "desktop", q1("body", () => {
        d("head").elements[0].insertAdjacentHTML(
          "afterbegin",
        ...
        ), d("body").elements[0].insertAdjacentHTML(
          "afterbegin",
          /* html */
          `<style class="crs_style_v2">${P1}</style>`
        ), this.init();
      });
    }
    init() {
      Z1("exp_opt_in_v2", "variant_2"), this.getRandomNumberForSeatsLeft() || this.generateAndStoreRandomNumberForSeatsLeft(), this.addBlocks(), this.setActions(), this.setEvents(), this.setInnerTxtRandomNumberForSeatsLeft(), this.setSliderStories("#main_block"), this.setSliderStories(".crs_exit_popup"), this.intentPopupTriggers();
    }
    ...
    setInnerTxtRandomNumberForSeatsLeft() {
      Ht(".seats_left_value").then((i) => {
        const r = this.getRandomNumberForSeatsLeft();
        let a = Ci(".seats_left_value");
        r && a && a.forEach((c) => {
          c.textContent = r;
        });
      });
    ...
    addBlocks() {
      ...
      i && i.nextElementSibling && i.nextElementSibling.tagName.toLowerCase() === "style" && i.nextElementSibling.remove(), i.innerHTML = "", i.classList.add("crs_v2"), i.insertAdjacentHTML("afterbegin", to), i.insertAdjacentHTML("beforeend", io), i.insertAdjacentHTML("beforeend", oo), i.insertAdjacentHTML("beforeend", so), i.insertAdjacentHTML("beforeend", ro), this.device === "desktop" && (i.insertAdjacentHTML("beforeend", ao), i.insertAdjacentHTML("beforeend", co), i.insertAdjacentHTML("beforeend", lo), i.insertAdjacentHTML("beforeend", po)), i.insertAdjacentHTML("beforeend", fo), i.insertAdjacentHTML("beforeend", uo), i.insertAdjacentHTML("beforeend", vo), i.insertAdjacentHTML("beforeend", mo), i.insertAdjacentHTML("beforeend", ho), window.location.href.includes("dropservicing.net") && (d("#main_block h1").elements[0].innerHTML = "The 4 steps to start your online business <br /> in 2025 and achieve financial freedom goals");
    }
    setActions() {
      function i() {
        Ci(".txt_container").forEach((p) => {
          p.addEventListener("scroll", () => r(p));
        });
      }
      function r(l) {
        const p = l.scrollTop, _ = l.scrollHeight, C = l.clientHeight;
        p + C < _ ? (console.log("remove scrolling-up", l), l.classList.remove("scrolling-up")) : (console.log("add scrolling-up", l), l.classList.add("scrolling-up"));
      }
      function a() {
        d(".crs_blockers_popup").elements[0].classList.remove("active"), setTimeout(() => {
          var l, p;
          d(".crs_blockers_content").elements[0].innerHTML = "", (p = (l = d(".sticky_btn_wrapper")) == null ? void 0 : l.elements[0]) == null || p.remove();
        }, 300);
      }
      const c = setInterval(() => {
        window.Wistia && (clearInterval(c), window._wq = window._wq || [], window._wq.push({
          id: "ilo2gdof4l",
          onReady: function(l) {
            d("#video_loader").addClass("is_hidden"), l.bind("play", function() {
              console.log("PLAY"), D("exp_opt_in_v2__fs__video", "Open video", "click", "First screen"), d("#main_block .crs_stories").addClass("is_hidden");
            }), l.bind("pause", function() {
              console.log("PAUSE"), d("#main_block .crs_stories").removeClass("is_hidden");
            }), new MutationObserver(() => {
              var _, C, $, j, X;
              ((_ = d(".crs_popup_form").elements[0]) != null && _.classList.contains("active") || (C = d(".crs_blockers_popup").elements[0]) != null && C.classList.contains("active") || ($ = d(".crs_video_popup").elements[0]) != null && $.classList.contains("active") || (j = d("#video_block").elements[0]) != null && j.classList.contains("is_play") || (X = d(".crs_exit_popup").elements[0]) != null && X.classList.contains("active")) && l.pause();
            }).observe(document.body, { attributes: !0, subtree: !0, attributeFilter: ["class"] });
          }
        }));
      }, 500);
      if (d("[data-seedetails]").on("click", function(l) {
        const p = l.currentTarget;
        if (!p)
          return;
        d("body").elements[0].style.overflow = "hidden", d(".crs_blockers_popup").elements[0].classList.add("active");
        const _ = p.getAttribute("data-id"), C = d(".crs_blockers_popup").elements[0], $ = d(".crs_blockers_content").elements[0], j = yi.find((T) => T.id === parseInt(_ || "")), X = j == null ? void 0 : j.popupContent.title;
        if (D(
          ...
          ), Ht(".crs_blockers_content .info_wrapper").then((Ee) => {
            D("exp_opt_in_v2__popup_det__view", "Popup", "view", `Popup. ${X}`);
          }), d(".crs_blockers_popup .cta").on("click", function(Ee) {
            Ee.currentTarget && (D("exp_opt_in_v2__popup_det__cta", "Yes! Get Access Now!", "click", `Popup. ${X}`), a(), setTimeout(() => {
              d(".crs_popup_form").elements[0].classList.add("active"), hn(
      ...
      }), d("[data-closeblokers]").on("click", function(l) {
        console.log(l.currentTarget), (l.target.matches(".crs_blockers_popup") || l.currentTarget.matches(".close")) && (a(), d("body").elements[0].style.overflow = "auto");
      }), d(".show_more_block").on("click", function(l) {
        const p = l.currentTarget;
        if (!p)
          return;
        p.classList.toggle("is_open");
        const _ = p.previousElementSibling, C = p.querySelector("span");
        _ && _.classList.toggle("is_open"), C && !p.classList.contains("is_open") ? (C.textContent = "Show more options", R1(".blokers_list li:nth-of-type(4) .blokers_item")) : C && (C.textContent = "Show less options");
      }), d("[data-closeexit]").on("click", function(l) {
        !l.target.closest(".crs_main_info") && !l.target.closest(".crs_stories") && (d("body").elements[0].style.overflow = "auto", d(".crs_exit_popup").elements[0].classList.remove("active"));
      }), d(".crs_exit_popup .cta").on("click", function(l) {
        D("exp_opt_in_v2__p_exit__yes", "Yes, I want free training & bonuses", "click", "Popup. Exit-intent"), d(".crs_exit_popup").elements[0].classList.remove("active"), hn(
          ".crs_popup_form.active .inputs1",
          "exp_opt_in_v2__p_form__1__view",
          "Popup. Access Your Exclusive Online Training. Step 1",
          "Popup"
        ), setTimeout(() => {
          d(".crs_popup_form").elements[0].classList.add("active");
        }, 800);
      }), d(".no_btn").on("click", function(l) {
        D("exp_opt_in_v2__p_exit__no", "No, I'll miss out", "click", "Popup. Exit-intent"), d("body").elements[0].style.overflow = "auto", d(".crs_exit_popup").elements[0].classList.remove("active");
      }), d(".inputs2").on("click", "li", function() {
      ...
      }), d("form").on("submit", async function(l) {
        l.preventDefault();
        const p = window.location.href.includes("dropservicingblueprint") ? 1 : 2, _ = this.querySelector('input[name="name"]').value, C = this.querySelector('input[name="email"]').value;
        let $ = !0;
        if ((!_ || _.trim() === "") && (this.querySelector('input[name="name"]').closest("label").classList.add("error"), $ = !1), (!C || C.trim() === "" || !C.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)) && (this.querySelector('input[name="email"]').closest("label").classList.add("error"), $ = !1), !$)
          return;
        this.closest("#main_block") ? D(
        ...
        if (this.querySelector(".inputs2").classList.contains("active")) {
          const T = d(".inputs2 .selected").elements[0].getAttribute("data-schedule");
          ...
          }).then((Cn) => Cn.json()).then((Cn) => {
            window.location.href = Cn.user.thank_you_url;
          });
        } else
          try {
            const T = await fetch("https://conversionrate.top/api/dropservicing/get-schedules", {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
            ...
            console.log(T), console.log(this), this.querySelector(".inputs1").style.display = "none", this.querySelector(".inputs2").innerHTML = _o(T.webinar.schedules, T.webinar.timezone), this.querySelector(".inputs2").classList.add("active"), D(
      ...
      }), d("form input").on("input", function() {
        this.closest("label").classList.remove("error");
      }), d('input[name="name"]').on("change", function() {
        !!this.closest("#main_block") ? D("exp_optin_fs_name", "Enter your name", "input", "First screen form") : D(
          "exp_opt_in_v2__p_form__1__name",
          "Input. Enter your name",
          "click",
          "Popup. Access Your Exclusive Online Training. Step 1"
        );
      }), d('input[name="email"]').on("change", function() {
        !!this.closest("#main_block") ? D("exp_optin_fs_email", "Enter email address", "input", "First screen form") : D(
          "exp_opt_in_v2__p_form__1__email",
          "Input. Enter email address",
          "click",
          "Popup. Access Your Exclusive Online Training. Step 1"
        );
      }), d('input[name="email"]').on("focus", function() {
        d(".name_label").elements[0].classList.contains("is_hidden") && d(".name_label").elements[0].classList.remove("is_hidden");
      }), d(".question").on("click", function() {
        const l = this.innerText;
        if (this.classList.contains("active")) {
          this.classList.remove("active"), D("exp_optin_faq_close", `Close question. ${l}`, "click", "Frequently asked questions");
          return;
        }
        d(".question.active").removeClass("active"), this.classList.toggle("active"), D("exp_optin_faq_open", `Open question. ${l}`, "click", "Frequently asked questions");
      }), d(".cta.pop").on("click", function() {
        var l, p, _, C;
        d("body").elements[0].style.overflow = "hidden", console.log(".cta.pop"), (p = (l = d(".crs_video_popup")) == null ? void 0 : l.elements[0]) != null && p.classList.contains("active") && d(".crs_video_popup .video *:not(.crs_close)").elements.forEach(($) => $.remove()), (C = (_ = d(".crs_video_popup")) == null ? void 0 : _.elements[0]) == null || C.classList.remove("active"), d(".crs_popup_form").elements[0].classList.add("active"), this.closest("#last_cta") && D("exp_optin_future_cta", "Join the exclusive training", "click", "Your Future Starts Here"), this.closest("#training_for") && D("exp_optin_who_cta", "Join The FREE Training Now", "click", "Who is the Training for"), this.closest("#host_block") && D("exp_optin_host_cta", "Unlock Dylan’s Formula for Free ", "click", "Your Host: Dylan Sydney"), this.closest("#bonus_block") && D("exp_optin_bonuses_cta", "Grab Your FREE Seat Now", "click", "Exclusive Bonuses"), this.closest(".crs_video_popup") && D("exp_optin_popup_review_cta", "Grab Your FREE Seat Now", "click", "Popup after review"), this.closest("#main_block") && D("exp_opt_in_v2__fs__cta", "Yes! Get Access Now!", "click", "First screen"), hn(
          ".crs_popup_form.active",
          "exp_opt_in_v2__p_form__1__view",
          "Popup. Access Your Exclusive Online Training. Step 1",
          "Popup"
        );
      }), d("[data-closeform]").on("click", function(l) {
        (l.target.matches(".crs_popup_form") || l.currentTarget.matches(".close")) && (d("body").elements[0].style.overflow = "auto", d(".crs_popup_form").elements[0].classList.remove("active"), d(".crs_popup_form .inputs1").elements[0].style.display = "block", d(".crs_popup_form .inputs2").removeClass("active"), sessionStorage.getItem("intentPopupTriggers") || setTimeout(() => {
          sessionStorage.setItem("intentPopupTriggers", "true"), d(".crs_exit_popup").elements[0].classList.add("active"), d("body").elements[0].style.overflow = "hidden", D("exp_opt_in_v2__p_exit__view", "Popup", "view", "Popup. Exit-intent");
        }, 400));
      }), d("#base_review .slide").on("click", function() {
        var C, $;
        const l = this.querySelector(".slide>p").textContent, p = this.getAttribute("data-video"), _ = d(`.video_slide[data-video="${p}"] .video`).elements[0].cloneNode(!0);
        console.log(_, p, "videoBlock"), d(".crs_video_popup .video").elements[0].appendChild(_), ($ = (C = d(".crs_video_popup")) == null ? void 0 : C.elements[0]) == null || $.classList.add("active"), D("exp_optin_why_join_review", `Open review. ${l}`, "click", "Why Join This Webinar"), d(".crs_video_popup .wistia_embed").on("click", function() {
          D("exp_optin_popup_review_video", `Play video ${l}`, "click", "Popup after review");
        });
      }), d(".crs_video_popup .crs_close").on("click", function() {
        d(".crs_video_popup .video *:not(.crs_close)").elements.forEach((l) => l.remove()), d(".crs_video_popup").elements[0].classList.remove("active");
      }), d("#base_review ul").elements[0]) {
        const l = st({
        ...
        setTimeout(() => {
          ...
          var C, $;
          const _ = p.navItems;
          Array.from(_).forEach((j) => j.classList.remove("tns-nav-near")), (C = _[p.index - 1]) == null || C.classList.add("tns-nav-near"), ($ = _[p.index + 1]) == null || $.classList.add("tns-nav-near");
        });
      }
      if (this.device === "desktop") {
        ...
        l.getInfo().slideItems[0].classList.add("tns-current"), l.getInfo().navItems[1].classList.add("tns-nav-near"), l.events.on("indexChanged", function(p) {
          var j, X;
          const _ = p.slideItems, C = p.navItems;
          Array.from(C).forEach((T) => T.classList.remove("tns-nav-near")), Array.from(_).forEach((T) => T.classList.remove("tns-current")), (j = C[p.index - 1]) == null || j.classList.add("tns-nav-near"), (X = C[p.index + 1]) == null || X.classList.add("tns-nav-near"), _[p.index].classList.add("tns-current");
        }), st({
      ...
      const h = setInterval(() => {
        window.Wistia && (clearInterval(h), window._wq = window._wq || [], Pt.forEach((l) => {
          window._wq.push({
            id: l.videoId,
            onReady: function(p) {
              p.bind("play", function() {
                console.log("PLAY"), p.container.closest(".video_slide") && (p.container.closest("#video_block").classList.add("is_play"), D(
                ...
                p.container.closest("#video_block").classList.contains("is_play") && p.container.closest("#video_block").classList.remove("is_play");
              });
            }
          });
        }));
    ...
    setSliderStories(i) {
      d(`${i} .crs_stories_nav span`).on("click", function(r) {
        if (this.classList.contains("active"))
          return;
        d(`${i} .crs_stories_nav span`).removeClass("active"), this.classList.add("active");
        const a = Array.from(this.parentElement.children).indexOf(this), c = d(`${i} .crs_stories_content .crs_story`).elements[a].getBoundingClientRect().left, l = d(`${i} .crs_stories_content`).elements[0].getBoundingClientRect().left - c, p = d(`${i} .crs_stories_content`).elements[0].scrollLeft;
        d(`${i} .crs_stories_content`).elements[0].scrollTo({
          left: p - l,
          behavior: "smooth"
        });
      });
