        ...
        <div class="inner">
            ...
            <div class="features">
                ...
                <ul>
                    ...
                    <li>1-Page Blueprint <span>($99)</span></li>
                    <li>1-Page Workshop <span>($199)</span></li>
                    <li>The 1 Page Launch <span>($499)</span></li>
...
let count = 2011 - (intervalTime / 1000)
...
function listener(e) {
	...
	dataLayer.push({
		'event': 'event-to-ga',
		'eventCategory': 'Exp — Webinar page special offer 10 secrets',
...
function showSaleBtn() {
	let interval = setInterval(() => {
		if (document.querySelector('.btn-wrapper')) {
			...
			if (mediaQuery.matches) {
				priceText = `<p class="price">$349<sup>$588</sup></p><p class="subprice">and get $6k in FREE gifts now</p>`

			} else {
				document.querySelector('.banner .subtitle').innerHTML = `Get SamCart and $6k<br>in FREE gifts now`
...
hj('event', 'webinar_page_special_offer_10_secrets')
