        ...
        <div class="inner">
            ...
            <div class="features">
                ...
                <ul>
                    ...
                    <li>1-Page Workshop <span>($199)</span></li>
                    <li>Traffic Tactics <span>($1,997)</span></li>
                    <li>The $237k Swipe File <span>($1,495)</span></li>
                    <li>Product Creation Masterclass <span>($499)</span></li>
                    <li>1 Page Wednesday Coaching Calls</li> 
                    <li>The Private Facebook Group</li>   
                    <li>Expert Bonus Trainings <span>($199)</span></li>               
...
let count = 4441 - (intervalTime / 1000)
...
function showSaleBtn() {
	let interval = setInterval(() => {
		if (document.querySelector('.btn-wrapper')) {
			...
			document.querySelector('.btn-wrapper').innerHTML = `<button class="btn-wrapper_sale" onclick="location.href='https://checkout.samcart.com/products/the-samcart-launch-bundle/'">Continue to special offer</button>`
			document.querySelector('.banner').classList.add('show_sale')

			let priceText

			if (mediaQuery.matches) {
				priceText = `<p class="price">$349<sup>$588</sup></p><p class="subprice">and get $16k in FREE gifts now</p>`

			} else {
				document.querySelector('.banner .subtitle').innerHTML = `Get SamCart and $16k<br>in FREE gifts now`
