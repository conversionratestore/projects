...
function abjqlr() {
    ...
    var p =
        ...
        m = $('#cssmenu .parent.has-sub:eq(0)').clone(),
        b = $('#cssmenu .parent.has-sub:eq(1)').clone(),
        g = $('.navbar-right .nav-search').html();
    function v() {
        $('body').find('.ab-test-menu').scrollLeft(0),
            $('body')
                ...
                .each(function (e, a) {
                    var t =
                        $(this).offset().left -
                        $('body').find('.ab-test-menu').offset().left;
                });
    }
    $('.row.collapse.navbar-collapse.no-transition').html(
        ...
        $('.search-and-menu .left-menu [href="/pages/search-by-vehicle"]').html(
            i.vehicle
        ),
        ...
        $(document).on('click', '.test-menu-control', function (e) {
            var a,
                t = $('body').find('.ab-test-menu').data('current_pos');
            t < 0 && (t = 1),
                t > $('body').find('.ab-test-menu a').length && (t = 1),
                $(this).hasClass('control-next') ? t++ : t--,
                (a = t),
                $('body')
                    .find('.ab-test-menu')
                    .animate({
