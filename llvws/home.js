...
const initBanner = setInterval(() => {
    if (document.querySelector('#banner-box')) {
        ...
        <div class="crs_activity">
            ...
            <a href="https://lakelasvegaswatersports.com/paddleboard-rentals/" class="d-flex crs_activity_item items-center">
                ${svgCircle}
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
            ...
            <a href="https://lakelasvegaswatersports.com/y2k-cruise/" class="d-flex crs_activity_item items-center">
                ${svgCircle}
                ...
                <span>Y2K Cruise Cruise</span>
                ${arrow}
            </a>
            <a href="https://lakelasvegaswatersports.com/latin-night-cruise-at-lake-las-vegas/" class="d-flex crs_activity_item items-center">
                ${svgCircle}
