  ...
  const icons = {
    ...
    copied: /* html */ `
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M14 3.99217L6.3173 12L2 7.49999L2.95189 6.50783L6.3173 10.0157L13.0481 3L14 3.99217Z" fill="white"/>
      </svg>`
  }
  ...
  class IndentPopup {
    ...
    #showCopiedBadge() {
      const copied = /* html */ `
        <div class="copy_code_inform"><span>${icons.copied}</span>Code copied</div>
      `
      return copied;
    }
