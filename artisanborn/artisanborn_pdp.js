  ...
  if (document.querySelector("#shopify-section-product-template")) {
    ...
    <div class="body_popup">
        ...
        <div class="inform_pdp">
          ...
          <form method="post" action="//stamped.io/api/questions" id="new-question-form" onsubmit = "event.preventDefault(); StampedFn.submitQuestionForm(this); setTimeout(() => {document.querySelector('.sending_rqst').classList.add('is_visible')}, 3000);">
