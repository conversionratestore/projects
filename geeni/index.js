; (function () {
  ...
  .sticky-btn-wrapper button span {
    display: none;
  }
  ...
  <div class="compatibility_block ${classess}">
    ...
    const stickyBtn = (productName, packs) => {
      ...
      const packsHTML = [...packs].map((pack, index) => {
        // console.log(pack.dataset)
        return /*html*/`
          <p class=${index === 0 ? "sticky-btn-pack__option--active" : ''}>${+index + 1} Pack</p>
        `
      }).join('')
      ...
      <div class="sticky-btn-inner d-flex">
        <div class="sticky-btn-info">
          ...
          <div class="sticky-btn-info__price-wrapper d-flex">
            <p class="sticky-btn-info__price">$49.99</p>
            <p class="sticky-btn-info__old-price">$59.99</p>
        ...
        <button>
          ...
          <span class="sticky-btn-wrapper__price">$49.99</span>
        </button>
      </div>
    </div>
    `}
          ...
          document.body.addEventListener('click', (e) => {
            ...
            if (target.matches('.sticky-btn-pack__options > p')) {
              ...
              if (!selectedPack.classList.contains('sticky-btn-pack__option--active')) {
                currentProductPacks.innerText = selectedPack.innerText
            ...
            if (target.closest('.sticky-btn-pack')) {
              productPacks.classList.toggle('sticky-btn-pack__options--visible')
            } else {
