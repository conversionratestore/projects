(function() {
  ...
  }), s = "https://conversionratestore.github.io/projects/geeni/img/home-app-web", v = window.innerWidth < 768 ? "mobile" : "desktop", _ = (
    /*html*/
    `
  <style>
    :root {
  ...
  f("exp_home_optim"), x({ name: 'Keenethics: "Introduce content based on JBTD on HP"', dev: "Andrii" }), d("head").then((t) => t.insertAdjacentHTML("afterend", _)), d("#shopify-section-template--16970486120700__section-marquee").then((t) => t.insertAdjacentHTML("afterend", w)), y(), F(), k(), d("body").then((t) => t == null ? void 0 : t.classList.add("hide-chat-btn")), d('iframe[title="Messaging window"]').then((t) => {
    ...
    g(".free-shipping", "exp_home_optim_section_01", "Home Page Free Shipping on Orders Over $69", "Section", 4e3), g(".shop-all .container", "exp_home_optim_section_02", "Home Page Shop by category", "Section"), g(".hero .swiper", "exp_home_optim_section_03", "Home Page Featured products PDP", "Section"), g(".warranty-sale", "exp_home_optim_section_04", "Home Page Benefits", "Section"), t.addEventListener("click", (n) => {
      ...
      if (e.closest(".hero .product__btn")) {
        const a = (r = e.closest(".product")) == null ? void 0 : r.querySelector(".product__title");
      ...
      if (e.closest(".hero .product")) {
        const a = (o = e.closest(".hero .product")) == null ? void 0 : o.querySelector(".product__type");
  ...
  function y() {
    function t(n, e, i) {
      ...
      r.href = n, r.rel = e, i && (r.crossOrigin = i), document.head.appendChild(r);
    }
  ...
  function b() {
    const t = setInterval(() => {
      ...
      n && e && (clearInterval(t), d(".additional-functional").then((i) => i.addEventListener("click", (r) => {
        var o;
        r.target, r.target.closest('[data-img-func="accessibility"]') ? n.click() : r.target.closest('[data-img-func="sale"]') ? (o = document.querySelector(".kl-teaser-T4UsqC")) == null || o.click() : r.target.closest('[data-img-func="chat"]') && (e.contentDocument || e.contentWindow.document).querySelector('[data-garden-id="buttons.icon_button"]').click();
      })), setInterval(() => {
        var i, r, o;
        if (document.querySelector('[data-testid="POPUP"]') ? (i = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || i.classList.remove("hidden-el") : document.querySelector(".kl-teaser-T4UsqC") ? (o = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || o.classList.remove("hidden-el") : (r = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || r.classList.add("hidden-el"), document.querySelector('iframe[title="Number of unread messages"]')) {
          const a = document.querySelector('iframe[title="Number of unread messages"]'), p = (a.contentDocument || a.contentWindow.document).querySelector(".gwgkTo");
    ...
    m(["https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js", "https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.css"]).then(() => {
      const t = setInterval(() => {
        typeof Swiper < "u" && (clearInterval(t), d(".hero .swiper").then((n) => {
          const e = n.clientWidth, r = e * 1.07 - e + 16;
  ...
  function k() {
    v === "mobile" && d('.mobile-menu [aria-controls="nav-drawer"]').then((t) => {
  ...
  function u(t, n) {
    ...
    d(e).then((i) => {
      ...
      const o = setInterval(() => {
        ...
        a[3] && (clearInterval(o), a.forEach((l, p) => {
          document.querySelectorAll(`${e} .product-grid-item__inner`)[p].insertAdjacentHTML("beforeend", `<a class="product__shop-now" href="${l.href}">Shop now</a>`);
        }));
      }, 100);
    });
  }
      ...
      const t = setInterval(() => {
        if (typeof Glide < "u" && document.querySelector(".glide")) {
          ...
          const n = setInterval(() => {
            ...
            e && i && (console.log("Arrows are ready"), clearInterval(n), r.addEventListener("click", (o) => {
