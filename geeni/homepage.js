(function() {
    ...
    const g = (i, n, t, e = "") => {
      ...
      const n = (t) => new Promise((e, r) => {
        ...
        if (l === "js") {
          ...
          a.src = t, a.onload = e, a.onerror = r, document.head.appendChild(a);
        } else if (l === "css") {
          ...
          a.rel = "stylesheet", a.href = t, a.onload = e, a.onerror = r, document.head.appendChild(a);
        }
      });
      for (const t of i)
    ...
    }), s = "https://conversionratestore.github.io/projects/geeni/img/home-app-web", h = window.innerWidth < 768 ? "mobile" : "desktop", x = (
      /*html*/
      `
    <style>
      :root {
    ...
    <div class="additional-functional">
      <div data-img-func="accessibility" >
        <img src="${s}/accessible.svg" alt="Open accessibility features">
      </div>
      <div data-img-func="sale" class="hidden-el">
        <img src="${s}/sale.svg" alt="Open sale proposition">
      </div>
      <div data-img-func="chat">
        <img src="${s}/chat.svg" alt="Open suppport chat">
        <div><p></p></div>
      </div>
    </div>
  
    <div class="free-shipping">
      <img src="${s}/delivery.svg" alt="shipping">
      ...
      <div class="container">
        <div class="shop-all__heading">
          ...
          <a href="/collections/all" class="shop-all__view">
            View all
            <img src="${s}/arrow-r.svg" alt="">
          </a>
        </div>
        <div class="menu-items">
          <a href="/collections/smart-security-cameras">
            <img src="${s}/cameras.jpg" alt="Cameras">
            <p>Cameras</p>
          </a>
          <a href="/collections/smart-appliances">
            <img src="${s}/lifestyle.jpg" alt="Lifestyle">
            <p>Lifestyle</p>
          </a>
          <a href="/collections/lighting">
            <img src="${s}/lighting.jpg" alt="Lighting">
            <p>Lighting</p>
          </a>
          <a href="/collections/power">
            <img src="${s}/power.jpg" alt="Power">
            <p>Power</p>
          </a>
        </div>
      </div>
          ...
          <div class="glide">
            ...
            <div class="glide__arrows" data-glide-el="controls">
              <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                <img src="${s}/arrow-l.svg" alt="arrow left">
              </button>
              <button class="glide__arrow glide__arrow--right" data-glide-dir=">">
                <img src="${s}/arrow-r.svg" alt="arrow right">
              </button>
            </div>
          </div>
    ...
    <section class="many-devices">
      <div class="container">
        <div class="many-devices__split">
          <img src="${s}/house-1.jpg" alt="">
          <img src="${s}/house-2.jpg" alt="">
        </div>
        <div class="many-devices__mobiles">
          <img src="${s}/many-devices.svg" alt="">
        </div>
    ...
    <section class="trusted-reviews">
      <div class="container">
        ...
        <div class="trusted-reviews__rate">
          <img src="${s}/4-stars.svg" alt="4 stars">
        ...
        <div class="trusted-load-more load-more-btn-visible">
            ...
            <div class="swiper-slide">
              <img src="${s}/5-stars.svg" alt="5 stars">
    ...
    _("exp_home_optim"), f({ name: 'Keenethics: "Introduce content based on JBTD on HP"', dev: "Andrii" }), p("head").then((i) => i.insertAdjacentHTML("afterend", x)), p("#shopify-section-template--16970486120700__section-marquee").then((i) => i.insertAdjacentHTML("afterend", w)), S(), $(), E(), k(), T(), B(), p("body").then((i) => i == null ? void 0 : i.classList.add("hide-chat-btn")), p('iframe[title="Messaging window"]').then((i) => {
      new MutationObserver((t) => {
        var e, r;
        for (let l of t)
          l.type === "attributes" && l.attributeName === "tabindex" && (console.log("Tabindex changed to:", i.getAttribute("tabindex")), i.getAttribute("tabindex") === "-1" ? (e = document.querySelector("body")) == null || e.classList.add("hide-chat-btn") : (r = document.querySelector("body")) == null || r.classList.remove("hide-chat-btn"));
      }).observe(i, { attributes: !0 });
    }), p(".load-more-btn").then((i) => {
      i.addEventListener("click", () => {
        const n = document.querySelector(".trusted-load-more");
        n && n.classList.remove("load-more-btn-visible");
      });
    }), A(), p("body").then((i) => {
      m(".free-shipping", "exp_home_optim_section_01", "Home Page Free Shipping on Orders Over $69", "Section", 4e3), m(".shop-all .container", "exp_home_optim_section_02", "Home Page Shop by category", "Section"), m(".hero .swiper", "exp_home_optim_section_03", "Home Page Featured products PDP", "Section"), m(".warranty-sale", "exp_home_optim_section_04", "Home Page Benefits", "Section"), i.addEventListener("click", (n) => {
        var e, r, l;
        const t = n.target;
        if (t.closest("button.mobile-menu__button") && g("exp_home_optim_button_01", "Menu", "Button", "Home Page Header"), t.closest(".shop-all__view") && g("exp_home_optim_button_01", "Menu", "Button", "Home Page Header"), t.closest(".menu-items a")) {
          const o = (e = t.closest(".menu-items a")) == null ? void 0 : e.querySelector("p");
          g("exp_home_optim_button_05", `${o == null ? void 0 : o.innerText} - choise category`, "Button", "Home Page Shop by category");
        }
        if (t.closest(".hero .product__btn")) {
          const o = (r = t.closest(".product")) == null ? void 0 : r.querySelector(".product__title");
          g("exp_home_optim_button_06", `${o == null ? void 0 : o.innerText} - Shop now`, "Button", "Home Page Featured products PDP");
        }
        if (t.closest(".hero .product")) {
          const o = (l = t.closest(".hero .product")) == null ? void 0 : l.querySelector(".product__type");
          g("exp_home_optim_button_07", `${o == null ? void 0 : o.innerText} - Click`, "Button", "Home Page Featured products PDP");
        }
      });
    });
    async function y(i, n) {
      try {
        const t = await fetch(`https://mygeeni.com/products/${i}.json`, {
          method: "GET",
          headers: {
        ...
        throw console.error(`Failed to fetch product data for handle ${i}: ${t}`), t;
      }
    }
    function b(i) {
      const n = i.length, t = i.map((e, r) => (
        /*html*/
        `
          <div class="glide__slide new-arrivals-product">
              ...
              <div class="new-arrivals-product__content">
                <div class="new-arrivals__nav">
                  ...
                  <p class="new-arrivals-product__number">${r + 1}/${n}</p>
      ...
      p(".new-arrivals .new-arrivals__content .glide__slides").then((e) => e == null ? void 0 : e.insertAdjacentHTML("beforeend", t));
    }
    function F(i) {
      const t = (
        /*html*/
        ...
        <div class="container">
          ...
          <div class="swiper">
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              ${i.map((e, r) => {
          const l = e.compare_at_price - e.price, o = Math.round(l / e.compare_at_price * 100), a = l > 0 ? `Save ${o}%` : "", d = e.compare_at_price && e.compare_at_price !== e.price ? `${e.compare_at_price}` : "", c = e.product_type.toLowerCase().includes("camera") ? "Cameras" : e.product_type;
          return (
            /*html*/
            `
      <div class="swiper-slide product">
        <img class="product__img" src="${e.image_src}" alt="${e.title}">
        ...
        <div class="product__info">
          ...
          <a class="product__btn" href="/products/${e.handle}">Shop now</a>
        </div>
      </div>`
          );
        }).join("")}
    ...
    `
      ...
      h === "desktop" ? p(".free-shipping").then((e) => e == null ? void 0 : e.insertAdjacentHTML("afterend", t)) : p(".shop-all").then((e) => e == null ? void 0 : e.insertAdjacentHTML("afterend", t));
    }
    async function S() {
      const i = document.getElementById("productData");
      if (!i || !i.textContent) {
      ...
      const r = t.map((a, d) => y(a));
      (await Promise.allSettled(r)).forEach((a, d) => {
        if (a.status === "fulfilled") {
          const c = document.querySelectorAll(".products-list__item__description")[d], I = c ? c.innerText : "", z = a.value.price ? `$${a.value.price}` : "";
          e.push({ ...a.value, description: I, price: z });
        } else
          console.error(`Failed to fetch product data for handle ${t[d]}: ${a.reason}`);
      });
      const o = window._dy_customer_logged_in && window._dy_customer_logged_in.email !== void 0;
      F(o ? e : n), b(e);
    }
    function k() {
      function i(n, t, e) {
        const r = document.createElement("link");
        r.href = n, r.rel = t, e && (r.crossOrigin = e), document.head.appendChild(r);
      }
    ...
    function A() {
      const i = setInterval(() => {
        ...
        n && t && (clearInterval(i), p(".additional-functional").then((e) => e.addEventListener("click", (r) => {
          var l;
          r.target, r.target.closest('[data-img-func="accessibility"]') ? n.click() : r.target.closest('[data-img-func="sale"]') ? (l = document.querySelector(".kl-teaser-T4UsqC")) == null || l.click() : r.target.closest('[data-img-func="chat"]') && (t.contentDocument || t.contentWindow.document).querySelector('[data-garden-id="buttons.icon_button"]').click();
        })), setInterval(() => {
          var e, r, l;
          if (document.querySelector('[data-testid="POPUP"]') ? (e = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || e.classList.remove("hidden-el") : document.querySelector(".kl-teaser-T4UsqC") ? (l = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || l.classList.remove("hidden-el") : (r = document.querySelector('.additional-functional [data-img-func="sale"]')) == null || r.classList.add("hidden-el"), document.querySelector('iframe[title="Number of unread messages"]')) {
            const o = document.querySelector('iframe[title="Number of unread messages"]'), d = (o.contentDocument || o.contentWindow.document).querySelector(".gwgkTo");
    ...
    function $() {
      u(["https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js", "https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.css"]).then(() => {
        const i = setInterval(() => {
          typeof Swiper < "u" && (clearInterval(i), p(".hero .swiper").then((n) => {
            const t = n.clientWidth, r = t * 1.07 - t + 16;
    ...
    function T() {
      h === "mobile" && p('.mobile-menu [aria-controls="nav-drawer"]').then((i) => {
        document.querySelector("h1.logo").insertAdjacentElement("beforebegin", i);
      });
    }
    function v(i, n) {
      const t = `[data-products-type="${i}"] .products-wrapper`;
      p(t).then((e) => {
        ...
        const l = setInterval(() => {
          const o = document.querySelectorAll(`${t} .product-grid-item__title`);
          o[3] && (clearInterval(l), o.forEach((a, d) => {
            document.querySelectorAll(`${t} .product-grid-item__inner`)[d].insertAdjacentHTML("beforeend", `<a class="product__shop-now" href="${a.href}">Shop now</a>`);
          }));
        }, 100);
      });
    }
      ...
      u(["https://cdn.jsdelivr.net/npm/@glidejs/glide@3.4.1/dist/css/glide.core.min.css", "https://cdn.jsdelivr.net/npm/@glidejs/glide@3.4.1/dist/glide.min.js"]).then(() => {
        const i = setInterval(() => {
          if (typeof Glide < "u" && document.querySelector(".glide")) {
            ...
            const n = setInterval(() => {
              const t = document.querySelector(".glide__arrow--left"), e = document.querySelector(".glide__arrow--right"), r = document.querySelector(".glide");
              t && e && (console.log("Arrows are ready"), clearInterval(n), r.addEventListener("click", (l) => {
                console.log(l.target), l.target.closest(".swiper-button-prev-mob") && t.dispatchEvent(new Event("click")), l.target.closest(".swiper-button-next-mob") && e.dispatchEvent(new Event("click"));
              }));
            }, 100);
          }
        }, 100);
