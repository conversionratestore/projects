...
`;
  ...
  const g = "http://conversionratestore.github.io/projects/drgolly/removing_barriers_on_pdp/", w = `.crs-header-bundle {
  margin-top: 16px;
  display: grid;
  ...
  class S {
    ...
    render() {
      const n = Array(5).fill(
        `<img src="${g}/img/icons/star.svg" width="20" height="20" loading="lazy" />`
      ).join(""), e = (
        /* HTML */
        `
      ...
      <div class="crs-video-section">
        ...
        <div class="video">
          <div class="video-container">
            <div
              class="video-cover"
              style="background-image: url('${g}/img/video_cover.webp');"
            >
  ...
  class Z {
    ...
    async addMorePaymentOptions() {
      ...
      <button type="button" data-button="more-payment-options">
        ...
        <div class="icon">${T.chevronDown}</div>
      </button>
    </div>`
      );
      (await c(
...
`;
  ...
  b({
    name: "Removing user barriers on product pages V2",
    dev: "OS"
  }), f("exp_pdp_imp");
  class O {
    constructor() {
