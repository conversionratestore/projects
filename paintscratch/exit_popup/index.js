...
(function() {
    ...
    for (let t = 1; t < arguments.length; t += 1) {
      ...
      if (i != null && !$e(i)) {
        ...
        for (let r = 0, l = n.length; r < l; r += 1) {
          const a = n[r], o = Object.getOwnPropertyDescriptor(i, a);
          o !== void 0 && o.enumerable && (Y(s[a]) && Y(i[a]) ? i[a].__swiper__ ? s[a] = i[a] : O(s[a], i[a]) : !Y(s[a]) && Y(i[a]) ? (s[a] = {}, i[a].__swiper__ ? s[a] = i[a] : O(s[a], i[a])) : s[a] = i[a]);
        }
      }
    }
    return s;
  ...
  function ue(s) {
    ...
    const n = A(), r = -e.translate;
    let l = null, a;
    const o = e.params.speed;
    e.wrapperEl.style.scrollSnapType = "none", n.cancelAnimationFrame(e.cssModeFrameID);
    const c = t > r ? "next" : "prev", p = (g, m) => c === "next" && g >= m || c === "prev" && g <= m, f = () => {
      a = (/* @__PURE__ */ new Date()).getTime(), l === null && (l = a);
      const g = Math.max(Math.min((a - l) / o, 1), 0), m = 0.5 - Math.cos(g * Math.PI) / 2;
      let h = r + m * (t - r);
  ...
  function Be(s) {
    ...
    const t = he(), i = A(), n = i.navigator.platform, r = e || i.navigator.userAgent, l = {
      ios: !1,
      android: !1
    }, a = i.screen.width, o = i.screen.height, c = r.match(/(Android);?[\s\/]+([\d.]+)?/);
    let p = r.match(/(iPad).*OS\s([\d_]+)/);
    const f = r.match(/(iPod)(.*OS\s([\d_]+))?/), g = !p && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/), m = n === "Win32";
    let h = n === "MacIntel";
    const w = ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"];
    return !p && h && t.touch && w.indexOf(`${a}x${o}`) >= 0 && (p = r.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), h = !1), c && !m && (l.os = "android", l.android = !0), (p || g || f) && (l.os = "ios", l.ios = !0), l;
  }
  function me(s) {
      ...
      !e || e.destroyed || !e.initialized || (r = new ResizeObserver((f) => {
        l = n.requestAnimationFrame(() => {
          ...
          f.forEach((b) => {
            ...
            v && v !== e.el || (h = u ? u.width : (d[0] || d).inlineSize, w = u ? u.height : (d[0] || d).blockSize);
          }), (h !== g || w !== m) && a();
        });
      }), r.observe(e.el));
    }, c = () => {
  ...
  var Re = {
    ...
    emit() {
      ...
      for (var n = arguments.length, r = new Array(n), l = 0; l < n; l++)
        r[l] = arguments[l];
      return typeof r[0] == "string" || Array.isArray(r[0]) ? (e = r[0], t = r.slice(1, r.length), i = s) : (e = r[0].events, t = r[0].data, i = r[0].context || s), t.unshift(i), (Array.isArray(e) ? e : e.split(" ")).forEach((o) => {
  ...
  function qe() {
    const s = this;
    function e(y, E) {
      return parseFloat(y.getPropertyValue(s.getDirectionLabel(E)) || 0);
    }
    const t = s.params, {
      wrapperEl: i,
      slidesEl: n,
      ...
      rtlTranslate: l,
      wrongRTL: a
    } = s, o = s.virtual && t.virtual.enabled, c = o ? s.virtual.slides.length : s.slides.length, p = _(n, `.${s.params.slideClass}, swiper-slide`), f = o ? s.virtual.slides.length : p.length;
    let g = [];
    const m = [], h = [];
    ...
    let v = t.spaceBetween, x = -w, S = 0, M = 0;
    if (typeof r > "u")
      return;
    typeof v == "string" && v.indexOf("%") >= 0 ? v = parseFloat(v.replace("%", "")) / 100 * r : typeof v == "string" && (v = parseFloat(v)), s.virtualSize = -v, p.forEach((y) => {
    ...
    for (let y = 0; y < f; y += 1) {
      L = 0;
      let E;
      if (p[y] && (E = p[y]), D && s.grid.updateSlide(y, E, p), !(p[y] && G(E, "display") === "none")) {
        if (t.slidesPerView === "auto") {
          z && (p[y].style[s.getDirectionLabel("width")] = "");
          ...
          if (T && (E.style.transform = "none"), P && (E.style.webkitTransform = "none"), t.roundLengths)
            ...
            const k = e(C, "width"), B = e(C, "padding-left"), cs = e(C, "padding-right"), Le = e(C, "margin-left"), Pe = e(C, "margin-right"), Me = C.getPropertyValue("box-sizing");
            if (Me && Me === "border-box")
              L = k + Le + Pe;
            else {
              const {
              ...
              L = k + B + cs + Le + Pe + (us - ps);
            }
          }
          T && (E.style.transform = T), P && (E.style.webkitTransform = P), t.roundLengths && (L = Math.floor(L));
        } else
          L = (r - (t.slidesPerView - 1) * v) / t.slidesPerView, t.roundLengths && (L = Math.floor(L)), p[y] && (p[y].style[s.getDirectionLabel("width")] = `${L}px`);
        p[y] && (p[y].swiperSlideSize = L), h.push(L), t.centeredSlides ? (x = x + L / 2 + S / 2 + v, S === 0 && y !== 0 && (x = x - r / 2 - v), y === 0 && (x = x - r / 2 - v), Math.abs(x) < 1 / 1e3 && (x = 0), t.roundLengths && (x = Math.floor(x)), M % t.slidesPerGroup === 0 && g.push(x), m.push(x)) : (t.roundLengths && (x = Math.floor(x)), (M - Math.min(s.params.slidesPerGroupSkip, M)) % s.params.slidesPerGroup === 0 && g.push(x), m.push(x), x = x + L + v), s.virtualSize += L + v, S = L, M += 1;
      }
    }
    if (s.virtualSize = Math.max(s.virtualSize, r) + b, l && a && (t.effect === "slide" || t.effect === "coverflow") && (i.style.width = `${s.virtualSize + v}px`), t.setWrapperSize && (i.style[s.getDirectionLabel("width")] = `${s.virtualSize + v}px`), D && s.grid.updateWrapperSize(L, g), !t.centeredSlides) {
      const y = [];
      for (let E = 0; E < g.length; E += 1) {
        let C = g[E];
        t.roundLengths && (C = Math.floor(C)), g[E] <= s.virtualSize - r && y.push(C);
      }
      g = y, Math.floor(s.virtualSize - r) - Math.floor(g[g.length - 1]) > 1 && g.push(s.virtualSize - r);
    }
    if (o && t.loop) {
      const y = h[0] + v;
      if (t.slidesPerGroup > 1) {
        const E = Math.ceil((s.virtual.slidesBefore + s.virtual.slidesAfter) / t.slidesPerGroup), C = y * t.slidesPerGroup;
        for (let T = 0; T < E; T += 1)
          g.push(g[g.length - 1] + C);
      }
      for (let E = 0; E < s.virtual.slidesBefore + s.virtual.slidesAfter; E += 1)
        t.slidesPerGroup === 1 && g.push(g[g.length - 1] + y), m.push(m[m.length - 1] + y), s.virtualSize += y;
    }
    if (g.length === 0 && (g = [0]), v !== 0) {
      const y = s.isHorizontal() && l ? "marginLeft" : s.getDirectionLabel("marginRight");
    ...
    if (Object.assign(s, {
      ...
      W(i, "--swiper-centered-offset-before", `${-g[0]}px`), W(i, "--swiper-centered-offset-after", `${s.size / 2 - h[h.length - 1] / 2}px`);
      const y = -s.snapGrid[0], E = -s.slidesGrid[0];
      s.snapGrid = s.snapGrid.map((C) => C + y), s.slidesGrid = s.slidesGrid.map((C) => C + E);
    }
    if (f !== c && s.emit("slidesLengthChange"), g.length !== d && (s.params.watchOverflow && s.checkOverflow(), s.emit("snapGridLengthChange")), m.length !== u && s.emit("slidesGridLengthChange"), t.watchSlidesProgress && s.updateSlidesOffset(), s.emit("slidesUpdated"), !o && !t.cssMode && (t.effect === "slide" || t.effect === "fade")) {
      const y = `${t.containerModifierClass}backface-hidden`, E = s.el.classList.contains(y);
      f <= t.maxBackfaceHiddenSlides ? E || s.el.classList.add(y) : E && s.el.classList.remove(y);
    }
  }
  function Ye(s) {
  ...
  function Xe(s) {
    ...
    for (let o = 0; o < i.length; o += 1) {
      ...
      const f = (l + (t.centeredSlides ? e.minTranslate() : 0) - p) / (c.swiperSlideSize + a), g = (l - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - p) / (c.swiperSlideSize + a), m = -(l - p), h = m + e.slidesSizesGrid[o], w = m >= 0 && m <= e.size - e.slidesSizesGrid[o];
      (m >= 0 && m < e.size - 1 || h > 1 && h <= e.size || m <= 0 && h >= e.size) && (e.visibleSlides.push(c), e.visibleSlidesIndexes.push(o), i[o].classList.add(t.slideVisibleClass)), w && i[o].classList.add(t.slideFullyVisibleClass), c.progress = n ? -f : f, c.originalProgress = n ? -g : g;
    }
  }
  function Ze(s) {
    const e = this;
    ...
    if (t.loop) {
      const p = e.getSlideIndexByData(0), f = e.getSlideIndexByData(e.slides.length - 1), g = e.slidesGrid[p], m = e.slidesGrid[f], h = e.slidesGrid[e.slidesGrid.length - 1], w = Math.abs(s);
      w >= g ? a = (w - g) / h : a = (w + h - m) / h, a > 1 && (a -= 1);
    }
    Object.assign(e, {
      progress: n,
      progressLoop: a,
      isBeginning: r,
      isEnd: l
    }), (t.watchSlidesProgress || t.centeredSlides && t.autoHeight) && e.updateSlidesProgress(s), r && !o && e.emit("reachBeginning toEdge"), l && !c && e.emit("reachEnd toEdge"), (o && !r || c && !l) && e.emit("fromEdge"), e.emit("progress", n);
  }
  function Ue() {
    const s = this, {
      slides: e,
      ...
      slidesEl: i,
      activeIndex: n
    } = s, r = s.virtual && t.virtual.enabled, l = s.grid && t.grid && t.grid.rows > 1, a = (f) => _(i, `.${t.slideClass}${f}, swiper-slide${f}`)[0];
    e.forEach((f) => {
    ...
    if (r)
      if (t.loop) {
        let f = n - s.virtual.slidesBefore;
      ...
      l ? (o = e.filter((f) => f.column === n)[0], p = e.filter((f) => f.column === n + 1)[0], c = e.filter((f) => f.column === n - 1)[0]) : o = e[n];
  ...
  function Je(s) {
    ...
    if (c >= i.length && (c = i.length - 1), o === r && !e.params.loop) {
    ...
    if (e.virtual && n.virtual.enabled && n.loop)
      ...
      Number.isNaN(h) && (h = Math.max(e.slides.indexOf(m), 0)), g = Math.floor(h / n.grid.rows);
    } else if (e.slides[o]) {
  ...
  function nt(s, e, t, i, n) {
    ...
    let p;
    if (i && s > o ? p = o : i && s < c ? p = c : p = s, r.updateProgress(p), l.cssMode) {
    ...
    return e === 0 ? (r.setTransition(0), r.setTranslate(p), t && (r.emit("beforeTransitionStart", e, n), r.emit("transitionEnd"))) : (r.setTransition(e), r.setTranslate(p), t && (r.emit("beforeTransitionStart", e, n), r.emit("transitionStart")), r.animating || (r.animating = !0, r.onTranslateToWrapperTransitionEnd || (r.onTranslateToWrapperTransitionEnd = function(g) {
      !r || r.destroyed || g.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onTranslateToWrapperTransitionEnd), r.onTranslateToWrapperTransitionEnd = null, delete r.onTranslateToWrapperTransitionEnd, t && r.emit("transitionEnd"));
  ...
  function pt(s, e, t, i, n) {
    ...
    if (r.animating && a.preventInteractionOnTransition || !h && !i && !n || r.destroyed)
      return !1;
    const w = Math.min(r.params.slidesPerGroupSkip, l);
    let b = w + Math.floor((l - w) / r.params.slidesPerGroup);
    b >= o.length && (b = o.length - 1);
    const d = -o[b];
    if (a.normalizeSlideIndex)
      for (let v = 0; v < c.length; v += 1) {
        const x = -Math.floor(d * 100), S = Math.floor(c[v] * 100), M = Math.floor(c[v + 1] * 100);
        typeof c[v + 1] < "u" ? x >= S && x < M - (M - S) / 2 ? l = v : x >= S && x < M && (l = v + 1) : x >= S && (l = v);
      }
    if (r.initialized && l !== f && (!r.allowSlideNext && (g ? d > r.translate && d > r.minTranslate() : d < r.translate && d < r.minTranslate()) || !r.allowSlidePrev && d > r.translate && d > r.maxTranslate() && (f || 0) !== l))
      return !1;
    l !== (p || 0) && t && r.emit("beforeSlideChangeStart"), r.updateProgress(d);
    let u;
    if (l > f ? u = "next" : l < f ? u = "prev" : u = "reset", g && -d === r.translate || !g && d === r.translate)
      return r.updateActiveIndex(l), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), a.effect !== "slide" && r.setTranslate(d), u !== "reset" && (r.transitionStart(t, u), r.transitionEnd(t, u)), !1;
    if (a.cssMode) {
      const v = r.isHorizontal(), x = g ? d : -d;
      if (e === 0) {
        ...
        S && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), S && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0 ? (r._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
          m[v ? "scrollLeft" : "scrollTop"] = x;
        })) : m[v ? "scrollLeft" : "scrollTop"] = x, S && requestAnimationFrame(() => {
    ...
    return r.setTransition(e), r.setTranslate(d), r.updateActiveIndex(l), r.updateSlidesClasses(), r.emit("beforeTransitionStart", e, i), r.transitionStart(t, u), e === 0 ? r.transitionEnd(t, u) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(x) {
      !r || r.destroyed || x.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onSlideToWrapperTransitionEnd), r.onSlideToWrapperTransitionEnd = null, delete r.onSlideToWrapperTransitionEnd, r.transitionEnd(t, u));
  ...
  function ut(s, e, t, i) {
    ...
    if (n.params.loop)
      if (n.virtual && n.params.virtual.enabled)
        ...
        let a;
        if (r) {
          const g = l * n.params.grid.rows;
          a = n.slides.filter((m) => m.getAttribute("data-swiper-slide-index") * 1 === g)[0].column;
        } else
        ...
        if (c && (f = f || a < Math.ceil(p / 2)), f) {
          const g = c ? a < n.activeIndex ? "prev" : "next" : a - n.activeIndex - 1 < n.params.slidesPerView ? "next" : "prev";
          n.loopFix({
            direction: g,
            slideTo: !0,
        ...
        if (r) {
          const g = l * n.params.grid.rows;
          l = n.slides.filter((m) => m.getAttribute("data-swiper-slide-index") * 1 === g)[0].column;
        } else
  ...
  function ft(s, e, t) {
    ...
    const o = i.activeIndex < r.slidesPerGroupSkip ? 1 : a, c = i.virtual && r.virtual.enabled;
    if (r.loop) {
      if (l && !c && r.loopPreventsSliding)
        return !1;
      if (i.loopFix({
        direction: "next"
    ...
    return r.rewind && i.isEnd ? i.slideTo(0, s, e, t) : i.slideTo(i.activeIndex + o, s, e, t);
  }
  function ht(s, e, t) {
    s === void 0 && (s = this.params.speed), e === void 0 && (e = !0);
    const i = this, {
    ...
    const m = g(f), h = r.map((d) => g(d));
    let w = r[h.indexOf(m) - 1];
    ...
    let b = 0;
    if (typeof w < "u" && (b = l.indexOf(w), b < 0 && (b = i.activeIndex - 1), n.slidesPerView === "auto" && n.slidesPerGroup === 1 && n.slidesPerGroupAuto && (b = b - i.slidesPerViewDynamic("previous", !0) + 1, b = Math.max(b, 0))), n.rewind && i.isBeginning) {
  ...
  function gt(s, e, t, i) {
    ...
    if (o >= n.snapGrid[a]) {
      const c = n.snapGrid[a], p = n.snapGrid[a + 1];
      o - c > (p - c) * i && (r += n.params.slidesPerGroup);
    } else {
      const c = n.snapGrid[a - 1], p = n.snapGrid[a];
      o - c <= (p - c) * i && (r -= n.params.slidesPerGroup);
    }
  ...
  function vt() {
    ...
    if (e.loop) {
      if (s.animating)
        return;
      r = parseInt(s.clickedSlide.getAttribute("data-swiper-slide-index"), 10), e.centeredSlides ? n < s.loopedSlides - i / 2 || n > s.slides.length - s.loopedSlides + i / 2 ? (s.loopFix(), n = s.getSlideIndex(_(t, `${l}[data-swiper-slide-index="${r}"]`)[0]), ee(() => {
        s.slideTo(n);
      })) : s.slideTo(n) : n > s.slides.length - i ? (s.loopFix(), n = s.getSlideIndex(_(t, `${l}[data-swiper-slide-index="${r}"]`)[0]), ee(() => {
        s.slideTo(n);
      })) : s.slideTo(n);
    } else
      s.slideTo(n);
  ...
  function xt(s) {
    ...
    }, r = e.grid && t.grid && t.grid.rows > 1, l = t.slidesPerGroup * (r ? t.grid.rows : 1), a = e.slides.length % l !== 0, o = r && e.slides.length % t.grid.rows !== 0, c = (p) => {
      for (let f = 0; f < p; f += 1) {
  ...
  function bt(s) {
    ...
    if (o.allowSlidePrev = !0, o.allowSlideNext = !0, o.virtual && m.virtual.enabled) {
      t && (!m.centeredSlides && o.snapIndex === 0 ? o.slideTo(o.virtual.slides.length, 0, !1, !0) : m.centeredSlides && o.snapIndex < m.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0)), o.allowSlidePrev = p, o.allowSlideNext = f, o.emit("loopFix");
      return;
    }
    ...
    let d = b;
    d % b !== 0 && (d += b - d % b), d += m.loopAdditionalSlides, o.loopedSlides = d;
    const u = o.grid && m.grid && m.grid.rows > 1;
    c.length < w + d ? X("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : u && m.grid.fill === "row" && X("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
    const v = [], x = [];
    let S = o.activeIndex;
    typeof r > "u" ? r = o.getSlideIndex(c.filter((T) => T.classList.contains(m.slideActiveClass))[0]) : S = r;
    const M = i === "next" || !i, D = i === "prev" || !i;
    let L = 0, z = 0;
    const y = u ? Math.ceil(c.length / m.grid.rows) : c.length, C = (u ? c[r].column : r) + (h && typeof n > "u" ? -w / 2 + 0.5 : 0);
    if (C < d) {
      L = Math.max(d - C, b);
      for (let T = 0; T < d - C; T += 1) {
        const P = T - Math.floor(T / y) * y;
        if (u) {
          const k = y - P - 1;
          for (let B = c.length - 1; B >= 0; B -= 1)
            c[B].column === k && v.push(B);
        } else
          v.push(y - P - 1);
      }
    } else if (C + w > y - d) {
      z = Math.max(C - (y - d * 2), b);
      for (let T = 0; T < z; T += 1) {
        const P = T - Math.floor(T / y) * y;
        u ? c.forEach((k, B) => {
          k.column === P && x.push(B);
    ...
    }), o.recalcSlides(), m.slidesPerView === "auto" ? o.updateSlides() : u && (v.length > 0 && D || x.length > 0 && M) && o.slides.forEach((T, P) => {
      o.grid.updateSlide(P, T, o.slides);
    }), m.watchSlidesProgress && o.updateSlidesOffset(), t) {
      if (v.length > 0 && D) {
        if (typeof e > "u") {
          const T = o.slidesGrid[S], k = o.slidesGrid[S + L] - T;
          a ? o.setTranslate(o.translate - k) : (o.slideTo(S + Math.ceil(L), 0, !1, !0), n && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - k, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - k));
        } else if (n) {
          const T = u ? v.length / m.grid.rows : v.length;
          o.slideTo(o.activeIndex + T, 0, !1, !0), o.touchEventsData.currentTranslate = o.translate;
        }
      } else if (x.length > 0 && M)
        if (typeof e > "u") {
          const T = o.slidesGrid[S], k = o.slidesGrid[S - z] - T;
          a ? o.setTranslate(o.translate - k) : (o.slideTo(S - z, 0, !1, !0), n && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - k, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - k));
        } else {
  ...
  function Pt(s) {
    ...
    let o = i.target;
    if (r.touchEventsTarget === "wrapper" && !e.wrapperEl.contains(o) || "which" in i && i.which === 3 || "button" in i && i.button > 0 || n.isTouched && n.isMoved)
      return;
    const c = !!r.noSwipingClass && r.noSwipingClass !== "", p = i.composedPath ? i.composedPath() : i.path;
    ...
    if (r.noSwiping && (g ? Lt(f, o) : o.closest(f))) {
      e.allowClick = !0;
      return;
    }
    ...
    Object.assign(n, {
      ...
      isScrolling: void 0,
      startMoving: void 0
    }), l.startX = m, l.startY = h, n.touchStartTime = q(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1);
    let w = !0;
    o.matches(n.focusableElements) && (w = !1, o.nodeName === "SELECT" && (n.isTouched = !1)), t.activeElement && t.activeElement.matches(n.focusableElements) && t.activeElement !== o && t.activeElement.blur();
    const b = w && e.allowTouchMove && r.touchStartPreventDefault;
    (r.touchStartForcePreventDefault || b) && !o.isContentEditable && i.preventDefault(), r.freeMode && r.freeMode.enabled && e.freeMode && e.animating && !r.cssMode && e.freeMode.onTouchStart(), e.emit("touchStart", i);
  }
  function Mt(s) {
    ...
    if (!a || !n.simulateTouch && s.pointerType === "mouse")
      return;
    let o = s;
    ...
    if (!t.allowTouchMove) {
      o.target.matches(i.focusableElements) || (t.allowClick = !1), i.isTouched && (Object.assign(r, {
        startX: p,
        startY: f,
        currentX: p,
        currentY: f
    ...
    i.allowTouchCallbacks && t.emit("touchMove", o), r.previousX = r.currentX, r.previousY = r.currentY, r.currentX = p, r.currentY = f;
    const g = r.currentX - r.startX, m = r.currentY - r.startY;
    if (t.params.threshold && Math.sqrt(g ** 2 + m ** 2) < t.params.threshold)
      return;
    if (typeof i.isScrolling > "u") {
      let M;
      t.isHorizontal() && r.currentY === r.startY || t.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : g * g + m * m >= 25 && (M = Math.atan2(Math.abs(m), Math.abs(g)) * 180 / Math.PI, i.isScrolling = t.isHorizontal() ? M > n.touchAngle : 90 - M > n.touchAngle);
    }
    if (i.isScrolling && t.emit("touchMoveOpposite", o), typeof i.startMoving > "u" && (r.currentX !== r.startX || r.currentY !== r.startY) && (i.startMoving = !0), i.isScrolling) {
      i.isTouched = !1;
      return;
    }
    if (!i.startMoving)
    ...
    let h = t.isHorizontal() ? g : m, w = t.isHorizontal() ? r.currentX - r.previousX : r.currentY - r.previousY;
    n.oneWayMovement && (h = Math.abs(h) * (l ? 1 : -1), w = Math.abs(w) * (l ? 1 : -1)), r.diff = h, h *= n.touchRatio, l && (h = -h, w = -w);
    ...
    if (!i.isMoved) {
      ...
      i.allowMomentumBounce = !1, n.grabCursor && (t.allowSlideNext === !0 || t.allowSlidePrev === !0) && t.setGrabCursor(!0), t.emit("sliderFirstMove", o);
    }
    let v;
    if ((/* @__PURE__ */ new Date()).getTime(), i.isMoved && i.allowThresholdMove && b !== t.touchesDirection && d && u && Math.abs(h) >= 1) {
      Object.assign(r, {
        startX: p,
        startY: f,
        currentX: p,
    ...
    t.emit("sliderMove", o), i.isMoved = !0, i.currentTranslate = h + i.startTranslate;
    let x = !0, S = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (S = 0), h > 0 ? (d && u && !v && i.allowThresholdMove && i.currentTranslate > (n.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] : t.minTranslate()) && t.loopFix({
      direction: "prev",
      setTranslate: !0,
      activeSlideIndex: 0
    }), i.currentTranslate > t.minTranslate() && (x = !1, n.resistance && (i.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + i.startTranslate + h) ** S))) : h < 0 && (d && u && !v && i.allowThresholdMove && i.currentTranslate < (n.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] : t.maxTranslate()) && t.loopFix({
      direction: "next",
      setTranslate: !0,
      activeSlideIndex: t.slides.length - (n.slidesPerView === "auto" ? t.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
    }), i.currentTranslate < t.maxTranslate() && (x = !1, n.resistance && (i.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - i.startTranslate - h) ** S))), x && (o.preventedByNestedSwiper = !0), !t.allowSlideNext && t.swipeDirection === "next" && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !t.allowSlidePrev && t.swipeDirection === "prev" && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), !t.allowSlidePrev && !t.allowSlideNext && (i.currentTranslate = i.startTranslate), n.threshold > 0)
  ...
  function kt(s) {
    ...
    if (i.type === "touchend" || i.type === "touchcancel") {
      if (n = [...i.changedTouches].filter((S) => S.identifier === t.touchId)[0], !n || n.identifier !== t.touchId)
        return;
    } else {
    ...
    const f = q(), g = f - t.touchStartTime;
    if (e.allowClick) {
      const S = i.path || i.composedPath && i.composedPath();
      e.updateClickedSlide(S && S[0] || i.target, S), e.emit("tap click", i), g < 300 && f - t.lastClickTime < 300 && e.emit("doubleTap doubleClick", i);
    }
    ...
    t.isTouched = !1, t.isMoved = !1, t.startMoving = !1;
    let m;
    if (l.followFinger ? m = o ? e.translate : -e.translate : m = -t.currentTranslate, l.cssMode)
      return;
    ...
    for (let S = 0; S < c.length; S += S < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup) {
      ...
      typeof c[S + M] < "u" ? (h || m >= c[S] && m < c[S + M]) && (w = S, b = c[S + M] - c[S]) : (h || m >= c[S]) && (w = S, b = c[c.length - 1] - c[c.length - 2]);
    }
    let d = null, u = null;
    l.rewind && (e.isBeginning ? u = l.virtual && l.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (d = 0));
    const v = (m - c[w]) / b, x = w < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
    if (g > l.longSwipesMs) {
      if (!l.longSwipes) {
  ...
  const xe = (s, e) => {
    ...
    t[o]("touchstart", s.onDocumentTouchStart, {
      passive: !1,
      capture: a
    }), n[o]("touchstart", s.onTouchStart, {
      passive: !1
    }), n[o]("pointerdown", s.onTouchStart, {
      passive: !1
      ...
      passive: !0
    }), (i.preventClicks || i.preventClicksPropagation) && n[o]("click", s.onClick, !0), i.cssMode && r[o]("scroll", s.onScroll), i.updateOnWindowResize ? s[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", we, !0) : s[c]("observerUpdate", we, !0), n[o]("load", s.onLoad, {
      capture: !0
    });
  };
  function $t() {
    ...
    s.onTouchStart = Pt.bind(s), s.onTouchMove = Mt.bind(s), s.onTouchEnd = kt.bind(s), s.onDocumentTouchStart = Ot.bind(s), e.cssMode && (s.onScroll = zt.bind(s)), s.onClick = It.bind(s), s.onLoad = At.bind(s), xe(s, "on");
  }
  function Dt() {
    xe(this, "off");
  }
  ...
  function Gt() {
    ...
    if (!r || r && Object.keys(r).length === 0)
      return;
    const l = s.getBreakpoint(r, s.params.breakpointsBase, s.el);
    if (!l || s.currentBreakpoint === l)
      return;
    const o = (l in r ? r[l] : void 0) || s.originalParams, c = be(s, i), p = be(s, o), f = i.enabled;
    c && !p ? (n.classList.remove(`${i.containerModifierClass}grid`, `${i.containerModifierClass}grid-column`), s.emitContainerClasses()) : !c && p && (n.classList.add(`${i.containerModifierClass}grid`), (o.grid.fill && o.grid.fill === "column" || !o.grid.fill && i.grid.fill === "column") && n.classList.add(`${i.containerModifierClass}grid-column`), s.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach((d) => {
      if (typeof o[d] > "u")
        return;
      const u = i[d] && i[d].enabled, v = o[d] && o[d].enabled;
      u && !v && s[d].disable(), !u && v && s[d].enable();
    });
    const g = o.direction && o.direction !== i.direction, m = i.loop && (o.slidesPerView !== i.slidesPerView || g), h = i.loop;
    g && t && s.changeDirection(), O(s.params, o);
    const w = s.params.enabled, b = s.params.loop;
    Object.assign(s, {
      allowTouchMove: s.params.allowTouchMove,
      allowSlideNext: s.params.allowSlideNext,
      allowSlidePrev: s.params.allowSlidePrev
    }), f && !w ? s.disable() : !f && w && s.enable(), s.currentBreakpoint = l, s.emit("_beforeBreakpoint", o), t && (m ? (s.loopDestroy(), s.loopCreate(e), s.updateSlides()) : !h && b ? (s.loopCreate(e), s.updateSlides()) : h && !b && s.loopDestroy()), s.emit("breakpoint", o);
  }
  function Bt(s, e, t) {
    if (e === void 0 && (e = "window"), !s || e === "container" && !t)
      return;
    let i = !1;
    const n = A(), r = e === "window" ? n.innerHeight : t.clientHeight, l = Object.keys(s).map((a) => {
    ...
    for (let a = 0; a < l.length; a += 1) {
      ...
      e === "window" ? n.matchMedia(`(min-width: ${c}px)`).matches && (i = o) : c <= t.clientWidth && (i = o);
    }
    return i || "max";
  }
  var Vt = {
  ...
  function Ft() {
    const s = this, {
      ...
      el: n,
      device: r
    } = s, l = Ht(["initialized", t.direction, {
  ...
  class $ {
    constructor() {
      ...
      const a = this;
      a.__swiper__ = !0, a.support = he(), a.device = me({
        userAgent: t.userAgent
      }), a.browser = He(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
      const o = {};
      a.modules.forEach((p) => {
        p({
          params: t,
      ...
      const c = O({}, ye, o);
      return a.params = O({}, c, le, t), a.originalParams = O({}, a.params), a.passedParams = O({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((p) => {
    ...
    getSlideIndex(e) {
      const {
        slidesEl: t,
        params: i
      } = this, n = _(t, `.${i.slideClass}, swiper-slide`), r = U(n[0]);
      return U(e) - r;
    }
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (n.centeredSlides) {
        let f = r[c] ? Math.ceil(r[c].swiperSlideSize) : 0, g;
        for (let m = c + 1; m < r.length; m += 1)
          r[m] && !g && (f += Math.ceil(r[m].swiperSlideSize), p += 1, f > o && (g = !0));
        for (let m = c - 1; m >= 0; m -= 1)
          r[m] && !g && (f += r[m].swiperSlideSize, p += 1, f > o && (g = !0));
      } else if (e === "current")
    ...
    mount(e) {
      ...
      let l = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(n()) : _(i, n())[0];
    ...
    init(e) {
      ...
      return t.isElement && n.push(...t.hostEl.querySelectorAll('[loading="lazy"]')), n.forEach((r) => {
        r.complete ? K(t, r) : r.addEventListener("load", (l) => {
          K(t, l.target);
        });
    ...
    destroy(e, t) {
      ...
      return typeof i.params > "u" || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), t && (i.removeClasses(), r.removeAttribute("style"), l.removeAttribute("style"), a && a.length && a.forEach((o) => {
        ...
        i.off(o);
      }), e !== !1 && (i.el.swiper = null, ze(i)), i.destroyed = !0), null;
    }
  ...
  function Se(s, e, t, i) {
    return s.params.createElements && Object.keys(i).forEach((n) => {
      if (!t[n] && t.auto === !0) {
        let r = _(s.el, `.${i[n]}`)[0];
        r || (r = Z("div", i[n]), r.className = i[n], s.el.append(r)), t[n] = r, e[n] = r;
      }
    }), t;
  }
  function Wt(s) {
    ...
    function p() {
      ...
      if (e.params.navigation = Se(e, e.originalParams.navigation, e.params.navigation, {
        ...
        return;
      let w = r(h.nextEl), b = r(h.prevEl);
      Object.assign(e.navigation, {
        nextEl: w,
        prevEl: b
      }), w = I(w), b = I(b);
      const d = (u, v) => {
        u && u.addEventListener("click", v === "next" ? c : o), !e.enabled && u && u.classList.add(...h.lockClass.split(" "));
      };
    ...
    function f() {
      ...
      h.forEach((d) => b(d, "next")), w.forEach((d) => b(d, "prev"));
    }
    i("init", () => {
      e.params.navigation.enabled === !1 ? m() : (p(), a());
      ...
      if (h = I(h), w = I(w), e.enabled) {
        a();
        return;
      }
      [...h, ...w].filter((b) => !!b).forEach((b) => b.classList.add(e.params.navigation.lockClass));
    }), i("click", (h, w) => {
      let {
        nextEl: b,
        prevEl: d
      ...
      if (e.params.navigation.hideOnClick && !d.includes(u) && !b.includes(u)) {
        if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === u || e.pagination.el.contains(u)))
          return;
        let v;
        b.length ? v = b[0].classList.contains(e.params.navigation.hiddenClass) : d.length && (v = d[0].classList.contains(e.params.navigation.hiddenClass)), n(v === !0 ? "navigationShow" : "navigationHide"), [...b, ...d].filter((x) => !!x).forEach((x) => x.classList.toggle(e.params.navigation.hiddenClass));
      }
    });
    const g = () => {
  ...
  function Xt(s) {
    ...
    function f() {
      ...
      if (e.params.loop ? (S = e.previousRealIndex || 0, x = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : typeof e.snapIndex < "u" ? (x = e.snapIndex, S = e.previousSnapIndex) : (S = e.previousIndex || 0, x = e.activeIndex || 0), u.type === "bullets" && e.pagination.bullets && e.pagination.bullets.length > 0) {
        ...
        if (u.dynamicBullets && (l = te(L[0], e.isHorizontal() ? "width" : "height", !0), v.forEach((C) => {
        ...
        }), u.dynamicMainBullets > 1 && S !== void 0 && (a += x - (S || 0), a > u.dynamicMainBullets - 1 ? a = u.dynamicMainBullets - 1 : a < 0 && (a = 0)), z = Math.max(x - a, 0), y = z + (Math.min(L.length, u.dynamicMainBullets) - 1), E = (y + z) / 2), L.forEach((C) => {
          ...
          L.forEach((C) => {
            const T = U(C);
            T === x ? C.classList.add(...u.bulletActiveClass.split(" ")) : e.isElement && C.setAttribute("part", "bullet"), u.dynamicBullets && (T >= z && T <= y && C.classList.add(...`${u.bulletActiveClass}-main`.split(" ")), T === z && c(C, "prev"), T === y && c(C, "next"));
          });
        else {
          const C = L[x];
          if (C && C.classList.add(...u.bulletActiveClass.split(" ")), e.isElement && L.forEach((T, P) => {
            ...
            const T = L[z], P = L[y];
            for (let k = z; k <= y; k += 1)
              L[k] && L[k].classList.add(...`${u.bulletActiveClass}-main`.split(" "));
            c(T, "prev"), c(P, "next");
          }
        }
        if (u.dynamicBullets) {
          ...
          L.forEach((k) => {
            k.style[e.isHorizontal() ? P : "top"] = `${T}px`;
          });
        }
      }
      v.forEach((L, z) => {
        if (u.type === "fraction" && (L.querySelectorAll(F(u.currentClass)).forEach((y) => {
          y.textContent = u.formatFractionCurrent(x + 1);
        }), L.querySelectorAll(F(u.totalClass)).forEach((y) => {
          y.textContent = u.formatFractionTotal(D);
        })), u.type === "progressbar") {
          let y;
          u.progressbarOpposite ? y = e.isHorizontal() ? "vertical" : "horizontal" : y = e.isHorizontal() ? "horizontal" : "vertical";
          const E = (x + 1) / D;
          let C = 1, T = 1;
          y === "horizontal" ? C = E : T = E, L.querySelectorAll(F(u.progressbarFillClass)).forEach((P) => {
            P.style.transform = `translate3d(0,0,0) scaleX(${C}) scaleY(${T})`, P.style.transitionDuration = `${e.params.speed}ms`;
          });
        }
        u.type === "custom" && u.renderCustom ? (L.innerHTML = u.renderCustom(e, x + 1, D), z === 0 && n("paginationRender", L)) : (z === 0 && n("paginationRender", L), n("paginationUpdate", L)), e.params.watchOverflow && e.enabled && L.classList[e.isLocked ? "add" : "remove"](u.lockClass);
      });
    }
    function g() {
      ...
      let x = "";
      if (d.type === "bullets") {
        let S = e.params.loop ? Math.ceil(u / e.params.slidesPerGroup) : e.snapGrid.length;
        e.params.freeMode && e.params.freeMode.enabled && S > u && (S = u);
        for (let M = 0; M < S; M += 1)
      ...
      d.type === "fraction" && (d.renderFraction ? x = d.renderFraction.call(e, d.currentClass, d.totalClass) : x = `<span class="${d.currentClass}"></span> / <span class="${d.totalClass}"></span>`), d.type === "progressbar" && (d.renderProgressbar ? x = d.renderProgressbar.call(e, d.progressbarFillClass) : x = `<span class="${d.progressbarFillClass}"></span>`), e.pagination.bullets = [], v.forEach((S) => {
        d.type !== "custom" && (S.innerHTML = x || ""), d.type === "bullets" && e.pagination.bullets.push(...S.querySelectorAll(F(d.bulletClass)));
    ...
    i("changeDirection", () => {
      ...
      e.params.pagination.enabled === !1 ? b() : (m(), g(), f());
    }), i("activeIndexChange", () => {
      ...
      d && (d = I(d), d.forEach((u) => u.classList[e.enabled ? "remove" : "add"](e.params.pagination.lockClass)));
    }), i("lock unlock", () => {
      f();
    }), i("click", (d, u) => {
      const v = u.target, x = I(e.pagination.el);
      if (e.params.pagination.el && e.params.pagination.hideOnClick && x && x.length > 0 && !v.classList.contains(e.params.pagination.bulletClass)) {
        ...
        n(S === !0 ? "paginationShow" : "paginationHide"), x.forEach((M) => M.classList.toggle(e.params.pagination.hiddenClass));
      }
    });
    const w = () => {
      ...
      d && (d = I(d), d.forEach((u) => u.classList.remove(e.params.pagination.paginationDisabledClass))), m(), g(), f();
    }, b = () => {
      e.el.classList.add(e.params.pagination.paginationDisabledClass);
      let {
        el: d
      } = e.pagination;
      d && (d = I(d), d.forEach((u) => u.classList.add(e.params.pagination.paginationDisabledClass))), h();
    };
  ...
  const Ce = async () => {
    ...
    try {
      if (N)
        return N;
      const i = await (await fetch("https://www.paintscratch.com/cgi-bin/shopping-cart.cgi")).text(), r = new DOMParser().parseFromString(i, "text/html"), l = r.querySelectorAll(".cart-row"), a = [];
      l && l.forEach((p, f) => {
        var b;
        const g = p.querySelector(".cart-pic img"), m = p.querySelector(".item-title a"), h = p.querySelector(".quantity .each-price"), w = {
          image: g.src || g.dataset.cfsrc,
          title: m.textContent,
          price: parseFloat(((b = h == null ? void 0 : h.textContent) == null ? void 0 : b.replace(/[$()@]/g, "")) || "0")
        };
        a.push(w);
      });
      const o = (e = (s = r.querySelector("#subtotals_and_shipping .right_side_text")) == null ? void 0 : s.textContent) == null ? void 0 : e.split("$")[1], c = parseFloat((o == null ? void 0 : o.replace(/[$()@]/g, "")) || "0");
    ...
    let l = new IntersectionObserver(
      ...
      o.forEach((c) => {
        c.isIntersecting ? (V(
          ...
          "view",
          i || c.target.id
        ), r && r(), l.unobserve(c.target)) : l.observe(c.target), a.unobserve(c.target);
      });
    });
  ...
  const de = (s) => document.querySelector(s), is = (s) => {
    let e = setInterval(function() {
      typeof window.clarity == "function" && (clearInterval(e), window.clarity("set", s, "variant_1"));
    }, 1e3);
  }, rs = function(s) {
    s = s || {};
    let e, t, i, n, r = s.delay || 50;
    function l() {
      e = null, n = 0;
    }
    return l(), function() {
      return t = window.scrollY, e != null && (n = t - e), e = t, clearTimeout(i), i = setTimeout(l, r), n;
    };
  }();
  function R(s) {
    let e = {};
  ...
  const ns = "https://conversionratestore.github.io/projects/paintscratch", Ee = "FIRSTORDER5";
  class os {
    constructor() {
      ...
      <dialog class="os-border-none os-p-0 os-w-[335px] md:os-w-[460px]" data-popup="${this.dataPopup}">
        <div class="os-p-y-[20px] md:os-p-y-[30px] os-pb-[20px] md:os-pb-[30px]">
          ...
          <div class="os-px-[20px] md:os-px-[30px]">
            <div class="os-flex os-justify-center"><img src="${ns}/img/kits-deluxe-spray.png" alt="kits deluxe spray" /></div>
          </div>
    ...
    `
      ...
      document.querySelector(e).insertAdjacentHTML(t, i), J(
        ...
        0
      ), this.popup = document.querySelector(`[data-popup="${this.dataPopup}"]`), this.popup.addEventListener("click", async (n) => {
        if (n.target.closest("[data-popup-close]") && (this.hide(), V(
          "exp_exitintent_button_02",
          "Close",
          "click",
          "Exit intent pop-up empty cart Don’t leave just yet! Get 5% Off Your Purchase Now!"
        )), n.target === this.popup && this.hide(), n.target.closest('[data-button="select-products"]')) {
          V(
          ...
          const r = R("makeSelected"), l = R("yearSelected"), a = decodeURIComponent(R("modelSelected")), o = R("ColorNameSelectedLast"), c = R("ColorRgbSelectedLast");
          if (this.hide(), r && l && a && o && c) {
            console.log({ makeSelected: r, yearSelected: l, modelSelected: a, colorNameSelectedLast: o, colorRgbSelectedLast: c });
            ...
            f.type = "hidden", f.name = "vehicle", f.value = `${l} ${r} ${a}`, p.appendChild(f);
            const g = document.createElement("input");
            g.type = "hidden", g.name = "make", g.value = r, p.appendChild(g);
            const m = document.createElement("input");
            m.type = "hidden", m.name = "model", m.value = a, p.appendChild(m);
            const h = document.createElement("input");
            h.type = "hidden", h.name = "year", h.value = l, p.appendChild(h);
  ...
  class as {
    ...
    `
      ...
      document.querySelector(e).insertAdjacentHTML(t, i), this.popup = document.querySelector(`[data-popup="${this.dataPopup}"]`), document.querySelector('[data-button="complete-order"]').addEventListener("click", () => {
        ...
        const r = new URL("https://www.paintscratch.com/cgi-bin/shopping-cart.cgi");
        r.searchParams.set("discount_code", Ee), document.cookie = `discount_code=${Ee};path=/`, setTimeout(() => {
          window.location.href = r.toString();
        }, 500);
      }), this.popup.addEventListener("click", (r) => {
        r.target.closest("[data-popup-close]") && (this.total >= 100 && V(
  ...
  class ds {
    constructor() {
      this.device = screen.width <= 768 ? j.mobile : j.desktop, this.cartPopup = new as(), this.offPurchasePopup = new os();
    }
    init() {
      this.initStyles(), this.cartPopup.render(), this.offPurchasePopup.render(), this.trigger(), this.mobilePromo();
    }
    initStyles() {
      const e = document.createElement("style");
      e.innerHTML = ls, document.head.appendChild(e);
    }
    mobilePromo() {
      location.href.includes("shopping-cart.cgi") && this.device === j.mobile && ss(".total_block").then(() => {
    ...
    trigger() {
      if (location.pathname === "/" || location.pathname === "/cgi-bin/select-color.cgi")
        return;
      const e = async () => {
        const n = await Ce();
      ...
      this.device === j.desktop && document.addEventListener("mouseout", async (n) => {
        (n.clientY <= 0 || n.clientX <= 0 || n.clientX >= window.innerWidth || n.clientY >= window.innerHeight) && e();
      }), this.device === j.mobile && document.addEventListener("scroll", async (n) => {
        const r = rs();
        (r > 70 || r < -70) && e();
