...
(function() {
  ...
  function at(s, e) {
    ...
    i.cssMode || (i.autoHeight && t.updateAutoHeight(), me({
      swiper: t,
      runCallbacks: s,
      direction: e,
      step: "Start"
  ...
  function lt(s, e) {
    ...
    t.animating = !1, !i.cssMode && (t.setTransition(0), me({
      swiper: t,
      runCallbacks: s,
      direction: e,
      step: "End"
  ...
  class $ {
    constructor() {
      ...
      const a = this;
      a.__swiper__ = !0, a.support = fe(), a.device = he({
