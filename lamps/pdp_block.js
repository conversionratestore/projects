let startFunkPdp = setInterval(() => {
  if (document.querySelector("#main-wrapper")) {
    ...
    <style>
        ...
        #cart-panel .var_ceiling_fan .mkt.i-block.text-center {
          display: none;
        }
        ...
        .inner-panel .content-panel .var_ceiling_fan.c-product .p-stock .in-stock {
          display: none;
        }
      ...
      .checkout-cart-index .wrapper .var_ceiling_fan.c-product .p-stock .in-stock{
        display: none;
      }
    ...
    if (document.querySelectorAll(".breadcrumbs ul li").length === 4 && document.querySelectorAll(".breadcrumbs ul li a")[2].textContent.toLocaleUpperCase() === "CEILING FANS") {
