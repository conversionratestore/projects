...
function startRemove() {
    let startRemove = setInterval(() => {
        if (document.querySelector('#parkingat') != null || document.querySelector('#easy-checkout') != null || document.querySelector('.search-switch') != null || (document.querySelector('#__next > section > main > div > div.bg-search-airport2 > div.container.mx-auto.flex.flex-col.relative > div > div:nth-child(2) > div:nth-child(1) > h2') != null && document.querySelector('#__next > section > main > div > div.bg-search-airport2 > div.container.mx-auto.flex.flex-col.relative > div > div:nth-child(2) > div:nth-child(1) > h2').innerText == 'Search parking deals') || document.querySelector('#__next > section > main > div > div.bg-white > div > button') == null || (document.querySelector('#__next > section > main > div > div.block.relative > div > h2') != null && (document.querySelector('#__next > section > main > div > div.block.relative > div > h2').innerText == 'AIRPORT') || document.querySelector('#__next > section > main > div > div.block.relative > div > h2').innerText == 'CITY')) { 
