...
let mut = new MutationObserver(function (muts) {
    ...
    if (document.querySelector('.js-style') != null && document.querySelector('.parent_block') != null && window.location.pathname != '/reservation/search' && document.querySelector('#detail-info') != null) {
        loadedContent = false;
