...
let mut = new MutationObserver(function (muts) {
    if (document.querySelector('main.ant-layout-content.site-layout') != null && document.querySelector('.list') == null && window.location.pathname.includes('reservation/search') && document.querySelector('#parkingat') == null && document.querySelector(".container.mx-auto > .container > div.flex.flex-row.items-center.mb-2.w-full > p").innerText == 'Search results') {
        mut.disconnect();
