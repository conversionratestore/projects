  ...
  const timeline = `
      <div class="crs_timeline">
          <div class="crs_timeline_container">
              ...
              <h3>You have 30 nights to test <br> <span class="underline">The Dual Pillow</span> </h3>
              <div class="flex justify-center ">
                  <div>
                      <p><b>Today</b> ${circleSvg}</p>
                      <p>${formatDate()}</p>
                  </div>
                  <p><b>Buy The Dual Pillow</b></p>
              </div>
              <div class="flex justify-center ">
                  <div>
        ...
        ${trustpilotIcon}
          ...
          <div class="crs_slider">
              ...
              <button type="button" class="crs_button-next crs_swiper-button">
                  <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
                      <path d="M27 5.5C15.1259 5.5 5.5 15.1258 5.5 27C5.5 38.8741 15.1259 48.4999 27 48.4999C38.8741 48.4999 48.5 38.8741 48.5 27C48.5 15.1258 38.8741 5.5 27 5.5Z" fill="#F4B184" stroke="white" stroke-width="11"/>
                      <path d="M21.001 27H33.0005" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M27 21.0002L32.9998 27L27 32.9998" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
              </button>
          </div>
      </div>
