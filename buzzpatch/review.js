let startFunkReview = setInterval(() => {
  if (document.querySelector("#mainContent")) {
    ...
    scriptCustom.src = "https://cdnjs.cloudflare.com/ajax/libs/zuck.js/1.2.0/zuck.min.js"
    scriptCustom.async = false
    document.head.appendChild(scriptCustom)

    let scriptCustomStyle = document.createElement("link")
    scriptCustomStyle.href = "https://cdnjs.cloudflare.com/ajax/libs/zuck.js/1.2.0/zuck.css"
    scriptCustomStyle.rel = "stylesheet"
    document.head.appendChild(scriptCustomStyle)

    let scriptSnapgramStyle = document.createElement("link")
    scriptSnapgramStyle.href = "https://cdnjs.cloudflare.com/ajax/libs/zuck.js/1.2.0/skins/snapgram.css"
