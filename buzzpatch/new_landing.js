...
.block_effective .compar-box:nth-child(2) .compar-link:not(:last-child) .span-after-svg{
border-right: 2px solid #E2E2E2;
width: 100%;
}
...
<div class="compar-block">
<h2 class="copar-title">Buzzpatch <br>vs other mosquito repellents</h2>
...
<div class="compar-box">
    <h3 class="compar-box-title">Apply to skin</h3>
...
<div class="compar-box">
    <h3 class="compar-box-title">Contains chemicals (like DEET or Picaridin)</h3>
    <ul class="compar-list">
        <li class="accent-color compar-link">
...
<div class="compar-box">
    <h3 class="compar-box-title">Unpleasant chemical smell</h3>
    <ul class="compar-list">
...
<div class="compar-box">
    <h3 class="compar-box-title">Causes allergies</h3>
    <ul class="compar-list">
...
<div class="compar-box">
    <h3 class="compar-box-title">Toxicity</h3>
    <ul class="compar-list">
...
<div class="compar-box">
    <h3 class="compar-box-title">Duration of effect</h3>
    <ul class="compar-list">
...
<div class="compar-box">
    <h3 class="compar-box-title">Sticky on skin</h3>
    <ul class="compar-list">
