(function() {
  ...
  const g = (e, n, t, p = "") => {
    window.dataLayer = window.dataLayer || [], window.dataLayer.push({
      ...
      event_type: t,
      event_loc: p
    }), console.log(`Event: ${e} | ${n} | ${t} | ${p}`);
  }, u = ({ name: e, dev: n }) => {
    console.log(
      `%c EXP: ${e} (DEV: ${n})`,
      "background: #3498eb; color: #fccf3a; font-size: 20px; font-weight: bold;"
    );
  }, f = (e) => document.querySelectorAll(e), o = (e) => document.querySelector(e), h = (e) => {
  ...
  (function(e) {
    e = e === void 0 ? {} : e;
    let n, t, p, i, a = (e == null ? void 0 : e.delay) || 50;
    function r() {
      n = null, i = 0;
    }
    return r(), function() {
      return t = window.scrollY, n != null && (i = t - n), n = t, clearTimeout(p), p = setTimeout(r, a), i;
    };
  })();
  function w(e) {
  ...
  }, l = "https://conversionratestore.github.io/projects/buzzpatch/img/", d = {
    giftIcon: (
      /* HTML */
      `
  ...
  `
    ...
    <div class="new_popup_body">
      <div class="img_wrapper">
        <img src="${l}free_gift_img.png" alt="free gift img" />
        <p>LIMITED COLLECTION</p>
      </div>
      <div class="info_wrapper">
        <p><span class="sticker_price">${e}</span><span>FREE</span></p>
        <p>16 STICKERS</p>
        <p>added to your order</p>
      </div>
    </div>
    <div class="new_popup_footer">
      <div class="new_checkout_btn">Checkout ${d.arrowWhiteIcon}</div>
    </div>
  `
  ), b = (
    /* HTML */
  ...
  <div class="new_popup_body">
    <div class="img_wrapper">
      <img src="${l}free_gift_img_c.png" alt="free gift img" />
    </div>
    <div class="info_wrapper">
...
`
    ...
    <div class="new_popup_backdrop is_hidden">
      <div class="new_popup">
        <div class="new_popup_content version_b">${m(e)}</div>
        <!-- <div class="new_popup_content version_c">${b}</div> -->
      </div>
    </div>
  `
  ), v = `#getNow {
...
.version_c .new_popup_footer .new_no_thanks_btn {
  ...
  class C {
    ...
    init() {
      u({ name: "Gift hypothesis (second iteration) v.B", dev: "SKh" }), h("exp_introduce_b"), localStorage.getItem("clickCheckoutBtn") === "yes" && localStorage.removeItem("clickCheckoutBtn"), localStorage.getItem("setTimeout3000") === "yes" && localStorage.removeItem("setTimeout3000"), document.head.insertAdjacentHTML(
        "beforeend",
        '<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&display=swap" rel="stylesheet">'
      ), document.head.insertAdjacentHTML("beforeend", `<style>${v}</style>`), this.createPopup(), this.rendergGiftElements(), this.clickProceedToCheckoutBtnHandler(), this.clickNewCheckoutBtnHandler(), this.handleClickGetNow();
    }
    rendergGiftElements() {
      f("#getNow input[type=radio] + label").forEach((n) => {
        n.getAttribute("for") !== "radios-3" && n.insertAdjacentHTML("afterbegin", d.giftIcon);
    ...
    triggerPopupOpenVerB(n) {
      this.handleShowPopup(), setTimeout(() => {
        localStorage.getItem("clickCheckoutBtn") !== "yes" && (this.addToCartGiftHandler(n), localStorage.setItem("setTimeout3000", "yes"));
      }, 3e3);
    }
    createPopup() {
      var t;
      const n = (t = o(".free-natpat-products .np-decals")) == null ? void 0 : t.getAttribute("data-price-compare");
      o(".new_popup_backdrop") || o("body").insertAdjacentHTML("afterbegin", x(n || "$9.99")), c(".new_popup_backdrop").then((p) => {
        this.handleClosePopup();
      });
    }
    handleShowPopup() {
      var i;
      const n = o("body"), t = o(".new_popup_backdrop"), p = o("html");
      t.classList.contains("is_hidden") && t.classList.remove("is_hidden"), n.style.overflow = "hidden", p.style.overflow = "hidden", (i = o(".progress_bar")) == null || i.classList.add("progress_bar_fill"), g("exp_introduce_v2_element_01", "Popover", "Visibility", "Congratulations! You get a FREE GIFT!");
    }
    handleClosePopup() {
      const n = o("body"), t = o(".new_popup_backdrop"), p = o(".new_popup"), i = p.querySelectorAll('[data-popup="close"]'), a = o("html");
      i.forEach((r) => {
        r.addEventListener("click", (s) => {
          s.currentTarget && (t.classList.add("is_hidden"), n.style.overflow = "initial", a.style.overflow = "initial");
        });
      });
    }
    clickProceedToCheckoutBtnHandler() {
      ...
      (n = o("#addToCart")) == null || n.addEventListener("click", (t) => {
        ...
        p === "39542857695276" ? this.addToCartGiftHandler(p, !1) : this.triggerPopupOpenVerB(p);
      });
    }
    clickNewCheckoutBtnHandler() {
      c(".new_checkout_btn").then((n) => {
        var t;
        (t = o(".new_checkout_btn")) == null || t.addEventListener("click", (p) => {
          var r;
          if (p.preventDefault(), g("exp_introduce_v2_button_02", "Checkout", "Button", "Congratulations! You get a FREE GIFT!"), localStorage.setItem("clickCheckoutBtn", "yes"), localStorage.getItem("setTimeout3000") === "yes")
            return;
          let i = (r = o(".js-packs input[type=radio]:checked+label")) == null ? void 0 : r.previousElementSibling.value;
          i === "39542857695276" ? this.addToCartGiftHandler(i, !1) : this.addToCartGiftHandler(i);
        });
      });
    }
    async addToCartGiftHandler(n, t = !0, p = !1, i) {
      var s;
      ...
      }), p && ((s = o(".new_popup_backdrop")) == null || s.classList.add("is_hidden"), o("body").style.overflow = "initial", o("html").style.overflow = "initial"), window.location.href = "/checkout";
    }
    handleClickGetNow() {
      c("#getNow").then((n) => {
        f('[href="#getFormNow"]').forEach((t) => {
          t.addEventListener("click", (p) => {
            p.preventDefault(), p.stopPropagation(), $("html, body").stop();
            let i = o("#getNow"), a = 65, r = !0, s = setInterval(async () => {
              i.getBoundingClientRect().top > a - 1 && i.getBoundingClientRect().top <= a + 1 ? clearInterval(s) : r && (r = !1, r = await _(a, i));
            }, 100);
          });
        });
      });
