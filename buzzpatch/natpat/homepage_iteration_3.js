(function() {
  ...
  (function(e) {
    e = e === void 0 ? {} : e;
    let n, s, A, t, i = (e == null ? void 0 : e.delay) || 50;
    function r() {
      n = null, t = 0;
    }
    return r(), function() {
      return s = window.scrollY, n != null && (t = s - n), n = s, clearTimeout(A), A = setTimeout(r, i), t;
    };
  })();
  const B = (e) => {
    ...
    if (!n)
      return;
    const A = n.getBoundingClientRect().top - 100;
    window.scrollBy({
      top: A,
      behavior: "smooth"
    });
  ...
  `
    ...
    let e = [];
    return $("#featured-reviews2 .carousel-item:not(.slick-cloned)").each((s, A) => {
      let t = {};
...
body {
  ...
  class N {
    ...
    async addBlocks() {
      ...
      if ($(".new_reviews_block .basic_slider").append(n), h(".slider_dots-2.slick-initialized").then((A) => {
        ...
        const A = $(".new_natpat_block .parallax"), t = A[0].getBoundingClientRect(), i = window.scrollY || document.documentElement.scrollTop, r = t.top + i;
        i + window.innerHeight > r && A.css("transform", `translateY(${(i - r) * 0.3}px)`);
        ...
        t.each(function(i, r) {
          i >= 6 && $(r).css("display", "none");
        }), $(".pages_r span").on("click", function() {
          if ($(this).hasClass("active"))
            return;
          const i = +$(this).text(), r = (i - 1) * 6, c = i * 6 - 1, d = $(".new_trustpilot_reviews .reviews_trust");
          d.fadeOut(function() {
            t.each(function(w, f) {
    ...
    addEvents() {
      ...
      $(".new_main_block .crs_btn").on("click", function(t) {
      ...
      }), $(".shop_by_category_block li").each(function(t, i) {
        $(i).on("click", function(r) {
          a(`exp_hp_3_shop_by_category_${t + 1}`, $(this).find("p").text().trim(), "Button", "Shop by category");
        });
      }), $(".new_main_block .big-stickers .shop_now_link").each(function(t, i) {
        $(i).on("click", function(r) {
          a(
        ...
        console.log($(".new_stickers_slider .item:not(.slick-cloned)")), $(".new_stickers_slider .item:not(.slick-cloned)").each(function(i, r) {
          ...
          a(`${n}stick_slider_qty_${i}`, `Quantity ${$(this).text()}`, "Click", `Stickers slider ${i}`);
        }), $(".new_stickers_slider").on("click", ".footer-btns .learn-more", function(i) {
          const r = $(this).closest(".item").find("h3").text().trim();
          a(`exp_hp_3_stick_slider_learn_${r}`, "Learn more", "Click", "Stickers slider");
      ...
      let s = !1;
      $(".new_slider_news").on("afterChange", function(t, i, r, c) {
        s || (s = !0, a("exp_hp_3_slider_news", "Choose", "Change", "Slider news"), setTimeout(() => {
          s = !1;
        }, 500));
      ...
      const A = setInterval(() => {
        var t, i;
        $(".insta_widget [data-widget-host]")[0].shadowRoot && ((t = $(".insta_widget [data-widget-host]")[0].shadowRoot) != null && t.querySelectorAll("img").length) && (clearInterval(A), (i = $(".insta_widget [data-widget-host]")[0].shadowRoot) == null || i.querySelectorAll("img").forEach((r, c) => {
    ...
    fixes() {
      ...
      setTimeout(() => {
        ...
        const A = window.location.pathname === "/" ? s.getAttribute("href") : window.location.pathname + s.getAttribute("href");
