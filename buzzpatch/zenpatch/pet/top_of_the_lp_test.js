...
.new_get_zen_stickers_now {
  ...
  class _ {
    ...
    init() {
      ...
      ), document.head.insertAdjacentHTML("beforeend", `<style>${x}</style>`), this.renderMainBenefitsBlock(), window.innerWidth >= 768 ? (console.log(this.device, window.innerWidth), this.renderLearnMoreBtnOnDesktop(), this.scrollToFAQ(".new_learn_more_btn")) : (console.log(this.device, window.innerWidth), this.changeIconLearnMore(), this.scrollToFAQ(".lp-tr--hero-section .lp-tr--learn-more-btn"), (n = r(".new_learn_more_btn")) == null || n.remove()), this.replaceFAQBlock(), this.addEventsAccordion(), this.renderBtnGetZenToAccordionBody(), this.scrollToFromNewGetZenStickersNowBtns(".new_get_zen_stickers_now");
    }
