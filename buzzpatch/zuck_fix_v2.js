  ...
  var ZuckJS = (function () {
    ...
    var ZuckJS = function ZuckJS(timeline, options) {
      ...
      var ZuckModal = function ZuckModal() {
          ...
          setTimeout(function () {
            if (target !== "" && slideItems[target] && useless !== "") {
              ...
              if (items) {
                ...
                items[0].innerHTML = '<b style="'.concat(
        ...
        var createStoryViewer = function createStoryViewer(
          ...
          each(get(storyData, "items"), function (i, item) {
            ...
            var commonAttrs = 'data-index="'
              .concat(i, '" data-item-id="')
              .concat(itemId, '"');
          ...
          var html = '<div class="head"><div class="left">'
            ...
            .concat(
              currentItemTime,
              '</span><span class="loading"></span><a class="close" tabIndex="2">&#128936</a></div></div><div class="slides-pointers"><div>'
            )
            .concat(pointerItems, "</div></div>");
          storyViewer.innerHTML = html;
          each(storyViewer.querySelectorAll(".close"), function (i, el) {
        ...
        return {
          show: function show(storyId, page) {
            ...
            var callback = function callback() {
              ...
              if (option("openEffect")) {
                var storyEl = query(
                  "#".concat(id, ' [data-id="').concat(storyId, '"] .img')
                );
      ...
      var updateStoryseenPosition = function updateStoryseenPosition() {
        each(
          d.querySelectorAll("#".concat(id, " .story.seen")),
          function (i, el) {
      ...
      zuck.navigateItem = zuck.nextItem = function (direction, event) {
        ...
        var storyViewer = query(
          '#zuck-modal .story-viewer[data-story-id="'.concat(currentStory, '"]')
        );
