(function() {
  ...
  `
    ...
    /* HTML */
    `
    <div class="new_bundle_wrapper" id="${a.ver_c.id}">
      <div class="img_wrapper">
        <img src="${a.ver_c.img}" alt="${a.ver_c.title}" />
      </div>
      <div class="info_wrapper">
        <h2 class="new_bundle_title">${a.ver_c.title}</h2>
        <p class="new_bundle_description">${a.ver_c.description}</p>
  ...
  `
    ...
    /* HTML */
    `
  <span class="new_bundle_tooltip" data-tooltip data-title="${v.ver_c}">${s.tooltipIcon}</span>
`
...
body.tooltip_open .new_bundle_tooltip svg path {
  ...
  class N {
    ...
    init() {
      m({ name: "bundle optimization v.B", dev: "SKh" }), _("exp_introduce_c"), document.head.insertAdjacentHTML(
        "beforeend",
