(function() {
  ...
  }, Se = (n) => document.querySelector(n), Ze = (n) => {
  ...
  const _e = "cartPopupShown", Ae = "promoPopupShown", Te = "giftPopupShown", j = "userWatchedPopup", X = "CRS_DISCOUNT", ke = "KEY0624", Ce = "savedGift", Je = "https://conversionratestore.github.io/projects/msb/", et = (
    /* HTML */
    `<svg
  ...
  class Ee {
    ...
    render() {
      ...
      <div class="crs-promocode__code">
        ...
        <button type="button" class="crs-promocode__copy-btn" data-action="copy-promo">${et}</button>
      </div>
    </div>`
      );
      if (this.container) {
        if (this.container.querySelector(".crs-promocode"))
          return;
        document.head.insertAdjacentHTML("beforeend", `<style>${nt}</style>`), this.container.insertAdjacentHTML("beforeend", e);
    ...
    copyPromo(e) {
      ...
      t.innerHTML = `${tt}`, navigator.clipboard.writeText(this.promocode), i.classList.add("copied"), localStorage.setItem(X, this.promocode);
    }
  }
  var I = /* @__PURE__ */ ((n) => (n.AU = "au", n.US = "us", n.CA = "ca", n.UK = "uk", n.IE = "ie", n.NZ = "nz", n))(I || {}), V = /* @__PURE__ */ ((n) => (n.Mobile = "Mobile", n.Desktop = "Desktop", n))(V || {}), Q = /* @__PURE__ */ ((n) => (n.WELCOME10 = "WELCOME10", n.WELCOME15 = "WELCOME15", n))(Q || {});
  const Z = [
    {
      id: 538,
      name: "The Mimi",
    ...
    ie: "€",
    nz: "$"
  }, R = [I.UK, I.IE, I.NZ, I.US], st = `.popup-hidden {
...
`, ot = 'input[aria-label="First Name*"]', rt = 50, K = '.needsclick[role="dialog"]', B = 'div[role="dialog"] .klaviyo-close-form', J = ".crs-promo-form", at = ".crs-promo-form__enhance", lt = ".crs-promo-form__continue", ce = 'form[data-testid^="klaviyo-form"]:has([id^="first_name"])', pe = (n) => ({
    closeBtn: (e) => {
      n();
    },
  ...
  class Ie {
    ...
    changeTextOnFirstStep() {
      ...
      e.querySelectorAll('div[id^="rich-text"]').forEach((r) => {
        ...
        `Get 10% off <br class="os-desktop" />
          ...
          c && (document.querySelector(".os-title-check") || c.insertAdjacentHTML(
            "afterend",
            /* HTML */
            `<div
              data-testid="form-row"
              class="needsclick  kl-private-reset-css-Xuajs1 os-title-check"
    ...
    handleEnhanceForm(e, t, i) {
      ...
      document.querySelector(".crs-promo-form") || s.insertAdjacentHTML("afterbegin", o);
    ...
    `
      ...
      if (!i)
        return;
      document.querySelector(".crs-promo-form__close") || i.insertAdjacentHTML("afterend", t), document.querySelector(".crs-promo-form__close").addEventListener("click", (l) => {
        var p, u, f;
        l.preventDefault();
    ...
    addEnhanceButtonListener(e, t, i) {
      var o;
      (o = document.querySelector(at)) == null || o.addEventListener("click", () => {
        var r;
...
>
  <g>
    <g transform="rotate(0 50 50)">
      <rect fill="#939091" height="25" width="6" ry="2.5" rx="2.5" y="7.5" x="47">
        <animate
          repeatCount="indefinite"
          begin="-0.45605306799336653s"
          dur="0.49751243781094534s"
          keyTimes="0;1"
          values="1;0"
...
.os-loader .os-spinner {
  width: 100px;
}

.os-loader .os-spinner svg {
  width: 100%;
  height: 100%;
} `;
  class Me {
    ...
    render() {
      const e = (
        /* HTML */
        `<dialog id="loader-popup" class="os-dialog os-loader">
      <div class="os-wrap">
      ...
      document.head.insertAdjacentHTML("beforeend", `<style>${dt}</style>`), document.body.insertAdjacentHTML("beforeend", e), this.popup = document.getElementById("loader-popup");
    }
    show() {
  ...
  class ut {
    constructor({ country: e, device: t }) {
      this.country = e, this.device = t, this.baseUrl = this.country === I.US ? "https://us.maxwellscottbags.com/" : this.country === I.AU ? "https://au.maxwellscottbags.com/" : this.country === I.IE ? "https://ie.maxwellscottbags.com/" : this.country === I.CA ? "https://ca.maxwellscottbags.com/" : this.country === I.NZ ? "https://nz.maxwellscottbags.com/" : "https://www.maxwellscottbags.com/", this.loader = new Me(), this.init();
    }
    init() {
  ...
  function de(n, e) {
    n === void 0 && (n = {}), e === void 0 && (e = {}), Object.keys(e).forEach((t) => {
      typeof n[t] > "u" ? n[t] = e[t] : Oe(e[t]) && Oe(n[t]) && Object.keys(e[t]).length > 0 && de(n[t], e[t]);
    });
  }
  const Be = {
    body: {},
  ...
  function ze(n) {
    ...
    const c = t > s ? "next" : "prev", p = (f, h) => c === "next" && f >= h || c === "prev" && f <= h, u = () => {
      l = (/* @__PURE__ */ new Date()).getTime(), r === null && (r = l);
      const f = Math.max(Math.min((l - r) / a, 1), 0), h = 0.5 - Math.cos(f * Math.PI) / 2;
      let g = s + h * (t - s);
  ...
  function se(n, e) {
    ...
    return t.classList.add(...Array.isArray(e) ? e : mt(e)), t;
  }
  function bt(n, e) {
    const t = [];
  ...
  function St(n) {
    ...
    const t = De(), i = z(), o = i.navigator.platform, s = e || i.navigator.userAgent, r = {
      ios: !1,
      android: !1
    }, l = i.screen.width, a = i.screen.height, c = s.match(/(Android);?[\s\/]+([\d.]+)?/);
    let p = s.match(/(iPad).*OS\s([\d_]+)/);
    const u = s.match(/(iPod)(.*OS\s([\d_]+))?/), f = !p && s.match(/(iPhone\sOS|iOS)\s([\d_]+)/), h = o === "Win32";
    let g = o === "MacIntel";
  ...
  function $e(n) {
    return n === void 0 && (n = {}), he || (he = St(n)), he;
  }
  let ge;
  function _t() {
    const n = z(), e = $e();
      ...
      !e || e.destroyed || !e.initialized || (s = new ResizeObserver((u) => {
        r = o.requestAnimationFrame(() => {
          ...
          u.forEach((x) => {
            ...
            w && w !== e.el || (g = m ? m.width : (d[0] || d).inlineSize, v = m ? m.height : (d[0] || d).blockSize);
          }), (g !== f || v !== h) && l();
        });
      }), s.observe(e.el));
    }, c = () => {
  ...
  function kt(n) {
    ...
    const s = [], r = z(), l = function(p, u) {
      u === void 0 && (u = {});
      const f = r.MutationObserver || r.WebkitMutationObserver, h = new f((g) => {
  ...
  function Pt() {
    ...
    const t = n.params, {
      ...
      rtlTranslate: r,
      wrongRTL: l
    } = n, a = n.virtual && t.virtual.enabled, c = a ? n.virtual.slides.length : n.slides.length, p = N(o, `.${n.params.slideClass}, swiper-slide`), u = a ? n.virtual.slides.length : p.length;
    let f = [];
    const h = [], g = [];
      ...
      if (p[S] && (T = p[S]), $ && n.grid.updateSlide(S, T, p), !(p[S] && q(T, "display") === "none")) {
        if (t.slidesPerView === "auto") {
          ...
          if (_ && (T.style.transform = "none"), C && (T.style.webkitTransform = "none"), t.roundLengths)
            ...
            const L = e(A, "width"), H = e(A, "padding-left"), Qn = e(A, "padding-right"), We = e(A, "margin-left"), Ue = e(A, "margin-right"), Xe = A.getPropertyValue("box-sizing");
            if (Xe && Xe === "border-box")
              k = L + We + Ue;
            else {
              const {
        ...
        p[S] && (p[S].swiperSlideSize = k), g.push(k), t.centeredSlides ? (b = b + k / 2 + y / 2 + w, y === 0 && S !== 0 && (b = b - s / 2 - w), S === 0 && (b = b - s / 2 - w), Math.abs(b) < 1 / 1e3 && (b = 0), t.roundLengths && (b = Math.floor(b)), E % t.slidesPerGroup === 0 && f.push(b), h.push(b)) : (t.roundLengths && (b = Math.floor(b)), (E - Math.min(n.params.slidesPerGroupSkip, E)) % n.params.slidesPerGroup === 0 && f.push(b), h.push(b), b = b + k + w), n.virtualSize += k + w, y = k, E += 1;
      }
    }
    if (n.virtualSize = Math.max(n.virtualSize, s) + x, r && l && (t.effect === "slide" || t.effect === "coverflow") && (i.style.width = `${n.virtualSize + w}px`), t.setWrapperSize && (i.style[n.getDirectionLabel("width")] = `${n.virtualSize + w}px`), $ && n.grid.updateWrapperSize(k, f), !t.centeredSlides) {
      const S = [];
    ...
    if (a && t.loop) {
      ...
      for (let T = 0; T < n.virtual.slidesBefore + n.virtual.slidesAfter; T += 1)
        t.slidesPerGroup === 1 && f.push(f[f.length - 1] + S), h.push(h[h.length - 1] + S), n.virtualSize += S;
    }
    ...
    if (Object.assign(n, {
      ...
      ne(i, "--swiper-centered-offset-before", `${-f[0]}px`), ne(i, "--swiper-centered-offset-after", `${n.size / 2 - g[g.length - 1] / 2}px`);
      const S = -n.snapGrid[0], T = -n.slidesGrid[0];
      n.snapGrid = n.snapGrid.map((A) => A + S), n.slidesGrid = n.slidesGrid.map((A) => A + T);
    }
    if (u !== c && n.emit("slidesLengthChange"), f.length !== d && (n.params.watchOverflow && n.checkOverflow(), n.emit("snapGridLengthChange")), h.length !== m && n.emit("slidesGridLengthChange"), t.watchSlidesProgress && n.updateSlidesOffset(), n.emit("slidesUpdated"), !a && !t.cssMode && (t.effect === "slide" || t.effect === "fade")) {
  ...
  function Mt(n) {
    ...
    for (let a = 0; a < i.length; a += 1) {
      ...
      const u = (r + (t.centeredSlides ? e.minTranslate() : 0) - p) / (c.swiperSlideSize + l), f = (r - s[0] + (t.centeredSlides ? e.minTranslate() : 0) - p) / (c.swiperSlideSize + l), h = -(r - p), g = h + e.slidesSizesGrid[a], v = h >= 0 && h <= e.size - e.slidesSizesGrid[a], x = h >= 0 && h < e.size - 1 || g > 1 && g <= e.size || h <= 0 && g >= e.size;
      x && (e.visibleSlides.push(c), e.visibleSlidesIndexes.push(a)), Ne(c, x, t.slideVisibleClass), Ne(c, v, t.slideFullyVisibleClass), c.progress = o ? -u : u, c.originalProgress = o ? -f : f;
    }
  }
  function Ot(n) {
    const e = this;
    ...
    if (t.loop) {
      const p = e.getSlideIndexByData(0), u = e.getSlideIndexByData(e.slides.length - 1), f = e.slidesGrid[p], h = e.slidesGrid[u], g = e.slidesGrid[e.slidesGrid.length - 1], v = Math.abs(n);
  ...
  function Bt() {
    const n = this, {
      ...
      slidesEl: i,
      activeIndex: o
    } = n, s = n.virtual && t.virtual.enabled, r = n.grid && t.grid && t.grid.rows > 1, l = (u) => N(i, `.${t.slideClass}${u}, swiper-slide${u}`)[0];
    let a, c, p;
    if (s)
      if (t.loop) {
    ...
    a && (r || (p = xt(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !p && (p = e[0]), c = bt(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !c === 0 && (c = e[e.length - 1]))), e.forEach((u) => {
  ...
  function Gt(n) {
    ...
    if (typeof a > "u" && (a = zt(e)), i.indexOf(t) >= 0)
      c = i.indexOf(t);
    else {
    ...
    if (e.virtual && o.virtual.enabled && o.loop)
      ...
      Number.isNaN(g) && (g = Math.max(e.slides.indexOf(h), 0)), f = Math.floor(g / o.grid.rows);
    } else if (e.slides[a]) {
  ...
  function Yt(n, e) {
    ...
    i.cssMode || (i.autoHeight && t.updateAutoHeight(), qe({
      swiper: t,
      runCallbacks: n,
      direction: e,
      step: "Start"
  ...
  function Wt(n, e) {
    ...
    t.animating = !1, !i.cssMode && (t.setTransition(0), qe({
      swiper: t,
      runCallbacks: n,
      direction: e,
      step: "End"
  ...
  function Xt(n, e, t, i, o) {
    ...
    if (!g && !i && !o || s.destroyed || s.animating && l.preventInteractionOnTransition)
      return !1;
    typeof e > "u" && (e = s.params.speed);
    const v = Math.min(s.params.slidesPerGroupSkip, r);
    let x = v + Math.floor((r - v) / s.params.slidesPerGroup);
    x >= a.length && (x = a.length - 1);
    const d = -a[x];
    if (l.normalizeSlideIndex)
      for (let w = 0; w < c.length; w += 1) {
        const b = -Math.floor(d * 100), y = Math.floor(c[w] * 100), E = Math.floor(c[w + 1] * 100);
  ...
  function Qt(n, e, t, i) {
    ...
    if (o.params.loop)
      if (o.virtual && o.params.virtual.enabled)
        ...
        if (s) {
          const f = r * o.params.grid.rows;
          r = o.slides.filter((h) => h.getAttribute("data-swiper-slide-index") * 1 === f)[0].column;
        } else
  ...
  function Kt(n, e, t) {
    ...
    const h = f(u), g = s.map((d) => f(d));
    let v = s[g.indexOf(h) - 1];
    ...
    let x = 0;
    if (typeof v < "u" && (x = r.indexOf(v), x < 0 && (x = i.activeIndex - 1), o.slidesPerView === "auto" && o.slidesPerGroup === 1 && o.slidesPerGroupAuto && (x = x - i.slidesPerViewDynamic("previous", !0) + 1, x = Math.max(x, 0))), o.rewind && i.isBeginning) {
  ...
  function tn() {
    ...
    if (e.loop) {
      if (n.animating)
        return;
      s = parseInt(n.clickedSlide.getAttribute("data-swiper-slide-index"), 10), e.centeredSlides ? o < n.loopedSlides - i / 2 || o > n.slides.length - n.loopedSlides + i / 2 ? (n.loopFix(), o = n.getSlideIndex(N(t, `${r}[data-swiper-slide-index="${s}"]`)[0]), ue(() => {
        n.slideTo(o);
      })) : n.slideTo(o) : o > n.slides.length - i ? (n.loopFix(), o = n.getSlideIndex(N(t, `${r}[data-swiper-slide-index="${s}"]`)[0]), ue(() => {
        n.slideTo(o);
      })) : n.slideTo(o);
    } else
      n.slideTo(o);
  ...
  function sn(n) {
    ...
    if (!t.loop || e.virtual && e.params.virtual.enabled)
      return;
    const o = () => {
      N(i, `.${t.slideClass}, swiper-slide`).forEach((u, f) => {
  ...
  function on(n) {
    ...
    const m = a.grid && h.grid && h.grid.rows > 1;
    c.length < v + d ? ie("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : m && h.grid.fill === "row" && ie("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
    const w = [], b = [];
    let y = a.activeIndex;
    typeof s > "u" ? s = a.getSlideIndex(c.filter((_) => _.classList.contains(h.slideActiveClass))[0]) : y = s;
    const E = i === "next" || !i, $ = i === "prev" || !i;
    let k = 0, O = 0;
    const S = m ? Math.ceil(c.length / h.grid.rows) : c.length, A = (m ? c[s].column : s) + (g && typeof o > "u" ? -v / 2 + 0.5 : 0);
    if (A < d) {
      k = Math.max(d - A, x);
    ...
    }), a.recalcSlides(), h.slidesPerView === "auto" ? a.updateSlides() : m && (w.length > 0 && $ || b.length > 0 && E) && a.slides.forEach((_, C) => {
  ...
  function un(n) {
    ...
    if (s.noSwiping && (f ? dn(u, a) : a.closest(u))) {
      e.allowClick = !0;
      return;
    }
    ...
    const h = r.currentX, g = r.currentY;
    if (!He(e, i, h))
      return;
    Object.assign(o, {
      isTouched: !0,
      ...
      isScrolling: void 0,
      startMoving: void 0
    }), r.startX = h, r.startY = g, o.touchStartTime = ee(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, s.threshold > 0 && (o.allowThresholdMove = !1);
    let v = !0;
    ...
    (s.touchStartForcePreventDefault || x) && !a.isContentEditable && i.preventDefault(), s.freeMode && s.freeMode.enabled && e.freeMode && e.animating && !s.cssMode && e.freeMode.onTouchStart(), e.emit("touchStart", i);
  }
  function fn(n) {
    ...
    if (typeof i.isScrolling > "u") {
      let E;
      t.isHorizontal() && s.currentY === s.startY || t.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : f * f + h * h >= 25 && (E = Math.atan2(Math.abs(h), Math.abs(f)) * 180 / Math.PI, i.isScrolling = t.isHorizontal() ? E > o.touchAngle : 90 - E > o.touchAngle);
    }
    ...
    let g = t.isHorizontal() ? f : h, v = t.isHorizontal() ? s.currentX - s.previousX : s.currentY - s.previousY;
    o.oneWayMovement && (g = Math.abs(g) * (r ? 1 : -1), v = Math.abs(v) * (r ? 1 : -1)), s.diff = g, g *= o.touchRatio, r && (g = -g, v = -v);
    ...
    let w;
    if ((/* @__PURE__ */ new Date()).getTime(), i.isMoved && i.allowThresholdMove && x !== t.touchesDirection && d && m && Math.abs(g) >= 1) {
      Object.assign(s, {
        startX: p,
        startY: u,
        currentX: p,
    ...
    t.emit("sliderMove", a), i.isMoved = !0, i.currentTranslate = g + i.startTranslate;
    let b = !0, y = o.resistanceRatio;
    if (o.touchReleaseOnEdges && (y = 0), g > 0 ? (d && m && !w && i.allowThresholdMove && i.currentTranslate > (o.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] : t.minTranslate()) && t.loopFix({
      direction: "prev",
      setTranslate: !0,
      activeSlideIndex: 0
    }), i.currentTranslate > t.minTranslate() && (b = !1, o.resistance && (i.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + i.startTranslate + g) ** y))) : g < 0 && (d && m && !w && i.allowThresholdMove && i.currentTranslate < (o.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] : t.maxTranslate()) && t.loopFix({
      direction: "next",
      setTranslate: !0,
      activeSlideIndex: t.slides.length - (o.slidesPerView === "auto" ? t.slidesPerViewDynamic() : Math.ceil(parseFloat(o.slidesPerView, 10)))
    }), i.currentTranslate < t.maxTranslate() && (b = !1, o.resistance && (i.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - i.startTranslate - g) ** y))), b && (a.preventedByNestedSwiper = !0), !t.allowSlideNext && t.swipeDirection === "next" && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !t.allowSlidePrev && t.swipeDirection === "prev" && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), !t.allowSlidePrev && !t.allowSlideNext && (i.currentTranslate = i.startTranslate), o.threshold > 0)
  ...
  function mn(n) {
    ...
    if (i.type === "touchend" || i.type === "touchcancel") {
      if (o = [...i.changedTouches].filter((y) => y.identifier === t.touchId)[0], !o || o.identifier !== t.touchId)
        return;
    } else {
    ...
    for (let y = 0; y < c.length; y += y < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
      ...
      typeof c[y + E] < "u" ? (g || h >= c[y] && h < c[y + E]) && (v = y, x = c[y + E] - c[y]) : (g || h >= c[y]) && (v = y, x = c[c.length - 1] - c[c.length - 2]);
    }
    let d = null, m = null;
    r.rewind && (e.isBeginning ? m = r.virtual && r.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (d = 0));
    const w = (h - c[v]) / x, b = v < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
    if (f > r.longSwipesMs) {
      if (!r.longSwipes) {
  ...
  const je = (n, e) => {
    ...
    !o || typeof o == "string" || (t[a]("touchstart", n.onDocumentTouchStart, {
      ...
      passive: !0
    }), (i.preventClicks || i.preventClicksPropagation) && o[a]("click", n.onClick, !0), i.cssMode && s[a]("scroll", n.onScroll), i.updateOnWindowResize ? n[c](r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Fe, !0) : n[c]("observerUpdate", Fe, !0), o[a]("load", n.onLoad, {
      capture: !0
    }));
  };
  function bn() {
    ...
    n.onTouchStart = un.bind(n), n.onTouchMove = fn.bind(n), n.onTouchEnd = mn.bind(n), n.onDocumentTouchStart = vn.bind(n), e.cssMode && (n.onScroll = gn.bind(n)), n.onClick = hn.bind(n), n.onLoad = wn.bind(n), je(n, "on");
  }
  function xn() {
    je(this, "off");
  }
  ...
  const Ve = (n, e) => n.grid && e.grid && e.grid.rows > 1;
  function Sn() {
    const n = this, {
      realIndex: e,
      initialized: t,
    ...
    if (!r || n.currentBreakpoint === r)
      return;
    const a = (r in s ? s[r] : void 0) || n.originalParams, c = Ve(n, i), p = Ve(n, a), u = n.params.grabCursor, f = a.grabCursor, h = i.enabled;
    ...
    const g = a.direction && a.direction !== i.direction, v = i.loop && (a.slidesPerView !== i.slidesPerView || g), x = i.loop;
    g && t && n.changeDirection(), G(n.params, a);
    const d = n.params.enabled, m = n.params.loop;
    Object.assign(n, {
      allowTouchMove: n.params.allowTouchMove,
      allowSlideNext: n.params.allowSlideNext,
      allowSlidePrev: n.params.allowSlidePrev
    }), h && !d ? n.disable() : !h && d && n.enable(), n.currentBreakpoint = r, n.emit("_beforeBreakpoint", a), t && (v ? (n.loopDestroy(), n.loopCreate(e), n.updateSlides()) : !x && m ? (n.loopCreate(e), n.updateSlides()) : x && !m && n.loopDestroy()), n.emit("breakpoint", a);
  }
  function _n(n, e, t) {
  ...
  function kn() {
    const n = this, {
      ...
      el: o,
      device: s
    } = n, r = Tn(["initialized", t.direction, {
  ...
  class D {
    constructor() {
      ...
      const l = this;
      l.__swiper__ = !0, l.support = De(), l.device = $e({
    ...
    getSlideIndex(e) {
      const {
        slidesEl: t,
        params: i
      } = this, o = N(t, `.${i.slideClass}, swiper-slide`), s = oe(o[0]);
      return oe(e) - s;
    }
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (o.centeredSlides) {
        ...
        for (let h = c + 1; h < s.length; h += 1)
          s[h] && !f && (u += Math.ceil(s[h].swiperSlideSize), p += 1, u > a && (f = !0));
        for (let h = c - 1; h >= 0; h -= 1)
          s[h] && !f && (u += s[h].swiperSlideSize, p += 1, u > a && (f = !0));
      } else if (e === "current")
    ...
    mount(e) {
      ...
      let r = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(o()) : N(i, o())[0];
      return !r && t.params.createElements && (r = se("div", t.params.wrapperClass), i.append(r), N(i, `.${t.params.slideClass}`).forEach((l) => {
        r.append(l);
      })), Object.assign(t, {
        el: i,
        wrapperEl: r,
    ...
    destroy(e, t) {
      ...
      return typeof i.params > "u" || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), o.loop && i.loopDestroy(), t && (i.removeClasses(), s && typeof s != "string" && s.removeAttribute("style"), r && r.removeAttribute("style"), l && l.length && l.forEach((a) => {
        ...
        i.off(a);
      }), e !== !1 && (i.el && typeof i.el != "string" && (i.el.swiper = null), ht(i)), i.destroyed = !0), null;
    }
  ...
  function Mn(n) {
    ...
    function s(g) {
      let v;
      return g && typeof g == "string" && e.isElement && (v = e.el.querySelector(g), v) ? v : (g && (typeof g == "string" && (v = [...document.querySelectorAll(g)]), e.params.uniqueNavElements && typeof g == "string" && v && v.length > 1 && e.el.querySelectorAll(g).length === 1 ? v = e.el.querySelector(g) : v && v.length === 1 && (v = v[0])), g && !v ? g : v);
    }
    function r(g, v) {
      const x = e.params.navigation;
      g = M(g), g.forEach((d) => {
        d && (d.classList[v ? "add" : "remove"](...x.disabledClass.split(" ")), d.tagName === "BUTTON" && (d.disabled = v), e.params.watchOverflow && e.enabled && d.classList[e.isLocked ? "add" : "remove"](x.lockClass));
      });
    }
    function l() {
      const {
    ...
    function p() {
      ...
      if (e.params.navigation = Ye(e, e.originalParams.navigation, e.params.navigation, {
        ...
        return;
      let v = s(g.nextEl), x = s(g.prevEl);
      Object.assign(e.navigation, {
        nextEl: v,
        prevEl: x
      }), v = M(v), x = M(x);
      const d = (m, w) => {
        m && m.addEventListener("click", w === "next" ? c : a), !e.enabled && m && m.classList.add(...g.lockClass.split(" "));
      };
      v.forEach((m) => d(m, "next")), x.forEach((m) => d(m, "prev"));
    }
    function u() {
      let {
        nextEl: g,
      ...
      g.forEach((d) => x(d, "next")), v.forEach((d) => x(d, "prev"));
    }
    i("init", () => {
      ...
      x = M(x), d = M(d);
      const m = v.target;
      let w = d.includes(m) || x.includes(m);
      if (e.isElement && !w) {
        const b = v.path || v.composedPath && v.composedPath();
        b && (w = b.find((y) => x.includes(y) || d.includes(y)));
      }
      if (e.params.navigation.hideOnClick && !w) {
        if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === m || e.pagination.el.contains(m)))
          return;
        let b;
        x.length ? b = x[0].classList.contains(e.params.navigation.hiddenClass) : d.length && (b = d[0].classList.contains(e.params.navigation.hiddenClass)), o(b === !0 ? "navigationShow" : "navigationHide"), [...x, ...d].filter((y) => !!y).forEach((y) => y.classList.toggle(e.params.navigation.hiddenClass));
      }
    });
    const f = () => {
  ...
  function On(n) {
    ...
    function f() {
      ...
      d.type === "fraction" && (d.renderFraction ? b = d.renderFraction.call(e, d.currentClass, d.totalClass) : b = `<span class="${d.currentClass}"></span> / <span class="${d.totalClass}"></span>`), d.type === "progressbar" && (d.renderProgressbar ? b = d.renderProgressbar.call(e, d.progressbarFillClass) : b = `<span class="${d.progressbarFillClass}"></span>`), e.pagination.bullets = [], w.forEach((y) => {
        d.type !== "custom" && (y.innerHTML = b || ""), d.type === "bullets" && e.pagination.bullets.push(...y.querySelectorAll(W(d.bulletClass)));
    ...
    function h() {
      ...
      if (!d.el)
        return;
      let m;
      typeof d.el == "string" && e.isElement && (m = e.el.querySelector(d.el)), !m && typeof d.el == "string" && (m = [...document.querySelectorAll(d.el)]), m || (m = d.el), !(!m || m.length === 0) && (e.params.uniqueNavElements && typeof d.el == "string" && Array.isArray(m) && m.length > 1 && (m = [...e.el.querySelectorAll(d.el)], m.length > 1 && (m = m.filter((w) => Ge(w, ".swiper")[0] === e.el)[0])), Array.isArray(m) && m.length === 1 && (m = m[0]), Object.assign(e.pagination, {
        el: m
      }), m = M(m), m.forEach((w) => {
    ...
    i("changeDirection", () => {
      ...
      e.params.pagination.enabled === !1 ? x() : (h(), f(), u());
    }), i("activeIndexChange", () => {
    ...
    const v = () => {
      ...
      d && (d = M(d), d.forEach((m) => m.classList.remove(e.params.pagination.paginationDisabledClass))), h(), f(), u();
    }, x = () => {
      e.el.classList.add(e.params.pagination.paginationDisabledClass);
      let {
        el: d
      } = e.pagination;
      d && (d = M(d), d.forEach((m) => m.classList.add(e.params.pagination.paginationDisabledClass))), g();
    };
...
`, $n = {
  ...
  class Nn {
    constructor({ country: e }) {
      this.selectedColors = {}, this.country = e, this.giftAjaxCall = null, this.baseUrl = this.country === I.US ? "https://us.maxwellscottbags.com/" : this.country === I.AU ? "https://au.maxwellscottbags.com/" : this.country === I.IE ? "https://ie.maxwellscottbags.com/" : this.country === I.CA ? "https://ca.maxwellscottbags.com/" : this.country === I.NZ ? "https://nz.maxwellscottbags.com/" : "https://www.maxwellscottbags.com/", this.loader = new Me(), this.init();
    }
    init() {
    ...
    render() {
            ...
            `<div class="swiper-slide">
                        <div class="os-product" data-product-id="${r.id}">
                          ...
                          <div class="os-price">
                            ...
                            ><span class="new">${Le[this.country]}0.00</span>
                          </div>
                          <div class="os-colors">
        ...
        <div data-step="2" style="display:none">
          ...
          <div class="os-content">
            <div class="os-product">
              ...
              <div class="os-price">
                <span class="old"></span><span class="new">${Le[this.country]}0.00</span>
              </div>
            </div>
      ...
      document.head.insertAdjacentHTML("beforeend", `<style>${Bn}</style>`), document.body.insertAdjacentHTML("beforeend", e), this.popup = document.querySelector("#gift-popup"), this.initSwiper();
      ...
      i && i.addEventListener("click", (r) => {
        var a, c, p;
        this.loader.show(), r.preventDefault(), this.selectedColors[this.selectedGiftId];
        const l = (c = (a = this.popup) == null ? void 0 : a.querySelector(".os-title")) == null ? void 0 : c.textContent;
        P(
      ...
      const e = (r) => {
        ...
        if ((() => {
          ...
          if (!this.selectedGiftId)
            return;
          const g = this.selectedColors[this.selectedGiftId], v = `${this.baseUrl}amasty_promo/cart/add/`, x = Pe[g] || Pe["Chestnut Tan"], d = {
    ...
    initSwiper() {
      this.swiper = new D("#gift-popup .swiper", $n), document.head.insertAdjacentHTML("beforeend", `<style>${zn}</style>`), document.head.insertAdjacentHTML("beforeend", `<style>${Gn}</style>`), document.head.insertAdjacentHTML("beforeend", `<style>${Dn}</style>`);
    }
    show(e = !0) {
      var o;
...
`;
  class Fn {
    ...
    show(e = !0) {
      ...
      <div class="crs-promo__blocks">
        ${qn[this.country.toLowerCase()][r].map((p) => (
        /* HTML */
        `
              <div class="crs-promo__block">
                <img class="crs-promo__block-img" src="${Je}${p.image}" alt="" />
  ...
  class jn {
    ...
    init() {
      this.promoPopup = new Fn({ country: this.country }), this.cartPopup = new ut({ country: this.country, device: this.device }), this.giftPopup = new Nn({ country: this.country }), this.handleAddToCart(), this.triggers();
    }
    triggers() {
    ...
    showPopupsOnFastScroll() {
      const e = Ke(), t = this.device === V.Desktop ? 70 : 120;
...
`;
  class Rn {
    ...
    init() {
      document.head.insertAdjacentHTML("beforeend", `<style>${Vn}</style>`), sessionStorage.removeItem(X);
    }
  }
  const Yn = `br.os-mobile {
  @media (min-width: 768px) {
    display: none;
  }
}
...
@media (max-width: 768px) {
  ...
  class Un {
    ...
    init() {
      document.head.insertAdjacentHTML("beforeend", `<style>${Wn}</style>`), console.log("hrere"), U(".os-popup-title").then(() => {
        var t;
  ...
  Qe({ name: "Exit Popup For Cart Retention", dev: "OS" }), Ze("exp_pop_car_retent");
  class Xn {
    constructor() {
      this.device = screen.width <= 768 ? V.Mobile : V.Desktop, this.country = window.location.host.includes("au") ? I.AU : window.location.host.includes("us") ? I.US : window.location.host.includes("ca") ? I.CA : I.UK, this.init();
    }
    init() {
      document.head.insertAdjacentHTML("beforeend", `<style>${Yn}</style>`), !location.pathname.includes("checkout") && !location.pathname.includes("sign-up") && (new Ie({ country: this.country, device: this.device }), new jn({ country: this.country, device: this.device })), location.pathname.includes("sign-up") && (new Ie({ country: this.country, device: this.device }), new Un()), location.pathname.includes("checkout") && new Rn({ country: this.country });
    }
  }
  new Xn();
})();
