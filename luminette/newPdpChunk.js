      ...
      <div class="days-test">
        ...
        <div class="line-dashed">
          <ul class="row days-test_list">
            ...
            <li class="col-xl-4 d-xl-block d-flex flex-row-reverse justify-content-center">
              <div class="d-flex align-items-center days-test_head">
                <p class="fs-22 fw-bold mr-2">100% moneyback guarantee </p>
                <div class="tooltip d-flex">
                  <img src="${dirImages}info.svg" alt="info"/>
                  <div class="tooltip-dropdown fs-16">
                    <div class="tooltip-item">
    ...
    <div class='container-fluid container--size--lg lav-jumb__container'>
      <div class="row fs-16 text-center compare mx-auto">
        <div class="col-6 py-5">
          <img class="mb-2 mt-1" src="${dirImages}glasses.svg" alt="glasses icon"/>
          <p class="fs-22 fw-bold py-1">Luminette3</p>
        </div>
        <div class="col-6 py-5">
          <img class="mb-2 mt-1" src="${dirImages}box.svg" alt="box icon"/>
          <p class="fs-22 fw-bold py-1">Light Box</p>
        </div>
        <div class="col-12 py-2 fs-18 fw-bold">Portable</div>
        <div class="col-6 py-5 fw-medium"><p class="py-1">Wear while on-the-go</p></div>
        <div class="col-6 py-5 fw-medium"><p class="py-1">Requires you to stop and sit still for 30 mins</p></div>
        <div class="col-12 py-2 fs-18 fw-bold">Light colour spectrum</div>
        <div class="col-6 py-5 fw-medium"><p class="py-1">Blue-enriched white light</p></div>
        <div class="col-6 py-5 fw-medium"><p class="py-1">Full spectrum white light</p></div>
        <div class="col-12 py-2 fs-18 fw-bold">Therapy effectiveness</div>
        ...
        <div class="col-12 py-2 fs-18 fw-bold">Size</div>
        ...
        <div class="row technical-block">
          ...
          <div class="col-6 fs-18">
            <div class="row pb-2 bb-1">
              <div class="col-7 pl-0">Product Dimensions</div>
              <div class="col-5 fw-semi pr-0">3"D x 9.06"W x6.26"H</div>
            </div>
            <div class="row py-2 bb-1">
              <div class="col-7 pl-0">Light Source Type</div>
              <div class="col-5 fw-semi pr-0">LED</div>
            </div>
            <div class="row py-2 bb-1">
              <div class="col-7 pl-0">Number of Light Sources</div>
              <div class="col-5 fw-semi pr-0">3</div>
            </div>
            <div class="row py-2 bb-1">
              <div class="col-7 pl-0">Item Weight</div>
              <div class="col-5 fw-semi pr-0">1.83 ounces (51g)</div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-6 pl-0">
              ...
              <div class="d-flex mt-5">
                <img class="mr-5" src="${dirImages}safety-1.svg" alt="safety icon" />
                <img class="mr-5 ml-2" src="${dirImages}safety-2.svg" alt="safety icon" />
                <img class="ml-2" src="${dirImages}safety-3.svg" alt="safety icon" />
              </div>
            </div>
            <div class="col-6 fs-18 pl-0">
...
const styles = `
  ...
  @media (max-width: 1199px) {
    ...
    .days-test_head, .days-test_head .fs-22 {
      font-size: 18px;
      line-height: 24px;
    }
    .days-test_date .fs-18 {
      font-size: 16px;
      line-height: 24px;
    }
