...
</svg>`, M = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
      ...
      <div class="trial_popup">
        <div class="left_part">
          <div class="steps_wrapper">
            <span class="back ${a ? "hide" : ""}">${L} back</span>
...
`
  ...
  class z {
    ...
    setEvents() {
      h(".step1", "exp_trial_flow_view_01", "Pop up start free trial", "Step 1"), h(".step2", "exp_trial_flow_view_02", "Pop up start free trial", "Step 2"), h(".trial_works", "exp_trial_flow_view_03", "Payment information", "How our trial works"), h(
