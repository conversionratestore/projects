...
form input:not([data-drupal-selector="edit-search-api-fulltext"]), 
.select2-container--default .select2-selection--single, 
input:not([type="submit"]):not([type=checkbox]):not([type=radio]):not([type=button]):not([data-drupal-selector="edit-search-api-fulltext"]) {
    font-family: 'Manrope';
    font-style: normal;
    font-weight: 500;
    font-size: 14px;
